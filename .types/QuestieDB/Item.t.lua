...
---@field Get fun(id: ItemId, key: QuestieDBItemField|integer): any Read a field by canonical name or index.
---@field GetAll fun(id: ItemId, keys: (QuestieDBItemField|integer)[]): QuestieDBPackedValues? Read fields into a packed table, or nil for an unknown ID.
---@field GetRaw fun(id: ItemId, key: QuestieDBItemField|integer): any Read base data without Corrections or localization.
