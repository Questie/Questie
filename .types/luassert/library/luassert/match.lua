...
---    s("foo")
---
---    assert.spy(s).was.called_with(_)        -- matches any argument
---    assert.spy(s).was.not_called_with(_, _) -- does not match two arguments
---end)
---```
match._ = {}
...
---(like `self`) and you want to use `was.called_with`, you should use
---`match.is_ref(obj)`.
---
---## Example
---```lua
...
---        s(t, 2)
---
---        assert.spy(s).was.called_with(match.is_ref(t), 2)
---    end)
---
...
---        s("foo")
---
---        assert.spy(s).was.called_with(match.is_all_of(
---            match.is_not_nil(),
---            match.is_not_number()
---        ))
---    end)
...
---        s("foo")
---
---        assert.spy(s).was.called_with(match.is_any_of(
---            match.is_number(),
---            match.is_string(),
---            match.is_boolean()
---        ))
...
---        s("foo")
---
---        assert.spy(s).was.called_with(match.is_none_of(
---            match.is_number(),
---            match.is_table(),
---            match.is_boolean()
---        ))
