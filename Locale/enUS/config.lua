QuestieLocale.locale['enUS'] = {
    ...
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION_DESC'] = "When this is checked, the current Questie Tracker Location and Size will be the same across all Characters.\n\nNOTE: Upon enabling, this will reset the Tracker to the center of your screen. Move the Tracker to your desired location and set the size. When you are ready, type \"/reload\" to finalize your settings.",
