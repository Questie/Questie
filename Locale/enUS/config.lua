QuestieLocale.locale['enUS'] = {
    ...
    ['TRACKER_FONT_HEADER'] = "Font for Quest Names",
    ['TRACKER_FONT_HEADER_DESC'] = "The font the tracker uses for quest names.",
    ['TRACKER_FONT_LINE'] = "Font for Objectives",
    ['TRACKER_FONT_LINE_DESC'] = "The font the tracker uses for objectives.",
    ['TRACKER_FONT_SIZE_HEADER'] = "Font Size for Quest Names",
    ['TRACKER_FONT_SIZE_HEADER_DESC'] = "The font size the tracker uses for quest names.",
    ['TRACKER_FONT_SIZE_LINE'] = "Font Size for Objectives",
    ['TRACKER_FONT_SIZE_LINE_DESC'] = "The font size the tracker uses for objectives.",
