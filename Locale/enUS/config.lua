QuestieLocale.locale['enUS'] = {
    ...
    ['ENABLE_WIDE_QUEST_LOG'] = "Enable Wide Quest Log",
    ['ENABLE_WIDE_QUEST_LOG_DESC'] = "Toggles the width of the quest log window to single or double width. This will also reload the UI.",
    ['ENABLE_QUEST_LOG_LEVEL_BADGES'] = "Enable Quest Log Level Badges",
    ['ENABLE_QUEST_LOG_LEVEL_BADGES_DESC'] = "Toggles the display of the level requirement badges in the quest log.",
    ...
    ['ICON_CTRLLEFT_CLICK_HOLD'] = "Ctrl + Left Click + Hold",
    ['ICON_DRAG_UNLOCKED'] = "Drag while Unlocked",
    ...
    ['TRACKER_ENABLE_AUTOTRACK'] = "Auto Track Quests",
    ...
    ['TRACKER_COLLAPSE_COMPLETED'] = "Min Complete Quests",
    ['TRACKER_COLLAPSE_COMPLETED_DESC'] = "When this is checked, completed quests will automatically minimize.",
    ['TRACKER_SHOW_QUEST_LEVEL'] = "Show Quest Level",
    ['TRACKER_SHOW_QUEST_LEVEL_DESC'] = "When this is checked, the Quest Level Tags for Quest Titles will show in the Questie Tracker.",
    ['TRACKER_SHOW_BLIZZARD_QUEST_TIMER'] = "Show Blizzard Timer",
    ['TRACKER_SHOW_BLIZZARD_QUEST_TIMER_DESC'] = "When this is checked, the default Blizzard Timer Frame for quests will be shown instead of being embedded inside the tracker.",
    ...
    ['TRACKER_HEADER_ENABLED'] = "Enable Header",
    ['TRACKER_HEADER_ENABLED_DESC'] = "When this is checked, the Questie Tracker Header will become visible and the total number of quests you have in your log will be shown.",
    ['TRACKER_AUTO_MOVE_HEADER_ENABLED'] = "Auto Move Header",
    ['TRACKER_AUTO_MOVE_HEADER_ENABLED_DESC'] = "When this is checked, the Questie Tracker Header will automatically move to the bottom of the Questie Tracker while the Tracker is placed in the bottom area of your screen. Otherwise, it will remain at the top always.\n\nNOTE: This setting only works while the \"Tracker SetPoint\" is using the default \"Auto\" mode.",
    ['TRACKER_STICKY_DURABILITY_FRAME'] = "Sticky Durability Frame",
    ['TRACKER_STICKY_DURABILITY_FRAME_DESC'] = "When this is checked, the durability frame will be placed on the left or right side of the Tracker depending on where the Tracker is placed on your screen.",
    ['TRACKER_HIDE_IN_COMBAT'] = "Minimize in combat",
    ['TRACKER_HIDE_IN_COMBAT_DESC'] = "When this is checked, the Tracker will automatically be minimized while entering combat.",
    ['TRACKER_FADE_MINMAX_BUTTONS'] = "Fade Min/Max BTNs",
    ['TRACKER_FADE_MINMAX_BUTTONS_DESC'] = "When this is checked, the Minimize and Maximize Buttons will fade and become transparent when not in use.",
    ['TRACKER_FADE_QUEST_ITEM_BUTTONS'] = "Fade Quest Item BTNs",
    ['TRACKER_FADE_QUEST_ITEM_BUTTONS_DESC'] = "When this is checked, the Quest Item Buttons will fade and become transparent when not in use.",
    ['TRACKER_ENABLE_BACKGROUND'] = "Enable Background",
    ['TRACKER_ENABLE_BACKGROUND_DESC'] = "When this is checked, the Questie Tracker Background becomes visible.",
    ['TRACKER_ENABLE_BORDER'] = "Enable Border",
    ['TRACKER_ENABLE_BORDER_DESC'] = "When this is checked, the Questie Tracker Border becomes visible.",
    ['TRACKER_FADE_BACKDROP'] = "Fade Background",
    ['TRACKER_FADE_BACKDROP_DESC'] = "When this is checked, the Questie Tracker Backdrop and Border (if enabled) will fade and become transparent when not in use.",
    ...
    ['TRACKER_ENABLED'] = "Enable The Tracker",
    ['TRACKER_ENABLED_DESC'] = "Enabling the Tracker will replace the default Blizzard Quest Tracker with the Questie Tracker.",
    ['TRACKER_DISABLED'] = "Disable The Tracker",
    ['TRACKER_DISABLED_DESC'] = "Disabling the Tracker will replace the Questie Tracker with the default Blizzard Quest Tracker.",
    ...
    ['TRACKER_ACTIVE_QUESTS'] = "Questie Tracker: ",
