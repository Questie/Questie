QuestieLocale.locale['frFR'] = {
    ...
    ['TRACKER_ENABLED'] = "Activer le traqueur",
    ['TRACKER_ENABLED_DESC'] = "Lorsque cette case est cochée, le suivi de quête Blizzard par défaut est remplacé par le suivi de quête.",
    ...
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION'] = "Emplacement du Global Tracker",
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION_DESC'] = "Lorsque cette case est cochée, l'emplacement et la taille actuels du traqueur de quête seront les mêmes pour tous les personnages.\n\nNOTE: une fois activé, cela réinitialisera le traqueur au centre de votre écran. à l'emplacement souhaité et définissez la taille. Lorsque vous êtes prêt, tapez \"/ reload\" pour finaliser vos paramètres.",
