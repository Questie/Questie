QuestieLocale.locale['frFR'] = {
	...
	['CLUSTER'] = "Regroupement des icônes des objectifs (pas encore implanté)",
	...
	['DEBUG_CLUSTER'] = "Valeur de mise en cluster des paramètres NYI, clusterLevel défini sur% s: Redrawing!", --à revoir
