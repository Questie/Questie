QuestieLocale.locale['koKR'] = {
    ...
    ['TRACKER_ENABLED_DESC'] = "이 옵션을 선택하면 기본 블리자드 퀘스트 추적기가 Questie 추적기로 바뀝니다.",
    ...
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION'] = "전역 추적기 위치",
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION_DESC'] = "이 옵션을 선택하면 현재 Questie 트래커 위치 및 크기가 모든 문자에서 동일합니다.\n\n참고 : 활성화하면 트래커가 화면 중앙으로 재설정됩니다. 준비가되면 \"/reload\"를 입력하여 설정을 완료하십시오.",
