QuestieLocale.locale['koKR'] = {
    ...
    [ 'TRACKER_FONT_HEADER'] = "퀘스트 이름에 대한 글꼴",
    [ 'TRACKER_FONT_HEADER_DESC'] = "트래커가 퀘스트 이름에 사용하는 글꼴",
    [ 'TRACKER_FONT_LINE'] = "목표를위한 글꼴",
    [ 'TRACKER_FONT_LINE_DESC'] = "트래커가 목표에 사용하는 글꼴",
    [ 'TRACKER_FONT_SIZE_HEADER'] = "퀘스트 이름의 글꼴 크기",
    [ 'TRACKER_FONT_SIZE_HEADER_DESC'] = "트래커가 퀘스트 이름에 사용하는 글꼴 크기",
    [ 'TRACKER_FONT_SIZE_LINE'] = "목표의 글꼴 크기",
    [ 'TRACKER_FONT_SIZE_LINE_DESC'] = "트래커가 목표에 사용하는 글꼴 크기",
