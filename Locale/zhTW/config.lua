QuestieLocale.locale['zhTW'] = {
    ...
    ['ENABLE_ICONS_DESC'] = "啟用或停用Questie.",
    ['ENABLE_MINIMAP_BUTTON'] = "啟用Questie的小地圖按鈕",
    ['ENABLE_MINIMAP_BUTTON_DESC'] = "啟用小地圖按鈕；停用後以 /questie 打開設定視窗",
    ['ENABLE_INSTANT'] = "立即顯示任務內容",
    ...
    ['ENABLE_MANUAL_OFFSET'] = "啟用自訂的最小任務等級平移值",
    ['ENABLE_MANUAL_OFFSET_DESC'] = "啟用自訂的最小任務等級平移值，而不是使用 GetQuestGreenLevel 所得到的最低等級值",
    ['LOWLEVEL_BELOW'] = "< 低於等級",
    ['LOWLEVEL_BELOW_DESC'] = "顯示比你低了多少級的任務（預設：%s）",
    ['LOWLEVEL_ABOVE'] = "高於等級 >",
    ['LOWLEVEL_ABOVE_DESC'] = "顯示比你高了多少級的任務（預設：%s）",
    ['ENABLE_MANUAL_OFFSET_ABSOLUTE'] = "啟用絕對任務等級範圍",
    ...
    ['ENABLE_TOOLTIPS_QUEST_LEVEL_DESC'] = "啟用後，任務的等級將顯示在提示訊息上",
    ...
    ['HIDE_UNEXPLORED_ICONS'] = "隱藏未探索區域圖是",
    ['HIDE_UNEXPLORED_ICONS_DESC'] = "在位探索的區域不顯示圖示",
    ...
    ['ENABLE_REPEATABLE_QUEST_ICONS'] = "啟用重複任務圖示",
    ['ENABLE_REPEATABLE_QUEST_ICONS_DESC'] = "啟用後，將在世界地圖/小地圖上顯示可取得重複任務的地點",
    ['ENABLE_EVENT_QUEST_ICONS'] = "啟用事件任務圖示",
    ['ENABLE_EVENT_QUEST_ICONS_DESC'] = "啟用後，將在世界地圖/小地圖上顯示可取得事件任務的地點",
    ['ENABLE_DUNGEON_QUEST_ICONS'] = "啟用副本任務圖示",
    ['ENABLE_DUNGEON_QUEST_ICONS_DESC'] = "啟用後，將在世界地圖/小地圖上顯示可取得副本任務的地點",
    ['ENABLE_PVP_QUEST_ICONS'] = "啟用PvP任務圖示",
    ['ENABLE_PVP_QUEST_ICONS_DESC'] = "啟用後，將在世界地圖/小地圖上顯示可取得PvP任務的地點",
    ['ENABLE_AUTO_ACCEPT_QUESTS'] = "自動接受任務",
    ['ENABLE_AUTO_ACCEPT_QUESTS_DESC'] = "啟用或停用任務的自動接受",
    ['ENABLE_AUTO_COMPLETE'] = "自動完成",
    ['ENABLE_AUTO_COMPLETE_DESC'] = "啟用或停用已完成的任務在與NPC交談時的自動完成",
    ['ENABLE_ACCEPT_TRIVIAL'] = "接受低等級任務",
    ['ENABLE_ACCEPT_TRIVIAL_DESC'] = "啟用後，即便是低等級任務也會自動被接受",
    ['AUTO_MODIFIER'] = "自動調整",
    ...
    ['ENABLE_TOOLTIPS_QUEST_LEVEL_IDS'] = "啟用後，將於追蹤視窗的任務列表提示訊息顯示任務ID",
    ['LOCALE_HEADER'] = "本地化設定",
    ...
    ['TRACKER_SHOW_QUEST_LEVEL_DESC'] = "啟用後，任務的等級將顯示在追蹤視窗",
    ...
    ['TRACKER_HIDE_IN_COMBAT_DESC'] = "啟用後，當進入戰鬥時，將自動最小化任務追蹤視窗",
    ...
    ['TRACKER_UNTRACK_DESC'] = "將一個任務從追蹤視窗刪除",
