QuestieLocale.locale['zhTW'] = {
    ...
    ['MINIMAP_OBJECTIVE_SCALE'] = "縮放目標圖示",
    ['MINIMAP_OBJECTIVE_SCALE_DESC'] = "調整小地圖上的目標圖示大小（預設：%s）",
    ...
    ['QUESTIE_DEV_MESSAGE'] = "Questie是一款為魔獸世界經典版製作的任務插件，目前仍在開發中，請到Github查看最新版本、回報問題或提供建議，也可以加入我們的 discord頻道。(( https://github.com/AeroScripts/QuestieDev/ ))",
    ...
    ['JOURNEY_SEARCH_QUESTS'] = "根據任務名稱搜尋",
    ['JOURNEY_SEARCH_QUESTS_ID'] = "根據任務ID搜尋",
    ['JOURNEY_SEARCH_NPCS'] = "根據NPC名稱搜尋",
    ['JOURNEY_SEARCH_NPCS_ID'] = "根據NPC ID搜尋",
