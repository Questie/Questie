QuestieLocale.locale['zhTW'] = {
    ...
    ['TRACKER_SORT_BY_ZONE'] = "按區域",
    ['TRACKER_SORT_BY_PROXIMITY'] = "按鄰近度",
    ['TRACKER_DONT_SORT'] = "不排序",
    ['TRACKER_SETPOINT'] = "追踪器設定點",
    ['TRACKER_SETPOINT_DESC'] = "這確定了跟踪器的生長方向。默認設置將根據您自動拖動跟踪器的位置進行調整，也可以覆蓋並強制其隨心所欲地填充。\n\n例如，如果您選擇 \"Bottom Left\", 則跟踪器將從左到右增長，並且任務將從跟踪器的底部到頂部填充。當您希望將跟踪器放置在 \"Bottom\" 時，此設置是理想的用戶界面等的左側 區域",
