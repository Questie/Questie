QuestieLocale.locale['zhTW'] = {
    ...
    ['ICON_CTRLLEFT_CLICK_HOLD'] = "Ctrl +左鍵+保持",
    ...
    ['TRACKER_COLLAPSE_COMPLETED'] = "最少完成任務",
    ['TRACKER_COLLAPSE_COMPLETED_DESC'] = "選中後，完成的任務將自動最小化。",
    ...
    ['TRACKER_ENABLED_DESC'] = "啟用跟踪器將用Questie跟踪器替換默認的Blizzard Quest跟踪器。",
    ['TRACKER_DISABLED'] = "禁用跟踪器",
    ['TRACKER_DISABLED_DESC'] = "禁用追踪器會將Questie追踪器替換為默認的Blizzard Quest追踪器。",
    ...
    ['TRACKER_ENABLE_CHAR_TRACKERLOCATION_DESC'] = "您當前正在保存Questie Tracker的位置和每個字符的大小。這可讓您自定義每個角色的跟踪器位置。\n\n注意：啟用“每個字符”後，跟踪器將重置為您的中心。屏幕。將Tracker移至所需位置並設置尺寸。準備好後，鍵入\"/reload\"完成設置。",
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION'] = "全局保存跟踪器",
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION_DESC'] = "您當前正在全局保存Questie Tracker的位置和大小。這使您可以對所有字符進行一次設置。\n\n注意：啟用“全局”後，Tracker將會重置為屏幕中心。將Tracker移至所需位置並設置尺寸。準備好後，鍵入\"/reload\"完成設置。",
