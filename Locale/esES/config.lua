QuestieLocale.locale['esES'] = {
    ...
    ['MINIMAP_GLOBAL_SCALE_DESC'] = "Cómo de grandes son los iconos en el minimapa. ( Por defecto: %s )",
    ...
    ['MINIMAP_FADE_PLAYER_DIST_DESC'] = "Cómo de lejos tienen que estar los iconos del jugador para que se desvanezcan. ( Por defecto: %s )",
    ...
    ['MAP_GLOBAL_SCALE_DESC'] = "Cómo de grande son los iconos del mapa ( Por defecto: %s )",
    ...
    ['AVAILABLE_ICON_SCALE_DESC'] = "Cómo de grande son los iconos de misión disponible y completada. ( Por defecto: %s )",
    ['LOOT_ICON_SCALE'] = "Tamaño de iconos de squeo",
    ['LOOT_ICON_SCALE_DESC'] = "Cómo de grande son los iconos de saqueo. ( Por defecto: %s )",
    ['MONSTER_ICON_SCALE'] = "Tamaño de iconos de matar",
    ['MONSTER_ICON_SCALE_DESC'] = "Cómo de grande son los iconos de matar. ( Por defecto: %s )",
    ['OBJECT_ICON_SCALE'] = "Tamaño de iconos de objeto",
    ['OBJECT_ICON_SCALE_DESC'] = "Cómo de grande son los iconos de objeto. ( Por defecto: %s )",
    ['EVENT_ICON_SCALE'] = "Tamaño de iconos de evento",
    ['EVENT_ICON_SCALE_DESC'] = "Cómo de grande son los iconos evento. ( Por defecto: %s )",
    ...
    ['ENABLE_DEBUG_DESC'] = "EHabilita o deshabilita el modo debug.",
