QuestieLocale.locale['esMX'] = {
    ...
    ['TRACKER_ENABLE_BACKDROP_DESC'] = "When this is checked, the Questie Tracker Backdrop becomes visible.",
    ['TRACKER_FADE_BACKDROP'] = "Fade Tracker Backdrop",
    ['TRACKER_FADE_BACKDROP_DESC'] = "When this is checked, the Questie Tracker Backdrop will fade and become transparent when not in use.",
    ...
    ['TRACKER_FONT_ZONE_DESC'] = "The font used for zone names.",
    ['TRACKER_FONT_QUESTS'] = "Font for Quest Titles",
    ['TRACKER_FONT_QUESTS_DESC'] = "The font used for quest titles.",
    ['TRACKER_FONT_OBJECTIVE'] = "Font for Objectives",
    ['TRACKER_FONT_OBJECTIVE_DESC'] = "The font used for objectives.",
    ['TRACKER_FONT_SIZE_HEADER'] = "Font Size for Active Quests",
    ['TRACKER_FONT_SIZE_HEADER_DESC'] = "The font size Active Quests uses.",
    ['TRACKER_FONT_SIZE_ZONE'] = "Font Size for Zone Names",
    ['TRACKER_FONT_SIZE_ZONE_DESC'] = "The font size used for zone names.",
    ['TRACKER_FONT_SIZE_QUESTS'] = "Font Size for Quest Titles",
