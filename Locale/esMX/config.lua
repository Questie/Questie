QuestieLocale.locale['esMX'] = {
    ...
    ['TRACKER_FONT_HEADER_DESC'] = "La fuente que utiliza Active Quests.",
    ['TRACKER_FONT_ZONE'] = "Fuente para nombres de zona",
    ['TRACKER_FONT_ZONE_DESC'] = "La fuente utilizada para los nombres de zona.",
    ['TRACKER_FONT_QUESTS'] = "Fuente para los títulos de Quest",
    ...
    ['TRACKER_FONT_SIZE_HEADER_DESC'] = "El tamaño de fuente que utiliza Active Quests.",
