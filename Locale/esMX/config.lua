QuestieLocale.locale['esMX'] = {
    ...
    ['ENABLE_REPEATABLE_QUEST_ICONS'] = "Mostrar misiones repitibles en el mapa",
    ['ENABLE_REPEATABLE_QUEST_ICONS_DESC'] = "Muestra las misiones repitibles en el mapa y minimapa.",
