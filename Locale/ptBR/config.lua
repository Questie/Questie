QuestieLocale.locale['ptBR'] = {
	...
	['CLUSTER'] = "Quantidade de ícones de objetivos (ainda não implementados)",
	...
	['JOURNEY_COMPLETE_TITLE'] = "Miss^0es terminadas",
	...
	['DEBUG_CLUSTER'] = "Valor de cluster dos parâmetros da NYI, clusterLevel definido como% s: Redrawing!",
