QuestieLocale.locale['ptBR'] = {
    ...
    ['TRACKER_ENABLED_DESC'] = "Quando esta opção está marcada, o Blizzard Quest Tracker padrão é substituído pelo Questie Tracker.",
    ...
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION'] = "Localização do rastreador global",
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION_DESC'] = "Quando esta opção estiver marcada, o local e o tamanho atuais do Questie Tracker serão os mesmos em todos os personagens. para o local desejado e defina o tamanho. Quando estiver pronto, digite \"/recarregar\" para finalizar suas configurações.",
