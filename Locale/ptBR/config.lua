QuestieLocale.locale['ptBR'] = {
    ...
    ['TRACKER_FONT_HEADER'] = "Fonte para nomes de missões",
    ['TRACKER_FONT_HEADER_DESC'] = "A fonte que o rastreador usa para nomes de missões.",
    ['TRACKER_FONT_LINE'] = "Fonte para objetivos",
    ['TRACKER_FONT_LINE_DESC'] = "A fonte que o rastreador usa para objetivos.",
    ['TRACKER_FONT_SIZE_HEADER'] = "Tamanho da fonte dos nomes das missões",
    ['TRACKER_FONT_SIZE_HEADER_DESC'] = "O tamanho da fonte que o rastreador usa para nomes de missões.",
    ['TRACKER_FONT_SIZE_LINE'] = "Tamanho da fonte dos objetivos",
    ['TRACKER_FONT_SIZE_LINE_DESC'] = "O tamanho da fonte que o rastreador usa para objetivos.",
