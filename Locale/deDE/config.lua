QuestieLocale.locale['deDE'] = {
	...
	['ENABLE_MANUAL_OFFSET_ABSOLUTE'] = "Absolute Levelbegrenzen aktivieren",
	['ENABLE_MANUAL_OFFSET_ABSOLUTE_DESC'] = "Ändert die relative Levelbegrenzung zu einem absoluten Wert.",
	['LEVEL_FROM'] = "Level ab",
	['LEVEL_FROM_DESC'] = "Zeige Quests ab level.",
	['LEVEL_TO'] = "Level bis",
	['LEVEL_TO_DESC'] = "Zeige Quests bis level.",
