QuestieLocale.locale['deDE'] = {
    ...
    ['TRACKER_ENABLED'] = "Aktivieren Sie den Tracker",
    ['TRACKER_ENABLED_DESC'] = "Wenn dies aktiviert ist, wird der Standard-Blizzard-Quest-Tracker durch den Questie-Tracker ersetzt.",
    ...
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION'] = "Global Tracker Location",
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION_DESC'] = "Wenn diese Option aktiviert ist, sind Position und Größe des aktuellen Questie-Trackers für alle Zeichen gleich.\n\nHINWEIS: Beim Aktivieren wird der Tracker in die Mitte Ihres Bildschirms zurückgesetzt. Bewegen Sie den Tracker an den gewünschten Ort und stellen Sie die Größe ein. Wenn Sie bereit sind, geben Sie \"/reload\" ein, um Ihre Einstellungen abzuschließen.",
