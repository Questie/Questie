QuestieLocale.locale['zhCN'] = {
    ...
    ['TRACKER_ENABLED_DESC'] = "选中此选项后，默认的Blizzard Quest Tracker将替换为Questie Tracker。",
    ...
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION'] = "全球追踪器位置",
    ['TRACKER_ENABLE_GLOBAL_TRACKERLOCATION_DESC'] = "选中后，所有角色的当前Questie追踪器位置和大小将相同。\n\n注意：启用后，这会将追踪器重置到屏幕中心。 到所需位置并设置尺寸。准备好后，键入\"/reload\"完成设置。",
