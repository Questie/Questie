QuestieLocale.locale['zhCN'] = {
    ...
    ['ENABLE_AUTO_COMPLETE'] = "自动完成任务",
    ['ENABLE_AUTO_COMPLETE_DESC'] = "启用后和NPC交谈 Questie 自动完成任务。",
    ['ENABLE_ACCEPT_TRIVIAL'] = "接受低等级任务",
    ['ENABLE_ACCEPT_TRIVIAL_DESC'] = "启用后低等级任务自动接受。",
    ['AUTO_MODIFIER'] = "自动调整",
    ...
    ['RECOMPILE_DATABASE_BTN'] = "启用探查器",
    ['RECOMPILE_DATABASE_BTN_DESC'] = "启用探查器，这对于追踪延迟/帧数峰值的来源很有用。",
    ...
    ['TRACKER_FONT_HEADER'] = "Active Quest的字体",
    ['TRACKER_FONT_HEADER_DESC'] = "Active Quests使用的字体。",
    ['TRACKER_FONT_ZONE'] = "区域名称的字体",
    ['TRACKER_FONT_ZONE_DESC'] = "区域名称使用的字体。",
    ['TRACKER_FONT_QUESTS'] = "任务标题的字体",
    ['TRACKER_FONT_QUESTS_DESC'] = "任务标题使用的字体。",
    ['TRACKER_FONT_OBJECTIVE'] = "目标字体",
    ['TRACKER_FONT_OBJECTIVE_DESC'] = "用于目标的字体。",
    ['TRACKER_FONT_SIZE_HEADER'] = "活动任务的字体大小",
    ['TRACKER_FONT_SIZE_HEADER_DESC'] = "Active Quests使用的字体大小。",
    ['TRACKER_FONT_SIZE_ZONE'] = "区域名称的字体大小",
    ['TRACKER_FONT_SIZE_ZONE_DESC'] = "区域名称使用的字体大小。",
    ['TRACKER_FONT_SIZE_QUESTS'] = "任务标题的字体大小",
    ['TRACKER_FONT_SIZE_QUESTS_DESC'] = "任务标题使用的字体大小。",
    ['TRACKER_FONT_SIZE_OBJECTIVE'] = "物镜的字体大小字体",
    ['TRACKER_FONT_SIZE_OBJECTIVE_DESC'] = "用于目标的字体大小",
    ...
    ['Reload UI'] = "重载界面",
    ["\124cFFAAEEFFQuestie DB has updated!\124r\124cFFFF6F22 Data is being processed, this may take a few moments and cause some lag..."] = "\124cFFAAEEFFQuestie DB 更新了！\124r\124cFFFF6F22 数据正在处理中，这可能需要一些时间，并会导致一些延迟...",
    ["\124cFF4DDBFF [1/4] Updating NPCs..."] = "\124cFF4DDBFF [1/4] 正在更新 NPCs...",
    ["\124cFF4DDBFF [2/4] Updating objects..."] = "\124cFF4DDBFF [2/4] 正在更新 objects...",
    ["\124cFF4DDBFF [3/4] Updating quests..."] = "\124cFF4DDBFF [3/4] 正在更新 quests...",
    ["\124cFF4DDBFF [4/4] Updating items..."] = "\124cFF4DDBFF [4/4] 正在更新 items...",
    ["\124cFFAAEEFFQuestie DB update complete!"] = "\124cFFAAEEFFQuestie DB 更新完成！",
    ["Nearby"] = "附近",
};
