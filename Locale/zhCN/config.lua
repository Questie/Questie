...
QuestieLocale.locale['zhCN'] = {
    ...
    ['DBM_HUD_REFRESH_DESC'] = "调整HUD图标的刷新率，这会影响UI更新其位置的频率。 （默认值：％s）",
    ['DBM_HUD_SCALE_OPTIONS'] = "打开大小 & 比例 选项",
    ['DBM_HUD_ZOOM'] = "HUD图标的全局缩放等级",
    ['DBM_HUD_ZOOM_DESC'] = "调整HUD图标的缩放级别，这会影响您看到它们的接近程度或远近程度。 （默认值：％s）",
    ['DBM_HUD_RADIUS'] = "HUD图标的全局半径/大小",
    ['DBM_HUD_RADIUS_DESC'] = "调整HUD上显示的图标的大小。 （默认值：％s）",
    ['DBM_HUD_FILTER_OPTIONS'] = "过滤器选项",
    ['DBM_HUD_FILTER_QUEST'] = "显示起始任务图标",
    ['DBM_HUD_FILTER_QUEST_DESC'] = "切换是否在HUD上显示可用/完成任务图标。 （默认值：％s）",
    ['DBM_HUD_FILTER_KILL'] = "显示任务需要击杀图标",
    ['DBM_HUD_FILTER_KILL_DESC'] = "切换是否在HUD上显示击杀目标的图标。 （默认值：％s）",
    ['DBM_HUD_FILTER_LOOT'] = "显示任务战利品图标",
    ['DBM_HUD_FILTER_LOOT_DESC'] = "切换是否在HUD上显示战利品图标。 （默认值：％s）",
    ['DBM_HUD_FILTER_INTERACT'] = "显示任务目标图标",
    ['DBM_HUD_FILTER_INTERACT_DESC'] = "切换是否在HUD上显示目标图标（默认值：％s）",
    ...
    ['NAMEPLATE_RESET_BTN'] = "重置",
    ['NAMEPLATE_RESET_BTN_DESC'] = "重置姓名板图标的位置和大小",
    ['TARGET_HEAD'] = "目标图标选项",
    ...
    ['SHARED_TOOLTIP_PARTY_ONLY_DESC'] = "启用此功能后，仅当共享任务信息来自队伍成员时才会显示。",
    ...
    ['SHOW_PROFILER_BTN_DESC'] = "打开Questie查找器，这对于跟踪延迟/帧峰值的来源很有用。",
    ...
    ['TRACKER_FONT_SIZE_HEADER'] = "Active Quests任务字体大小",
    ...
    ["\124cFF4DDBFF [1/4] Updating NPCs..."] = "\124cFF4DDBFF [1/4] 正在读出 NPCs...",
    ["\124cFF4DDBFF [2/4] Updating objects..."] = "\124cFF4DDBFF [2/4] 正在读出 objects...",
    ["\124cFF4DDBFF [3/4] Updating quests..."] = "\124cFF4DDBFF [3/4] 正在读出 quests...",
    ["\124cFF4DDBFF [4/4] Updating items..."] = "\124cFF4DDBFF [4/4] 正在读出 items...",
