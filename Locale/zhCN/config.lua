QuestieLocale.locale['zhCN'] = {
    ...
    ['TRACKER_ENABLE_HOOKS_DESC'] = "启用后，Questie会以钩子（Hook）钩起暴雪的任务追踪函数，接管它的功能，这对Questie任务追踪的某些功能来说是必要的，可以使追踪的状态更精准地更新，同时还可以与其他插件整合。如果你的任务追踪出现了奇怪的错误，可能就要停用这项功能；停用需要重载界面（/reload）",
