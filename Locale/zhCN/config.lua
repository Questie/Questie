...
QuestieLocale.locale['zhCN'] = {
    ...
    ['TRACKING_ICONS_BUTTON'] = "显示NPC图标配置",
    ['TRACKING_ICONS_BUTTON_DESC'] = "允许在地图和小地图上显示选择的各NPC图标（例如“邮箱”，“修理”）。",
    ...
    ['ENABLE_MANUAL_OFFSET_ABSOLUTE'] = "任务等级范围",
    ...
    ['ENABLE_TOOLTIPS_DESC'] = "启用后，在目标或物品的鼠标提示中显示任务信息",
    ['ENABLE_TOOLTIPS_QUEST_LEVEL'] = "显示任务等级",
    ['ENABLE_TOOLTIPS_QUEST_LEVEL_DESC'] = "启用后，任务等级将显示在鼠标提示中",
    ['SHARED_TOOLTIP_PARTY_ONLY'] = "仅限队伍",
    ['SHARED_TOOLTIP_PARTY_ONLY_DESC'] = "启用后，仅当共享任务信息来自队伍其他成员时才会显示。",
    ['SHOW_QUESTS_IN_NPC_TOOLTIPS'] = '显示任务 NPC',
    ['SHOW_QUESTS_IN_NPC_TOOLTIPS_DESC'] = '启用后，在鼠标提示中显示NPC（可接/完成）任务。',
    ...
    ['ICON_TOGGLE_QUESTIE'] = "切换Questie",
    ['ICON_CTRLRIGHT_CLICK'] = "Ctrl + 右键",
    ['ICON_CTRLLEFT_CLICK'] = "Ctrl + 左键",
    ...
    ['TRACKER_STICKY_DURABILITY_FRAME'] = "锁定任务道具",
    ...
    ['TRACKER_FADE_QUEST_ITEM_BUTTONS'] = "渐隐任务道具",
