...
ZoneDB.private.subZoneToParentZoneOverride = [[return {
    ...
    [4830] = 4812, -- Icecrown Citadel -> Upper Spire (fake ID for ICC)
    [4831] = 4812, -- Icecrown Citadel -> Blood Queen Lana'thel (fake ID for ICC)
    [4834] = 4812, -- Icecrown Citadel -> Sindragosa (fake ID for ICC)
    [4835] = 4812, -- Icecrown Citadel -> Rampart of Skulls (fake ID for ICC)
    [4836] = 4812, -- Icecrown Citadel -> Deathbringer's Rise (fake ID for ICC)
    [4837] = 4812, -- Icecrown Citadel -> The Frozen Throne (fake ID for ICC)
