...
ZoneDB.private.subZoneToParentZoneOverride = [[return {
    ...
    [6466] = 5805, -- Cavern of Endless Echoes -> Valley of the Four Winds (cave)
    ...
    [10003] = 1583, -- Blackrock Spire - Tazz'Alor (fake ID for Blackrock Spire)
    [10004] = 1583, -- Blackrock Spire - Skitterweb Tunnels (fake ID for Blackrock Spire)
    [10005] = 1583, -- Blackrock Spire - Hordemar City (fake ID for Blackrock Spire)
    [10006] = 1583, -- Blackrock Spire - Halycon's Lair (fake ID for Blackrock Spire)
    [10007] = 1583, -- Blackrock Spire - Chamber of Battle (fake ID for Blackrock Spire)
    [10008] = 796, -- Scarlet Monastery - Library (fake ID for Scarlet Monastery)
    [10009] = 796, -- Scarlet Monastery - Armory (fake ID for Scarlet Monastery)
    [10010] = 796, -- Scarlet Monastery - Cathedral (fake ID for Scarlet Monastery)
    [10011] = 2057, -- Scholomance - Chamber of Summoning (fake ID for Scholomance)
    [10012] = 2057, -- Scholomance - The Upper Study (fake ID for Scholomance)
    [10013] = 2057, -- Scholomance - Headmaster's Study (fake ID for Scholomance)
    [10014] = 209, -- Shadowfang Keep - Dining Hall (fake ID for Shadowfang Keep)
    [10015] = 209, -- Shadowfang Keep - The Vacant Den (fake ID for Shadowfang Keep)
    [10016] = 209, -- Shadowfang Keep - Lower Observatory (fake ID for Shadowfang Keep)
    [10017] = 209, -- Shadowfang Keep - Upper Observatory (fake ID for Shadowfang Keep)
    [10018] = 209, -- Shadowfang Keep - Lord Godfrey's Chamber (fake ID for Shadowfang Keep)
    [10019] = 209, -- Shadowfang Keep - The Wall Walk (fake ID for Shadowfang Keep)
    [10020] = 719, -- Blackfathom Deeps - Dungeon - Moonshrine Sanctum
    [10021] = 719, -- Blackfathom Deeps - Dungeon - The Forgotten Pool
    [10022] = 2557, -- Dire Maul - Gordok Commons (fake ID for Dire Maul North)
    [10023] = 2557, -- Dire Maul - Capital Gardens (fake ID for Dire Maul West)
    [10024] = 2557, -- Dire Maul - Court of the Highborne (fake ID for Dire Maul West)
    [10025] = 2557, -- Dire Maul - Prison of Immol'Thar (fake ID for Dire Maul West)
    [10026] = 2557, -- Dire Maul - Warpwood Quarter (fake ID for Dire Maul East)
    [10027] = 2557, -- Dire Maul - The Shrine of Eldretharr (fake ID for Dire Maul East)
    [10028] = 4131, -- Magisters' Terrace - Grand Magister's Asylum (fake ID for Magisters' Terrace)
    [10029] = 1581, -- The Deadmines - Dungeon - Ironclad Cove (fake ID for The Deadmines)
    [10030] = 721, -- Gnomeregan - Dungeon - The Dormitory
    [10031] = 721, -- Gnomeregan - Dungeon - Launch Bay
    [10032] = 721, -- Gnomeregan - Dungeon - Tinkers' Court
    [10033] = 1337, -- Uldaman - Dungeon - Khaz'Goroth's Seat
    [10039] = 5844, -- Hour of Twilight - Wyrmrest Temple
    [10040] = 3428, -- Ahn'Qiraj - Raid - The Hive Undergrounds
    [10041] = 3428, -- Ahn'Qiraj - Raid - Vault of C'thun
    [10042] = 3791, -- Sethekk Halls - Dungeon - Halls of Mourning
    [10043] = 3790, -- Auchenai Crypts - Dungeon - Bridge of Souls
    [10044] = 3848, -- The Mechanar - Dungeon - Calculation Chamber
    [10045] = 3848, -- The Arcatraz - Dungeon - Stasis Block: Maximus
    [10046] = 3848, -- The Arcatraz - Dungeon - Containment Core
    ...
    [10050] = 4273, -- The Descent of Madness -> Ulduar (fake ID for Ulduar)
    ...
    [10061] = 4416, -- Gundrak - Lower Level (fake ID for Gundrak)
    [10062] = 3456, -- Naxxramas - Construct Quarter (fake ID for Naxxramas)
    [10063] = 3456, -- Naxxramas - Arachnid Quarter (fake ID for Naxxramas)
    [10064] = 3456, -- Naxxramas - Military Quarter (fake ID for Naxxramas)
    [10065] = 3456, -- Naxxramas - Plague Quarter (fake ID for Naxxramas)
    [10066] = 3456, -- Naxxramas - Frostwyrm Lair (fake ID for Naxxramas)
    [10067] = 4812, -- Icecrown Citadel -> Rampart of Skulls (fake ID for ICC)
    [10068] = 4812, -- Icecrown Citadel -> Deathbringer's Rise (fake ID for ICC)
    [10069] = 4812, -- Icecrown Citadel -> Sindragosa (fake ID for ICC)
...
ZoneDB.private.subZoneToParentZone = [[return {
  ...
  [214] = 130, -- The Great Sea -> Silverpine Forest
  ...
  [254] = 46, -- Blackrock Mountain -> Burning Steppes
  ...
  [814] = 14, -- Southfury River -> Durotar
  [815] = 17, -- Southfury River -> The Barrens
  ...
  [836] = 11, -- Dun Algaz -> Wetlands
  [837] = 38, -- Dun Algaz -> Loch Modan
  ...
  [878] = 16, -- Southfury River -> Azshara
  [879] = 331, -- Southfury River -> Ashenvale
  [880] = 45, -- Thandol Span -> Arathi Highlands
  [881] = 11, -- Thandol Span -> Wetlands
  ...
  [1057] = 267, -- Thoradin's Wall -> Hillsbrad Foothills
  ...
  [1316] = 17, -- Razorfen Downs -> The Barrens
  [1336] = 440, -- Lost Rigger Cove -> Tanaris
  [1338] = 130, -- Lordamere Lake -> Silverpine Forest
  [1339] = 36, -- Lordamere Lake -> Alterac Mountains
  ...
  [1717] = 17, -- Razorfen Kraul -> The Barrens
  ...
  [1857] = 45, -- Thoradin's Wall -> Arathi Highlands
  ...
  [2279] = 139, -- Stratholme -> Eastern Plaguelands
  ...
  [2300] = 440, -- Caverns of Time -> Tanaris
  ...
  [2318] = 15, -- The Great Sea -> Dustwallow Marsh
  [2319] = 17, -- The Great Sea -> The Barrens
  [2320] = 14, -- The Great Sea -> Durotar
  [2321] = 16, -- The Great Sea -> Azshara
  [2322] = 141, -- The Veiled Sea -> Teldrassil
  [2323] = 357, -- The Veiled Sea -> Feralas
  [2324] = 405, -- The Veiled Sea -> Desolace
  [2325] = 331, -- The Veiled Sea -> Ashenvale
  [2326] = 148, -- The Veiled Sea -> Darkshore
  [2337] = 14, -- Razor Hill Barracks -> Durotar
  [2338] = 33, -- South Seas -> Stranglethorn Vale
  [2339] = 33, -- The Great Sea -> Stranglethorn Vale
  ...
  [2364] = 40, -- The Great Sea -> Westfall
  [2365] = 11, -- The Great Sea -> Wetlands
  ...
  [2377] = 2367, -- Thoradin's Wall -> Old Hillsbrad Foothills
  [2378] = 2367, -- Western Strand -> Old Hillsbrad Foothills
  [2379] = 2367, -- Azurelode Mine -> Old Hillsbrad Foothills
  [2397] = 267, -- The Great Sea -> Hillsbrad Foothills
  [2398] = 130, -- The Great Sea -> Silverpine Forest
  [2399] = 85, -- The Great Sea -> Tirisfal Glades
  [2400] = 47, -- The Forbidding Sea -> The Hinterlands
  [2401] = 45, -- The Forbidding Sea -> Arathi Highlands
  [2402] = 11, -- The Forbidding Sea -> Wetlands
  [2403] = 8, -- The Forbidding Sea -> Swamp of Sorrows
  ...
  [2477] = 1377, -- The Veiled Sea -> Silithus
  ...
  [2562] = 41, -- Karazhan -> Deadwind Pass
  [2563] = 41, -- Morgan's Plot -> Deadwind Pass
  [2577] = 357, -- Dire Maul -> Feralas
  ...
  [2777] = 267, -- UNUSED Alterac Valley -> Hillsbrad Foothills
  [2797] = 331, -- Blackfathom Deeps -> Ashenvale
  [2837] = 41, -- The Master's Cellar -> Deadwind Pass
  [2838] = 51, -- Stonewrought Pass -> Searing Gorge
  [2839] = 36, -- Alterac Valley -> Alterac Mountains
  ...
  [3688] = 3519, -- Auchindoun -> Terokkar Forest
  ...
  [3774] = 3522, -- Gruul's Lair -> Blade's Edge Mountains
  ...
  [3840] = 3520, -- The Black Temple -> Shadowmoon Valley
  ...
  [3846] = 3525, -- The Arcatraz -> Bloodmyst Isle
  ...
  [3905] = 3521, -- Coilfang Reservoir -> Zangarmarsh
  ...
  [3983] = 495, -- Utgarde Keep -> Howling Fjord
  ...
  [4094] = 4080, -- Sunwell Plateau -> Isle of Quel'Danas
  [4095] = 4080, -- Magisters' Terrace -> Isle of Quel'Danas
  ...
  [4120] = 3537, -- The Nexus -> Borean Tundra
  ...
  [4202] = 394, -- Vordrassil's Tears -> Grizzly Hills
  ...
  [4271] = 495, -- Utgarde Pinnacle -> Howling Fjord
  ...
  [4445] = 67, -- Ulduar -> The Storm Peaks
  ...
  [4522] = 210, -- Icecrown Citadel -> Icecrown
  ...
  [4548] = 67, -- Halls of Lightning -> The Storm Peaks
  ...
  [4567] = 4395, -- The Violet Hold -> Dalaran
  ...
  [4635] = 66, -- Drak'Tharon Keep -> Zul'Drak
  ...
  [4859] = 4812, -- The Frozen Throne -> Icecrown Citadel
  [4862] = 210, -- The Frozen Halls -> Icecrown
  [4889] = 4812, -- The Frost Queen's Lair -> Icecrown Citadel
  [4890] = 4812, -- Putricide's Laboratory of Alchemical Horrors and Fun -> Icecrown Citadel
  [4891] = 4812, -- The Sanctum of Blood -> Icecrown Citadel
  [4892] = 4812, -- The Crimson Hall -> Icecrown Citadel
  ...
  [6141] = 5840, -- Shrine of Two Moons -> Vale of Eternal Blossoms
  [6142] = 5840, -- Shrine of Seven Stars -> Vale of Eternal Blossoms
  ...
  [14292] = 14288, -- The Chilled Quagmire -> Battle for Wintergrasp
  [14293] = 14288, -- The Forest of Shadows -> Battle for Wintergrasp
  [14294] = 14288, -- Glacial Falls -> Battle for Wintergrasp
  [14295] = 14288, -- The Cauldron of Flames -> Battle for Wintergrasp
  [14296] = 14288, -- Winter's Edge Tower -> Battle for Wintergrasp
  [14297] = 14288, -- Flamewatch Tower -> Battle for Wintergrasp
  [14298] = 14288, -- Western Bridge -> Battle for Wintergrasp
  [14299] = 14288, -- Central Bridge -> Battle for Wintergrasp
  [14300] = 14288, -- Wintergrasp Fortress -> Battle for Wintergrasp
  [14301] = 14288, -- The Sunken Ring -> Battle for Wintergrasp
  [14302] = 14288, -- Eastern Bridge -> Battle for Wintergrasp
  [14303] = 14288, -- The Broken Temple -> Battle for Wintergrasp
  [14304] = 14288, -- Shadowsight Tower -> Battle for Wintergrasp
  ...
  [14469] = 14141, -- Aldur'thar: The Desolation Gate -> Icecrown
  [14470] = 14141, -- Silent Vigil -> Icecrown
  [14472] = 14471, -- Nidavelir -> The Storm Peaks
  [14473] = 14471, -- Snowdrift Plains -> The Storm Peaks
  [14474] = 14141, -- Sindragosa's Fall -> Icecrown
  [14483] = 14288, -- Uncharted Territory -> Battle for Wintergrasp
}]]
