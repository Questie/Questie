...
ZoneDB.private.subZoneToParentZoneOverride = [[return {
    ...
    [4548] = 4272,  -- Halls of Lightning - The Terrestrial Watchtower (fake ID for Halls of Lightning)
    [3477] = 4277, -- Azjol-Nerub - Hadronox's Lair (fake ID for Azjol-Nerub)
    ...
    [4835] = 4812, -- Rampart of Skulls -> Icecrown Citadel (fake ID for ICC)
    [4836] = 4812, -- Deathbringer's Rise -> Icecrown Citadel (fake ID for ICC)
    [4837] = 4812, -- The Frozen Throne -> Icecrown Citadel (fake ID for ICC)
