...
ZoneDB.private.areaIdToUiMapIdOverride = [[return {
    ...
    [10080] = 453, -- Mogu'shan Palace - The Crimson Assembly Hall (fake ID for Mogu'shan Palace)
    [10081] = 454, -- Mogu'shan Palace - Vaults of Kings Past (fake ID for Mogu'shan Palace)
    [10082] = 455, -- Mogu'shan Palace - Throne of Ancient Conquerors (fake ID for Mogu'shan Palace)
}]]
...
ZoneDB.private.areaIdToUiMapId = [[return {
    ...
    [6182] = 453, -- Mogu'shan Palace - (Dungeon/Raid)
