...
ZoneDB.private.areaIdToUiMapIdOverride = [[return {
    ...
    [1977] = 337, -- Zul'Gurub - Dungeon (override wrong ID) - cata ZG
    ...
    [6219] = 480, -- Arena of Annihilation - (Scenario)
    ...
    [9105] = 390, -- Vale of Eternal Blossoms
    ...
    [10090] = 196, -- Kaja'mine SE
    [10091] = 197, -- Kaja'mine SW
    [10092] = 74, -- Caverns of Time - Timeless Tunnel
    [10093] = 509, -- Throne of Thunder - Royal Amphitheater (Dungeon/Raid)
    [10094] = 510, -- Throne of Thunder - Forgotten Depths (Dungeon/Raid)
    [10095] = 511, -- Throne of Thunder - Roost of Ji-Kun(Dungeon/Raid)
    [10096] = 512, -- Throne of Thunder - Halls of Flesh-Shaping (Dungeon/Raid)
    [10097] = 513, -- Throne of Thunder - Hall of Kings (Dungeon/Raid)
    [10098] = 514, -- Throne of Thunder - Pinnacle of Storms (Dungeon/Raid)
    [10099] = 515, -- Throne of Thunder - Hidden Cell (Dungeon/Raid)
    [10100] = 505, -- Isle of Thunder - Lightning Vein Mine
    [10101] = 506, -- Isle of Thunder - The Swollen Vault
...
ZoneDB.private.areaIdToUiMapId = [[return {
    ...
    [1584] = 242, -- Blackrock Depths - (Dungeon/Raid) -- Detention Block
    [1585] = 243, -- Blackrock Depths - (Dungeon/Raid) -- Shadowforge City
    [1637] = 85, -- Orgrimmar
    [1638] = 88, -- Thunder Bluff
    [1657] = 89, -- Darnassus
    [1717] = 301, -- Razorfen Kraul - (Dungeon/Raid)
    [1941] = 75, -- Caverns of Time
    ...
    [4817] = 181, -- Greymane Manor - Main Floor
    [6545] = 182, -- Greymane Manor - Upper Floor
    ...
    [6109] = 435, -- Scarlet Monastery - (Dungeon/Raid)
    ...
    [6615] = 498, -- Domination Point (Scenario)
    [6616] = 487, -- A Little Patience (Scenario)
