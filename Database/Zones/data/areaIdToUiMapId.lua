...
ZoneDB.private.areaIdToUiMapIdOverride = [[return {
    ...
    [10103] = 351, -- Karazhan - Upper Livery Stables (Dungeon/Raid)
    [10104] = 352, -- Karazhan - The Banquet Hall (Dungeon/Raid)
    [10105] = 353, -- Karazhan - The Guest Chambers (Dungeon/Raid)
    [10106] = 354, -- Karazhan - Opera Hall Balcony (Dungeon/Raid)
    [10107] = 355, -- Karazhan - Master's Terrace (Dungeon/Raid)
    [10108] = 356, -- Karazhan - Lower Broken Stair (Dungeon/Raid)
    [10109] = 357, -- Karazhan - Upper Broken Stair (Dungeon/Raid)
    [10110] = 358, -- Karazhan - The Menagerie (Dungeon/Raid)
    [10111] = 359, -- Karazhan - Guardian's Library (Dungeon/Raid)
    [10112] = 360, -- Karazhan - The Repository (Dungeon/Raid)
    [10113] = 361, -- Karazhan - Upper Library (Dungeon/Raid)
    [10114] = 362, -- Karazhan - The Celestial Watch (Dungeon/Raid)
    [10115] = 363, -- Karazhan - Gamesman's Hall (Dungeon/Raid)
    [10116] = 364, -- Karazhan - Medivh's Chambers (Dungeon/Raid)
    [10117] = 365, -- Karazhan - The Power Station (Dungeon/Raid)
    [10118] = 366, -- Karazhan - Netherspace (Dungeon/Raid)
    [15475] = 1440, -- Demon Fall Canyon (SoD Dungeon) (fake ID, mapped to Ashenvale)
    [15531] = 1419, -- The Tainted Scar (SoD Raid) (fake ID, mapped to Blasted Lands)
    [15828] = 1423, -- The Burning of Andorhal (SoD Solo Dungeon) (fake ID, mapped to Eastern Plaguelands)
    [16074] = 1430, -- Karazhan Crypts (SoD Dungeon) (fake ID, mapped to Deadwind Pass)
    [16236] = 1423, -- Scarlet Enclave (SoD Raid) (fake ID, mapped to Eastern Plaguelands)

    -- WOW FOREVER ENTRIES BEGIN
...
ZoneDB.private.areaIdToUiMapId = [[return {
    ...
    [1584] = 242, -- Blackrock Depths - Dungeon -- Detention Block
    [1585] = 243, -- Blackrock Depths - Dungeon -- Shadowforge City
    [1637] = 1454, -- Orgrimmar
