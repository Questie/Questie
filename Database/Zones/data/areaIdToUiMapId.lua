...
ZoneDB.private.areaIdToUiMapIdOverride = [[return {
    ...
    [3477] = 158, -- Azjol-Nerub - Hadronox's Lair (correct(?) ID for Azjol-Nerub)
    [4301] = 157, -- Azjol-Nerub - The Brood Pit (fake ID for Azjol-Nerub)
    [4548] = 139, -- Halls of Lightning - The Terrestrial Watchtower (correct ID for Halls of Lightning)
