...
ZoneDB.private.uiMapIdToAreaIdOverride = [[return {
    ...
    [139] = 4548, -- Halls of Lightning - The Terrestrial Watchtower (fake ID for Halls of Lightning)
    ...
    [158] = 3477, -- Azjol-Nerub - Hadronox's Lair (fake ID for Azjol-Nerub)
    ...
    [149] = 10050, -- Ulduar - The Inner Sanctum of Ulduar (fake ID for Ulduar)
    [150] = 10051, -- Ulduar - The Descent of Madness (fake ID for Ulduar)
    [151] = 10052, -- Ulduar - The Spark of Imagination (fake ID for Ulduar)
