...
ZoneDB.zoneIDs = {
    ...
    BLACKROCK_SPIRE = 1583, -- this is also Hall of Blackhand map for Blackrock Spire
    ...
    KARAZHAN = 3457, -- this is also Servant's Quarters map for Karazhan
    ...
    SCARLET_MONASTERY_MOP = 6109, -- Scarlet Monastery MoP -- Forlorn Cloister map
