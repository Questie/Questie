...
if Questie.IsCata then
    dungeons[491][3] = 4709
    dungeons[491][4] = {{4709, 41, 94.6}}
    dungeons[717][4] = {{1519, 52.4, 70}}
    dungeons[718][4] = {{17, 38.9, 69.1}}
    dungeons[719][4] = {{331, 14.2, 13.9}}
    dungeons[721][4] = {{1, 31.1, 37.9}}
    dungeons[722][3] = 400
    dungeons[722][4] = {{400, 41.5, 29.4}}
    dungeons[796][4] = {{85, 82.5, 33.3}}
    dungeons[1176][4] = {{440, 39.2, 21.3}}
    dungeons[1337][4] = {{3, 41.7, 11.6}, {3, 58.6, 37}}
    dungeons[1477][4] = {{8, 69.7, 53.5}}
    dungeons[1581][4] = {{40, 42.6, 71.8}}
    dungeons[1583][4] = {{51, 34.9, 83.9}, {46, 21, 37.9}}
    dungeons[1584][4] = {{51, 34.9, 83.9}, {46, 21, 37.9}}
    dungeons[1977][4] = {{33, 72.1, 32.9}}
    dungeons[2017][4] = {{139, 27.7, 11.5}, {139, 47.9, 24}}
    dungeons[2100][4] = {{405, 29.1, 62.6}}
    dungeons[2257][4] = {{1519, 69.49, 31.2}, {1537, 84.1, 53.1}}
    dungeons[2366][4] = {{440, 64.8, 50}}
    dungeons[2367][4] = {{440, 64.8, 50}}
    dungeons[2437][4] = {{1637, 55.2, 51.2}}
    dungeons[2557][4] = {{357, 62.1, 30.2}}
    dungeons[2677][4] = {{51, 34.9, 83.9}, {46, 21, 37.9}}
    dungeons[2717][4] = {{51, 34.9, 83.9}, {46, 21, 37.9}}
    dungeons[3428][4] = {{1377, 24.4, 87.5}}
    dungeons[3429][4] = {{1377, 36.5, 93.9}}
    dungeons[3456][4] = {{65, 87.4, 51.1}}
    dungeons[3606][4] = {{440, 64.8, 50}}
    dungeons[4100][4] = {{440, 64.8, 50}}
    dungeons[7307][4] = {{51, 34.9, 83.9}, {46, 21, 37.9}}
elseif Questie.IsWotlk then
    dungeons[717][4] = {{1519, 52.4, 70}}
    dungeons[2257][4] = {{1519, 72, 28}, {1537, 84.1, 53.1}}
    dungeons[3456][4] = {{65, 87.4, 51.1}}
end
