...
ZoneDB.private.dungeonLocations = {
    ...
    [209] = {{130, 44.8, 67.8}},
    [491] = {{17, 42.3, 89.9}},
    [717] = {((Questie.IsWotlk or Questie.IsCata) and {1519, 52.4, 70}) or {1519, 40.5, 55.9}},
    [718] = {(Questie.IsCata and {17, 38.9,69.1} or {17, 46, 36.5})},
    [719] = {(Questie.IsCata and {331, 14.2, 13.9} or {331, 14.5, 14.2})},
    [721] = {{1, 24.4, 39.8}},
    [722] = {{17, 50.8, 92.8}},
    [796] = {{85, 82.6, 33.8}},
    [1176] = {{440, 38.7, 20.1}},
    ...
    [1977] = {Questie.IsCata and {33, 72.1, 32.8} or {33, 53.8, 17.5}},
    [2017] = {{139, 27.1, 15.7}, {139, 43.5, 19.4}},
    [2057] = {{28, 69.7, 73.2}},
    [2100] = {{405, 29.1, 62.5}},
    [2159] = {{15, 52.6, 76.8}},
    [2257] = {(Questie.IsWotlk or Questie.IsCata) and {1519, 72, 28} or {1519, 67.6, 4.1}, {1537, 84.1, 53.1}},
    [2366] = {{440, 65.7, 49.8}},
    [2367] = {{440, 65.7, 49.8}},
    [2437] = {{1637, 51.7, 49.8}},
    [2557] = {{357, 59.2, 45.1}},
    [3456] = {(Questie.IsWotlk or Questie.IsCata) and {65, 87.4, 51.1} or {139, 39.9, 25.8}},
    [2597] = {{36, 66.6, 51.3},},
