...
ZoneDB.private.dungeons = {
    ...
    [491] = {"Razorfen Kraul", 1717, Questie.IsCata and 4709 or 17},
    [717] = {"The Stockade", nil, 1519},
    [718] = {"Wailing Caverns", nil, 17},
    [719] = {"Blackfathom Deeps", 2797, 331},
    [721] = {"Gnomeregan", 133, 1},
    [722] = {"Razorfen Downs", 1316, Questie.IsCata and 400 or 17},
...
ZoneDB.private.dungeonLocations = {
    ...
    [491] = {(Questie.IsCata and {4709, 41, 94.6}) or {17, 42.3, 89.9}}, -- Razorfen Kraul
    [717] = {((Questie.IsWotlk or Questie.IsCata) and {1519, 52.4, 70}) or {1519, 40.5, 55.9}}, -- The Stockade
    [718] = {(Questie.IsCata and {17, 38.9, 69.1}) or {17, 46, 36.5}}, -- Wailing Caverns
    [719] = {(Questie.IsCata and {331, 14.2, 13.9}) or {331, 14.5, 14.2}}, -- Blackfathom Deeps
    [721] = {(Questie.IsCata and {1, 31.1, 37.9}) or {1, 24.4, 39.8}}, -- Gnomeregan
    [722] = {(Questie.IsCata and {400, 41.5, 29.4}) or {17, 50.8, 92.8}}, -- Razorfen Downs
    [796] = {(Questie.IsCata and {85, 82.5, 33.3}) or {85, 82.6, 33.8}}, -- Scarlet Monastery
    [1176] = {(Questie.IsCata and {440, 39.2, 21.3}) or {440, 38.7, 20.1}}, -- Zul'Farrak
    [1196] = {{495, 57.3, 46.8}}, -- Utgarde Pinnacle
    [1337] = {(Questie.IsCata and {3, 41.7, 11.6}) or {3, 44.4, 12.2}, (Questie.IsCata and {3, 58.6, 37}) or {3, 65.2, 43.5}}, -- Uldaman
    [1417] = {(Questie.IsCata and {8, 69.7, 53.5}) or {8, 69.9, 53.5}}, -- The Temple of Atal'Hakkar
    [1477] = {(Questie.IsCata and {8, 69.7, 53.5}) or {8, 69.9, 53.5}}, -- The Temple of Atal'Hakkar
    [1581] = {(Questie.IsCata and {40, 42.6, 71.8}) or {40, 42.5, 71.7}}, -- The Deadmines
    [1583] = {(Questie.IsCata and {51, 34.9, 83.9}) or {51, 34.8, 85.3}, (Questie.IsCata and {46, 21, 37.9}) or {46, 29.4, 38.3}}, -- Blackrock Spire
    [1584] = {(Questie.IsCata and {51, 34.9, 83.9}) or {51, 34.8, 85.3}, (Questie.IsCata and {46, 21, 37.9}) or {46, 29.4, 38.3}}, -- Blackrock Depths
    [1585] = {(Questie.IsCata and {51, 34.9, 83.9}) or {51, 34.8, 85.3}, (Questie.IsCata and {46, 21, 37.9}) or {46, 29.4, 38.3}}, -- Blackrock Depths
    [1977] = {(Questie.IsCata and {33, 72.1, 32.9}) or {33, 53.8, 17.5}}, -- Zul'Gurub
    [2017] = {(Questie.IsCata and {139, 27.7, 11.5}) or {139, 27.1, 15.7}, {139, 43.5, 19.4}}, -- Stratholme
    ...
    [2557] = {(Questie.IsCata and {357, 62.1, 30.2}) or {357, 59.2, 45.1}}, -- Dire Maul
    [3456] = {((Questie.IsWotlk or Questie.IsCata) and {65, 87.4, 51.1}) or {139, 39.9, 25.8}}, -- Naxxramas
    [2597] = {{36, 66.6, 51.3},}, -- Alterac Valley
    [2677] = {(Questie.IsCata and {51, 34.9, 83.9}) or {51, 34.8, 85.3}, (Questie.IsCata and {46, 21, 37.9}) or {46, 29.4, 38.3}}, -- Blackwing Lair
    [2717] = {(Questie.IsCata and {51, 34.9, 83.9}) or {51, 34.8, 85.3}, (Questie.IsCata and {46, 21, 37.9}) or {46, 29.4, 38.3}}, -- Molten Core
    [2917] = {{1637, 40.4, 68.3}}, -- Hall of Legends
    [2918] = {{1519, 72.7, 54}}, -- Champion's Hall
    [3428] = {(Questie.IsCata and {1377, 24.4, 87.5}) or {1377, 28.6, 92.3}}, -- TempleTemple of Ahn'Qiraj
    [3429] = {(Questie.IsCata and {1377, 36.5, 93.9}) or {1377, 28.6, 92.3}}, -- Ruins of Ahn'Qiraj
    [3457] = {{41, 46.7, 70.2},{41, 46.9, 74.7}}, -- Karazhan
    [3562] = {{3483, 47.7, 53.6}}, -- Hellfire Ramparts
    [3606] = {(Questie.IsCata and {440, 64.8, 50}) or {440, 65.7, 49.8}}, -- Hyjal Summit
    [3607] = {{3521, 50.4, 40.9}}, -- Serpentshrine Cavern
    ...
    [3959] = {{3520, 71.1, 46.3}}, -- The Black Temple
    [4075] = {{4080, 44.3, 45.5}}, -- Sunwell Plateau
    [4100] = {(Questie.IsCata and {440, 64.8, 50}) or {440, 65.7, 49.8}}, -- The Culling of Stratholme
    ...
    [4722] = {{210, 75.1, 21.8}}, -- Trial of the Crusader, Raid
    [4723] = {{210, 74.2, 20.5}}, -- Trial of the Champion, Dungeon
    ...
    [4926] = {(Questie.IsCata and {51, 34.9, 83.9}) or {51, 34.8, 85.3}, (Questie.IsCata and {46, 21, 37.9}) or {46, 29.4, 38.3}}, -- Blackrock Caverns, Dungeon
    ...
    [5723] = {Questie.IsCata and {616, 47.3, 78.0}}, -- Firelands, Raid
