...
function SeasonOfDiscovery:LoadBaseQuests()
    ...
    return {
        ...
        [89229] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.NONE,
            [questKeys.objectivesText] = {"Speak with Leonid Bartholomew the Revered at Light's Hope Chapel to receive your reward."},
            [questKeys.objectives] = nil,
        },
        [89234] = {
        ...
        [89310] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.NONE,
            [questKeys.objectivesText] = {"Travel to Terrordale and find Leonid Bartholomew the Revered at one of the houses there."},
            [questKeys.objectives] = nil,
        },
        [89328] = {
            [questKeys.name] = "Loss",
