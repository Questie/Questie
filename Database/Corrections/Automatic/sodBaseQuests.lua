...
function SeasonOfDiscovery:LoadBaseQuests()
    ...
    return {
        ...
        [78226] = { -- This quest is not in the game. It's a placeholder fake quest to make the quest chain work.
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.DRUID,
            [questKeys.objectivesText] = {"Obtain 1 symbol of the owl to start the Trial of The Owls quest chain."},
            [questKeys.objectives] = {nil,nil,{{210026}}},
        },
        [78227] = { -- This quest is not in the game. It's a placeholder fake quest to make the quest chain work.
            [questKeys.name] = "Trial of The Owls",
            [questKeys.startedBy] = nil,
            [questKeys.finishedBy] = {{12042,}},
            [questKeys.requiredLevel] = 1,
            ...
            [questKeys.requiredClasses] = classIDs.DRUID,
            [questKeys.objectivesText] = {"Obtain 1 symbol of the owl to start the Trial of The Owls quest chain."},
            [questKeys.objectives] = {nil,nil,{{210043}}},
        },
        [78228] = { -- This quest is not in the game. It's a placeholder fake quest to make the quest chain work.
            [questKeys.name] = "Trial of The Owls",
            [questKeys.startedBy] = nil,
            [questKeys.finishedBy] = {{12042,}},
            [questKeys.requiredLevel] = 1,
            ...
            [questKeys.requiredClasses] = classIDs.DRUID,
            [questKeys.objectivesText] = {"Obtain 1 symbol of the owl to start the Trial of The Owls quest chain."},
            [questKeys.objectives] = {nil,nil,{{210044}}},
        },
        [78229] = {
            [questKeys.name] = "Trial of The Owls",
