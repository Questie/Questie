...
function SeasonOfDiscovery:LoadBaseQuests()
    ...
    return {
        ...
        [84350] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.NONE,
            [questKeys.objectivesText] = {"Evonice Sootsmoker wants you to slay 12 Obsidian Reavers in the Searing Gorge. The Obsidian Reavers can be found all along the southern section of Searing Gorge, and near the entrance the Blackrock Mountain."},
