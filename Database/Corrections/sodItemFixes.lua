...
function SeasonOfDiscovery:LoadItems()
    ...
    return {
        ...
        [234011] = { -- Qiraji Stalker Venom
            [itemKeys.npcDrops] = {6551,6552,6553,6554,6555,6582,11698,11722,11723,11724,11726,11727,11728,11729,11730,11732,11733,11734,13136,15235,15236,15325,15327,15509},
        },
