...
function SeasonOfDiscovery:LoadItems()
    ...
    return {
        ...
        [234006] = { -- Monstrous Silithid Chitin
            [itemKeys.npcDrops] = {11698,11722,11724,11727,11729,11730,13136,15240,15286,15288,15341,15348,234798},
        },
        ...
        [234011] = { -- Qiraji Stalker Venom
            [itemKeys.npcDrops] = {6551,6552,6553,6554,6555,6582,10040,11698,11722,11723,11724,11725,11726,11727,11728,11729,11730,11732,11733,11734,13136,15235,15236,15325,15327,15509},
        },
