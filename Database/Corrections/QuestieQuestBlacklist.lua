...
function QuestieQuestBlacklist:Load()
    local questsToBlacklist = {
        ...
        [5283] = QuestieCorrections.WOTLK_ONLY, -- removed in wotlk
        [5284] = QuestieCorrections.WOTLK_ONLY, -- removed in wotlk
        [5301] = QuestieCorrections.WOTLK_ONLY, -- removed in wotlk
        [5302] = QuestieCorrections.WOTLK_ONLY, -- removed in wotlk
