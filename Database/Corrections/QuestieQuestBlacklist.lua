...
function QuestieQuestBlacklist:Load()
    local questsToBlacklist = {
        ...
        -- First Pre-Event
        [25444] = QuestieCorrections.CATA_HIDE, -- Da Perfect Spies
        [25445] = QuestieCorrections.CATA_HIDE, -- Zalazane's Fall
        [25446] = QuestieCorrections.CATA_HIDE, -- Frogs Away!
        [25461] = QuestieCorrections.CATA_HIDE, -- Trollin' For Volunteers
        [25470] = QuestieCorrections.CATA_HIDE, -- Lady Of Da Tigers
        [25480] = QuestieCorrections.CATA_HIDE, -- Dance Of De Spirits
        [25495] = QuestieCorrections.CATA_HIDE, -- Preparin' For Battle

        -- Second Pre-event
        [25571] = QuestieCorrections.CATA_HIDE, -- A Natural Occurrence
        [25773] = QuestieCorrections.CATA_HIDE, -- A Natural Occurrence
        [27473] = QuestieCorrections.CATA_HIDE, -- What's Shaking in Ironforge
        [27546] = QuestieCorrections.CATA_HIDE, -- Speak with Captain Anton
        [27566] = QuestieCorrections.CATA_HIDE, -- A Gathering in Outland
        [27572] = QuestieCorrections.CATA_HIDE, -- A Gathering in Outland
        [25180] = QuestieCorrections.CATA_HIDE, -- Tablets of the Earth
        [25181] = QuestieCorrections.CATA_HIDE, -- Tablets of Fire
        [26054] = QuestieCorrections.CATA_HIDE, -- Water They Up To?
        [26990] = QuestieCorrections.CATA_HIDE, -- Water They Up To?
        [27137] = QuestieCorrections.CATA_HIDE, -- Earth Girls Aren't So Easy
        [27138] = QuestieCorrections.CATA_HIDE, -- Earth Girls Aren't So Easy
        [27122] = QuestieCorrections.CATA_HIDE, -- Fired Up and Not So Good To Go.
        [27127] = QuestieCorrections.CATA_HIDE, -- Fired Up and Not So Good To Go.
        [27207] = QuestieCorrections.CATA_HIDE, -- This Blows
        [27209] = QuestieCorrections.CATA_HIDE, -- This Blows

        -- Phase 2 - Rise of the Zandalari

        [29100] = QuestieCorrections.CATA_HIDE, -- Bwemba's Spirit
        [29102] = QuestieCorrections.CATA_HIDE, -- To Fort Livingston
        [29153] = QuestieCorrections.CATA_HIDE, -- Booty Bay's Interests
        [29157] = QuestieCorrections.CATA_HIDE, -- The Zandalari Menace
        [29158] = QuestieCorrections.CATA_HIDE, -- The Zandalar Representative
        [29172] = QuestieCorrections.CATA_HIDE, -- The Beasts Within
        [29173] = QuestieCorrections.CATA_HIDE, -- Secondary Targets
        [29175] = QuestieCorrections.CATA_HIDE, -- Break Their Spirits
        [29177] = QuestieCorrections.CATA_HIDE, -- Vigilance on Wings
        [29208] = QuestieCorrections.CATA_HIDE, -- An Old Friend
        [29219] = QuestieCorrections.CATA_HIDE, -- Bwemba's Spirit
        [29220] = QuestieCorrections.CATA_HIDE, -- To Bambala
        [29229] = QuestieCorrections.CATA_HIDE, -- Follow That Cat
        [29241] = QuestieCorrections.CATA_HIDE, -- Break the Godbreaker
        [29242] = QuestieCorrections.CATA_HIDE, -- Putting a Price on Priceless
        [29251] = QuestieCorrections.CATA_HIDE, -- Booty Bay's Interests
        [29252] = QuestieCorrections.CATA_HIDE, -- Booty Bay's Interests

        -- Phase 3 - Rage of the Firelands

        [29129] = QuestieCorrections.CATA_HIDE, -- A Legendary Engagement
        [29132] = QuestieCorrections.CATA_HIDE, -- A Legendary Engagement
        [29326] = QuestieCorrections.CATA_HIDE, -- The Nordrassil Summit
        [29387] = QuestieCorrections.CATA_HIDE, -- Guardians of Hyjal: Firelands Invasion!
        [29388] = QuestieCorrections.CATA_HIDE, -- Guardians of Hyjal: Firelands Invasion!
        [29389] = QuestieCorrections.CATA_HIDE, -- Guardians of Hyjal: Firelands Invasion!
        [29390] = QuestieCorrections.CATA_HIDE, -- Guardians of Hyjal: Call of the Ancients
        [29391] = QuestieCorrections.CATA_HIDE, -- Guardians of Hyjal: Call of the Ancients
        [29437] = QuestieCorrections.CATA_HIDE, -- The Fallen Guardian
        [29439] = QuestieCorrections.CATA_HIDE, -- The Call of the World-Shaman
        [29440] = QuestieCorrections.CATA_HIDE, -- The Call of the World-Shaman
        [29452] = QuestieCorrections.CATA_HIDE, -- Your Time Has Come
        [29453] = QuestieCorrections.CATA_HIDE, -- Your Time Has Come
        [30094] = QuestieCorrections.CATA_HIDE, -- The End Time
        [30095] = QuestieCorrections.CATA_HIDE, -- The End Time

        -- Darkmoon Faire
        [27664] = QuestieCorrections.CATA_HIDE, -- Darkmoon Volcanic Deck
        [27665] = QuestieCorrections.CATA_HIDE, -- Darkmoon Hurricane Deck
        [27666] = QuestieCorrections.CATA_HIDE, -- Darkmoon Tsunami Deck
        [27667] = QuestieCorrections.CATA_HIDE, -- Darkmoon Earthquake Deck
        [29433] = QuestieCorrections.CATA_HIDE, -- Test Your Strength
        [29434] = QuestieCorrections.CATA_HIDE, -- Tonk Commander
        [29436] = QuestieCorrections.CATA_HIDE, -- The Humanoid Cannonball
        [29438] = QuestieCorrections.CATA_HIDE, -- He Shoots, He Scores!
        [29443] = QuestieCorrections.CATA_HIDE, -- A Curious Crystal
        [29444] = QuestieCorrections.CATA_HIDE, -- An Exotic Egg
        [29445] = QuestieCorrections.CATA_HIDE, -- An Intriguing Grimoire
        [29446] = QuestieCorrections.CATA_HIDE, -- A Wondrous Weapon
        [29451] = QuestieCorrections.CATA_HIDE, -- The Master Strategist
        [29455] = QuestieCorrections.CATA_HIDE, -- Target: Turtle
        [29456] = QuestieCorrections.CATA_HIDE, -- A Captured Banner
        [29457] = QuestieCorrections.CATA_HIDE, -- The Enemy's Insignia
        [29458] = QuestieCorrections.CATA_HIDE, -- The Captured Journal
        [29463] = QuestieCorrections.CATA_HIDE, -- It's Hammer Time
        [29464] = QuestieCorrections.CATA_HIDE, -- Tools of Divination
        [29506] = QuestieCorrections.CATA_HIDE, -- A Fizzy Fusion
        [29507] = QuestieCorrections.CATA_HIDE, -- Fun for the Little Ones
        [29508] = QuestieCorrections.CATA_HIDE, -- Baby Needs Two Pair of Shoes
        [29509] = QuestieCorrections.CATA_HIDE, -- Putting the Crunch in the Frog
        [29510] = QuestieCorrections.CATA_HIDE, -- Putting Trash to Good Use
        [29511] = QuestieCorrections.CATA_HIDE, -- Talkin' Tonks
        [29513] = QuestieCorrections.CATA_HIDE, -- Spoilin' for Salty Sea Dogs
        [29514] = QuestieCorrections.CATA_HIDE, -- Herbs for Healing
        [29515] = QuestieCorrections.CATA_HIDE, -- Writing the Future
        [29516] = QuestieCorrections.CATA_HIDE, -- Keeping the Faire Sparkling
        [29517] = QuestieCorrections.CATA_HIDE, -- Eyes on the Prizes
        [29518] = QuestieCorrections.CATA_HIDE, -- Rearm, Reuse, Recycle
        [29519] = QuestieCorrections.CATA_HIDE, -- Tan My Hide
        [29520] = QuestieCorrections.CATA_HIDE, -- Banners, Banners Everywhere!
        [29601] = QuestieCorrections.CATA_HIDE, -- The Darkmoon Field Guide
        [29760] = QuestieCorrections.CATA_HIDE, -- Pit Fighter
        [29761] = QuestieCorrections.CATA_HIDE, -- Master Pit Fighter

        -- Love is in the Air
        [14483] = QuestieCorrections.CATA_HIDE, -- Something is in the Air (and it Ain't Love)
        [24745] = QuestieCorrections.CATA_HIDE, -- Something is in the Air (and it Ain't Love)
        [28935] = QuestieCorrections.CATA_HIDE, -- Crushing the Crown

        -- Day of the Dead
        [13952] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14166] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14167] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14168] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14169] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14170] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14171] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14172] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14173] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14174] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14175] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14176] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [14177] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [27841] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead
        [27846] = QuestieCorrections.CATA_HIDE, -- The Grateful Dead

        -- Children's Week
        [28879] = QuestieCorrections.CATA_HIDE, -- Back To The Orphanage
        [28880] = QuestieCorrections.CATA_HIDE, -- Back To The Orphanage
        [29093] = QuestieCorrections.CATA_HIDE, -- Cruisin' the Chasm
        [29106] = QuestieCorrections.CATA_HIDE, -- The Biggest Diamond Ever!
        [29107] = QuestieCorrections.CATA_HIDE, -- Malfurion Has Returned!
        [29117] = QuestieCorrections.CATA_HIDE, -- Let's Go Fly a Kite
        [29119] = QuestieCorrections.CATA_HIDE, -- You Scream, I Scream...
        [29146] = QuestieCorrections.CATA_HIDE, -- Ridin' the Rocketway
        [29167] = QuestieCorrections.CATA_HIDE, -- The Banshee Queen
        [29176] = QuestieCorrections.CATA_HIDE, -- The Fallen Chieftain
        [29190] = QuestieCorrections.CATA_HIDE, -- Let's Go Fly a Kite
        [29191] = QuestieCorrections.CATA_HIDE, -- You Scream, I Scream...

        -- Midsummer
        [28910] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28911] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28912] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28913] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28914] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28915] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28916] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28917] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28918] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28919] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28920] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28921] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28922] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28923] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28924] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28925] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28926] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28927] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28928] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28929] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28930] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28931] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28932] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28933] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28943] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28944] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28945] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28946] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28947] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28948] = QuestieCorrections.CATA_HIDE, -- Desecrate this Fire!
        [28949] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [28950] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [29030] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [29031] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [29036] = QuestieCorrections.CATA_HIDE, -- Honor the Flame
        [29092] = QuestieCorrections.CATA_HIDE, -- Inform the Elder

        -- Hallow's End
        [28934] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28951] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28952] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28953] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28954] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28955] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28956] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28957] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28958] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28959] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28960] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28961] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28962] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28963] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28964] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28965] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28966] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28967] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28968] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28969] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28970] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28971] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28972] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28973] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28974] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28975] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28976] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28977] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28978] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28979] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28980] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28981] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28982] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28983] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28984] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28985] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28986] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28987] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28988] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28989] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28990] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28991] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28992] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28993] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28994] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28995] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28996] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28997] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28998] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [28999] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29000] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29001] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29002] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29003] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29004] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29005] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29006] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29007] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29008] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29009] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29010] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29011] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29012] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29013] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29014] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29016] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29017] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29018] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29019] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29020] = QuestieCorrections.CATA_HIDE, -- Candy Bucket
        [29054] = QuestieCorrections.CATA_HIDE, -- Stink Bombs Away!
        [29074] = QuestieCorrections.CATA_HIDE, -- A Season for Celebration
        [29075] = QuestieCorrections.CATA_HIDE, -- A Time to Gain
        [29144] = QuestieCorrections.CATA_HIDE, -- Clean Up in Stormwind
        [29371] = QuestieCorrections.CATA_HIDE, -- A Time to Lose
        [29374] = QuestieCorrections.CATA_HIDE, -- Stink Bombs Away!
        [29375] = QuestieCorrections.CATA_HIDE, -- Clean Up in Undercity
        [29376] = QuestieCorrections.CATA_HIDE, -- A Time to Build Up
        [29377] = QuestieCorrections.CATA_HIDE, -- A Time to Break Down
        [29392] = QuestieCorrections.CATA_HIDE, -- Missing Heirlooms
        [29398] = QuestieCorrections.CATA_HIDE, -- Fencing the Goods
        [29399] = QuestieCorrections.CATA_HIDE, -- Shopping Around
        [29400] = QuestieCorrections.CATA_HIDE, -- A Season for Celebration
        [29402] = QuestieCorrections.CATA_HIDE, -- Taking Precautions
        [29403] = QuestieCorrections.CATA_HIDE, -- The Collector's Agent
        [29411] = QuestieCorrections.CATA_HIDE, -- What Now?
        [29415] = QuestieCorrections.CATA_HIDE, -- Missing Heirlooms
        [29416] = QuestieCorrections.CATA_HIDE, -- Fencing the Goods
        [29425] = QuestieCorrections.CATA_HIDE, -- Shopping Around
        [29426] = QuestieCorrections.CATA_HIDE, -- Taking Precautions
        [29427] = QuestieCorrections.CATA_HIDE, -- The Collector's Agent
        [29428] = QuestieCorrections.CATA_HIDE, -- What Now?
        [29430] = QuestieCorrections.CATA_HIDE, -- A Friend in Need
        [29431] = QuestieCorrections.CATA_HIDE, -- A Friend in Need

        -- Winter's Veil
        [13966] = QuestieCorrections.CATA_HIDE, -- A Winter Veil Gift
        [29382] = QuestieCorrections.CATA_HIDE, -- Thanks, But No Thanks
        [29383] = QuestieCorrections.CATA_HIDE, -- Thanks, But No Thanks
        [29385] = QuestieCorrections.CATA_HIDE, -- A Winter Veil Gift
        [28878] = QuestieCorrections.CATA_HIDE, -- A Winter Veil Gift

        -- Brewfest
        [11413] = QuestieCorrections.CATA_HIDE, -- Did Someone Say "Souvenir?"
        [29393] = QuestieCorrections.CATA_HIDE, -- Brew For Brewfest
        [29394] = QuestieCorrections.CATA_HIDE, -- Brew For Brewfest
        [29396] = QuestieCorrections.CATA_HIDE, -- A New Supplier of Souvenirs
        [29397] = QuestieCorrections.CATA_HIDE, -- A New Supplier of Souvenirs

        -- Lunar Festival
        [29734] = QuestieCorrections.CATA_HIDE, -- Deepforge the Elder
        [29735] = QuestieCorrections.CATA_HIDE, -- Stonebrand the Elder
        [29736] = QuestieCorrections.CATA_HIDE, -- Darkfeather the Elder
        [29737] = QuestieCorrections.CATA_HIDE, -- Firebeard the Elder
        [29738] = QuestieCorrections.CATA_HIDE, -- Moonlance the Elder
        [29739] = QuestieCorrections.CATA_HIDE, -- Windsong the Elder
        [29740] = QuestieCorrections.CATA_HIDE, -- Evershade the Elder
        [29741] = QuestieCorrections.CATA_HIDE, -- Sekhemi the Elder
        [29742] = QuestieCorrections.CATA_HIDE, -- Menkhaf the Elder
