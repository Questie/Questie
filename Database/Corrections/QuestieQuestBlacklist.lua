...
function QuestieQuestBlacklist:Load()
    local questsToBlacklist = {
		...
		[1884] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		...
		[1921] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1938] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1943] = QuestieCorrections.CATA_HIDE, -- Removed with cata
		[1940] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1945] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1944] = QuestieCorrections.CATA_HIDE, -- Removed with cata
		[1947] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1948] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1949] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1950] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1951] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1953] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1954] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1955] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1956] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1957] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1960] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[1961] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		...
		[7463] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
        [7492] = QuestieCorrections.CATA_HIDE, -- Removed with cata
		[8251] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
		[8252] = QuestieCorrections.CATA_HIDE, -- Nemoved with cata
