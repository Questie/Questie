...
function SeasonOfDiscovery:LoadQuests()
    ...
    return {
        ...
        [90209] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.ROGUE,
            [questKeys.objectivesText] = {"Loot the Lighthouse Stash under the right of the tree to receive the rune."},
        ...
        [90213] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.ROGUE,
            [questKeys.objectivesText] = {"Use Sprint and jump to the Rusty Chest on the platform and open it to receive the rune. NOTE: You need to have learnt Sprint to make the jump."},
            [questKeys.requiredSpell] = -424984,
            [questKeys.zoneOrSort] = sortKeys.ROGUE,
        },
    }
