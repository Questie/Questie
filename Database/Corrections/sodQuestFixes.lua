...
function SeasonOfDiscovery:LoadQuests()
    ...
    return {
        ...
        [90077] = {
            ...
            [questKeys.startedBy] = {{1124,1397,300005,300014,1134,1135,300015,705,704,1131,1133,1138,300016,204070,300017}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 8,
            [questKeys.requiredRaces] = raceIDs.ALL_ALLIANCE,
        ...
        [90078] = {
            [questKeys.name] = "Demonic Grace",
            [questKeys.startedBy] = {{476,474,300018,97,478,300019,299,525,69,1922,118,300029,204070,300025}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 8,
            [questKeys.requiredRaces] = raceIDs.ALL_ALLIANCE,
        ...
        [90079] = {
            [questKeys.name] = "Demonic Grace",
            [questKeys.startedBy] = {{3206,3207,3113,3198,3118,300020,3103,3104,300021,3128,3129,300022,204070,300023}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 8,
            [questKeys.requiredRaces] = raceIDs.ALL_HORDE,
        ...
        [90080] = {
            [questKeys.name] = "Demonic Grace",
            [questKeys.startedBy] = {{1522,300026,1675,1941,1674,1675,300027,1547,1548,1549,300028,204070,300024}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 8,
            [questKeys.requiredRaces] = raceIDs.ALL_HORDE,
