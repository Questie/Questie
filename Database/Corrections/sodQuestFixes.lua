...
function SeasonOfDiscovery:LoadQuests()
    ...
    return {
        ...
        [88729] = { -- Ramaladni's Icy Grasp
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.NONE,
            [questKeys.objectivesText] = {"Korfax at Light's Hope Chapel in the Eastern Plaguelands wants you to bring him 1 Frozen Rune, 1 Blue Sapphire and 1 Arcanite Bar."},
