...
function SeasonOfDiscovery:LoadQuests()
    ...
    return {
        ...
        [90140] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.WARRIOR,
            [questKeys.objectivesText] = {"Kill Defias for Gillsbane. Then kill Murlocs for Soul of the Sea. Take it to the Idol of the Deep, and interact with it. Kill the mob, and loot the rune."},
            [questKeys.requiredSpell] = -425443,
            [questKeys.zoneOrSort] = sortKeys.WARRIOR,
        },
    }
