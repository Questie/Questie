...
function SeasonOfDiscovery:LoadQuests()
    ...
    return {
        ...
        [90208] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.HUNTER,
            [questKeys.objectivesText] = {"Kill Razermane Quillboars until Adder Pheromone drops, consume it and use Tame Beast on a Adder critter, then speak to Razzil in Razor Hill to receive the rune."},
            [questKeys.requiredSpell] = -425758,
            [questKeys.zoneOrSort] = sortKeys.HUNTER,
        },
        [90209] = {
