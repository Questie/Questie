...
function SeasonOfDiscovery:LoadQuests()
    ...
    return {
        ...
        [90206] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.HUNTER,
            [questKeys.objectivesText] = {"Kill Rockjaw Troggs until Rabbit Musk drops, consume it and use Tame Beast on a Rabbit critter, then speak to Toby at Amberstill Ranch to receieve the rune."},
        ...
        [90207] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.HUNTER,
            [questKeys.objectivesText] = {"Kill Gnarlpine Furbolgs until Deer Musk drops, consume it and use Tame Beast on a Deer critter, then speak to Raelaeron next to the hunter trainer in Darnassus to receieve the rune."},
            [questKeys.requiredSpell] = -425758,
            [questKeys.zoneOrSort] = sortKeys.HUNTER,
        },
        [90208] = {
            ...
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.HUNTER,
            [questKeys.objectivesText] = {"Kill Razermane Quillboars until Adder Pheromone drops, consume it and use Tame Beast on a Adder critter, then speak to Razzil in Razor Hill to receieve the rune."},
            [questKeys.requiredSpell] = -425758,
            [questKeys.zoneOrSort] = sortKeys.HUNTER,
        },
        [90209] = {
            [questKeys.name] = "Carve",
            [questKeys.startedBy] = {{2949,2950,2951,207515,205635}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 7,
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.HUNTER,
            [questKeys.objectivesText] = {"Kill Palemane Gnolls until Prairie Dog Musk drops, consume it and use Tame Beast on a Prairie Dog critter, then speak to Takoda Sunmane in Bloodhoof Village to receieve the rune."},
            [questKeys.requiredSpell] = -425758,
            [questKeys.zoneOrSort] = sortKeys.HUNTER,
        },
    }
