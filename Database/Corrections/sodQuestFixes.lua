...
function SeasonOfDiscovery:LoadQuests()
    ...
    return {
        ...
        [81728] = { -- Recover Incursion Field Report: Hinterlands
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.NONE,
            [questKeys.zoneOrSort] = zoneIDs.HINTERLANDS,
        ...
        [81850] = { -- Hinterlands Mission XVI: Rescue Elianar Shadowdrinker
            ...
            [questKeys.extraObjectives] = {{{[zoneIDs.HINTERLANDS]={{63.24,27.39}}}, Questie.ICON_TYPE_EVENT, l10n("Escort Elianar Shadowdrinker to the Dream Portal"),}},
        },
        [81851] = { -- Hinterlands Mission XVII: Rescue Serlina Starbright
            ...
            [questKeys.extraObjectives] = {{{[zoneIDs.HINTERLANDS]={{63.24,27.39}}}, Questie.ICON_TYPE_EVENT, l10n("Escort Serlina Starbright to the Dream Portal"),}},
        },
        [81852] = { -- Hinterlands Mission XVIII: Rescue Veanna Cloudsleeper
            ...
            [questKeys.extraObjectives] = {{{[zoneIDs.HINTERLANDS]={{63.24,27.39}}}, Questie.ICON_TYPE_EVENT, l10n("Escort Veanna Cloudsleeper to the Dream Portal"),}},
        },
