...
function SeasonOfDiscovery:LoadQuests()
    ...
    return {
        ...
        [90133] = {
            ...
            [questKeys.startedBy] = {nil,{208220}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 5,
            [questKeys.requiredRaces] = raceIDs.NONE,
            [questKeys.requiredClasses] = classIDs.ROGUE,
            [questKeys.objectivesText] = {"Follow the location of the treasure map and loot the treasure chest."},
            [questKeys.requiredSpell] = -400095,
            [questKeys.zoneOrSort] = sortKeys.ROGUE,
        },
        [90134] = {
            [questKeys.name] = "Quick Draw",
            [questKeys.startedBy] = {nil,{203750}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 5,
            [questKeys.requiredRaces] = raceIDs.NONE,
        ...
        [90135] = {
            [questKeys.name] = "Quick Draw",
            [questKeys.startedBy] = {nil,{208605}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 5,
            [questKeys.requiredRaces] = raceIDs.NONE,
        ...
        [90136] = {
            [questKeys.name] = "Quick Draw",
            [questKeys.startedBy] = {nil,{207110}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 5,
            [questKeys.requiredRaces] = raceIDs.NONE,
        ...
        [90137] = {
            [questKeys.name] = "Quick Draw",
            [questKeys.startedBy] = {nil,{208034}},
            [questKeys.finishedBy] = nil,
            [questKeys.requiredLevel] = 1,
            [questKeys.questLevel] = 5,
            [questKeys.requiredRaces] = raceIDs.NONE,
