...
function CataNpcFixes.Load()
    ...
    return {
        ...
        [18481] = { -- A'dal
            [npcKeys.questStarts] = {10167,10560,10704,10884,10885,10886,10888,10949,13082,13430},
            [npcKeys.questEnds] = {10102,10210,10280,10560,10704,10708,10781,10883,10884,10885,10886,10888,10948,11007,11052,11116,13081,13430,29657,29658,29659,29660,29667,29669,29674,29675,29681},
        },
