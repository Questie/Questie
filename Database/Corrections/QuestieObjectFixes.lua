...
function QuestieObjectFixes:Load()
    ...
    return {
        ...
        [2712] = {
            [objectKeys.spawns] = {[zoneIDs.ARATHI_HIGHLANDS]={{17.6,88.8},{19.4,90.2},{19.6,84.8},{20.6,87.2},{21.1,90.2},{21.1,92.2},{22.4,83.8},{22.4,90},{22.5,83.7},{22.5,90},{22.7,88.4},{22.7,88.6},{22.9,92.1},{23.6,87.4},{23.9,88.4},{23.9,88.5},{24.3,84.6},{24.4,86.4},{24.5,86.4},{24.6,86.5},{24.9,89.3},{24.9,89.5},{25.2,90.6},},},
        },
        [2744] = {
