...
function CataObjectFixes.Load()
    ...
    return {
        ...
        [161752] = { -- Tool Bucket
            [objectKeys.spawns] = {[zoneIDs.NORTHERN_BARRENS]={{40.75,33.22},{40.74,33.38},{40.65,33.46},{40.44,32.85},{41.00,32.98},{41.49,32.08},{41.90,32.09},{42.07,32.31},{42.14,31.90},{42.48,31.92},{42.72,31.82},{42.98,32.12},{42.69,32.68},{42.19,32.65},{43.12,31.49},{43.04,30.90}}},
        },
