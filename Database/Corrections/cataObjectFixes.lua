...
function CataObjectFixes.Load()
    ...
    return {
        ...
        [430002] = { -- Fossil Archaeology Object
        ...
        [430015] = { -- Mark of the World Tree
            [objectKeys.name] = "Mark of the World Tree",
        },
        [430016] = { -- Felwood Bee Hive
