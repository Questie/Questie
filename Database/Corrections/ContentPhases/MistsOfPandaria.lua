...
local questsToBlacklistByPhase = {
    ...
    [3] = { -- Phase 3 (Patch 5.2 The Thunder King (Isle of Thunder, Throne of Thunder))
        ...
        [32231] = true, -- Trailing Light in the Dark
        ...
        [32569] = true, -- Trailing Light in the Dark
    ...
    [4] = { -- Phase 4 (Patch 5.3 Escalation (Deepwind Gorge, New Scenarios, Heroic Scenarios))
        ...
        [32836] = true, -- A Knockoff Grumplefloot
        [32837] = true, -- Grandpa Grumplefloot
        [32838] = true, -- A Tale of Romance and Chivalry
        [32839] = true, -- The Bear and the Lady Fair
        [32840] = true, -- Boom Boom's Fuse
        [32841] = true, -- Master Boom Boom
        [32842] = true, -- Teeth Like Swords
        [32843] = true, -- Razorgrin
        [32844] = true, -- Secret of the Ooze
        [32845] = true, -- Splat
        [32846] = true, -- Modified Chomping Apparatus
        [32847] = true, -- Mecha-Bruce
        [32848] = true, -- Frost-Tipped Eggshell
        [32849] = true, -- Dippy and Doopy
        [32850] = true, -- Last Year's Model
        [32851] = true, -- Blingtron 3000
        [32852] = true, -- The Digmaster's Earthblade
        [32853] = true, -- Mingus Diggs
        [32854] = true, -- Well-Worn Blindfold
        [32855] = true, -- The Blind Hero
        [32856] = true, -- Paper-Covered Rock
        [32857] = true, -- Ro-Shambo
    ...
    [5] = { -- Phase 5 (Patch 5.4 Siege of Orgrimmar (Raid, Timeless Isle, Proving Grounds)
        ...
        [33024] = true, -- Is That A Real Measurement?
        [33026] = true, -- These Aren't Your Fatty Goatsteaks
        [33027] = true, -- The Secret Ingredient Is...
        [33047] = true, -- Short-Supply Reward
        [33087] = true, -- Meet Me Back at the Inn
        [33088] = true, -- A Timeless Discovery
        ...
        [33098] = true, -- Secrets of the Timeless Isle
