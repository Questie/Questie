...
-- Removed in TBC
tinsert(eventQuests, {"Midsummer", 9388, nil, nil, nil, nil, Expansions.Current >= Expansions.Tbc}) -- Flickering Flames in Kalimdor
tinsert(eventQuests, {"Midsummer", 9389, nil, nil, nil, nil, Expansions.Current >= Expansions.Tbc}) -- Flickering Flames in the Eastern Kingdoms
tinsert(eventQuests, {"Midsummer", 9319, nil, nil, nil, nil, Expansions.Current >= Expansions.Tbc}) -- A Light in Dark Places
tinsert(eventQuests, {"Midsummer", 9386, nil, nil, nil, nil, Expansions.Current >= Expansions.Tbc}) -- A Light in Dark Places
tinsert(eventQuests, {"Midsummer", 9367, nil, nil, nil, nil, Expansions.Current >= Expansions.Tbc}) -- The Festival of Fire
tinsert(eventQuests, {"Midsummer", 9368, nil, nil, nil, nil, Expansions.Current >= Expansions.Tbc}) -- The Festival of Fire
tinsert(eventQuests, {"Midsummer", 9322, nil, nil, nil, nil, Expansions.Current >= Expansions.Tbc}) -- Wild Fires in Kalimdor
tinsert(eventQuests, {"Midsummer", 9323, nil, nil, nil, nil, Expansions.Current >= Expansions.Tbc}) -- Wild Fires in the Eastern Kingdoms
...
tinsert(eventQuests, {"Midsummer", 11691, nil, nil, nil, nil, Expansions.Current >= Expansions.Cata}) -- Summon Ahune
tinsert(eventQuests, {"Midsummer", 11696, nil, nil, nil, nil, Expansions.Current >= Expansions.Cata}) -- Ahune is Here!
...
tinsert(eventQuests, {"Midsummer", 11748, nil, nil, nil, nil, Expansions.Current >= Expansions.Cata}) -- Desecrate this Fire!
...
tinsert(eventQuests, {"Midsummer", 11785, nil, nil, nil, nil, Expansions.Current >= Expansions.Cata}) -- Desecrate this Fire!
...
tinsert(eventQuests, {"Midsummer", 11819, nil, nil, nil, nil, Expansions.Current >= Expansions.Cata}) -- Honor the Flame
...
tinsert(eventQuests, {"Midsummer", 11861, nil, nil, nil, nil, Expansions.Current >= Expansions.Cata}) -- Honor the Flame
...
tinsert(eventQuests, {"Midsummer", 11955, nil, nil, nil, nil, Expansions.Current >= Expansions.Cata}) -- Ahune, the Frost Lord
