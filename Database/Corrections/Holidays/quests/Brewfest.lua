...
-- TBC quests
tinsert(eventQuests, {"Brewfest", 11117, nil, nil, nil, nil, Questie.IsEURegion}) -- Catch the Wild Wolpertinger!
tinsert(eventQuests, {"Brewfest", 11118, nil, nil, nil, nil, Questie.IsEURegion}) -- Pink Elekks On Parade
tinsert(eventQuests, {"Brewfest", 11120, nil, nil, nil, nil, Questie.IsEURegion}) -- Pink Elekks On Parade
...
tinsert(eventQuests, {"Brewfest", 11400, nil, nil, nil, nil, Expansions.Current >= Expansions.Wotlk}) -- Brewfest Riding Rams
...
tinsert(eventQuests, {"Brewfest", 11419, nil, nil, nil, nil, Expansions.Current >= Expansions.Wotlk}) -- Brewfest Riding Rams
tinsert(eventQuests, {"Brewfest", 11431, nil, nil, nil, nil, Questie.IsEURegion}) -- Catch the Wild Wolpertinger!
