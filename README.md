...
[![Downloads Latest](https://img.shields.io/github/downloads/Questie/Questie/v11.38.0/total.svg)](https://github.com/Questie/Questie/releases/latest)
...
See [QuestieDB integration](docs/questiedb-integration.md) for data ownership, initialization, and testing against the real provider.
