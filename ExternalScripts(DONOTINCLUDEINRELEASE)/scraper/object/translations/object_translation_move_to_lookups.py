...
def merge_locales(input_locale, output_locale):
    ...
    output_file = os.path.join(base_dir, f'../../../../Localization/lookups/MoP/lookupObjects/{output_locale}.lua')
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        f.write(f'l10n.objectLookup["{output_locale}"] = loadstring([[return {{\n')
