...
local debugMessagesLocales = {
    ...
    ["Toggles the Config window"] = {
        ...
        ["itIT"] = "Mostra/nascondi la finestra delle opzioni",
        ["koKR"] = "설정 창을 엽니다",
    ...
    ["Toggles showing questie on the map and minimap"] = {
        ...
        ["itIT"] = "Mostra/nascondi Questie sulla mappa e sulla minimappa",
    ...
    ["Toggles the My Journey window"] = {
        ...
        ["itIT"] = "Mostra/nascondi la finestra 'Il mio viaggio'",
        ["koKR"] = "나의 여정 창을 표시합니다",
        ["ptBR"] = "Mostra/oculta a janela 'Minha viagem'",
    ...
    ["Toggles the Tracker. Add 'show', 'hide', 'reset' to explicit show/hide or reset the Tracker"] = {
        ...
        ["itIT"] = "Mostra/nascondi il tracciatore. Aggiungi 'mostra', 'nascondi', 'reimposta' per mostrare/nascondere o reimpostare il tracciatore",
    ...
    ["Flex the amount of quests you have completed so far"] = {
        ...
        ["itIT"] = "Sfoggia il numero di missioni che hai completato finora",
    ...
    ["has completed a total of %d quests"] = {
        ...
        ["itIT"] = "ha completato un totale di %d missioni",
    ...
    ["Toggles the Minimap Button for Questie"] = {
        ...
        ["itIT"] = "Mostra/nascondi il pulsante della minimappa per Questie",
    ...
    ["Invalid command. For a list of options please type:"] = {
        ...
        ["itIT"] = "Comando non valido. Per un elenco delle opzioni digita:",
    ...
    ["An active target or search parameters are required."] = {
        ...
        ["itIT"] = "È richiesto un bersaglio attivo o parametri di ricerca.",
    ...
    ["All map markers cleared."] = {
        ...
        ["itIT"] = "Tutti i marcatori della mappa sono stati rimossi.",
    ...
    ["Search term required."] = {
        ...
        ["itIT"] = "È richiesto un termine di ricerca.",
        ["koKR"] = "검색어가 필요합니다.",
    ...
    ["Exact match found, added %s to map."] = {
        ...
        ["itIT"] = "Trovata corrispondenza esatta, %s aggiunto alla mappa.",
    ...
    ["No exact matches, %d partial matches found and added to map."] = {
        ...
        ["itIT"] = "Nessuna corrispondenza esatta, trovate %d corrispondenze parziali e aggiunte alla mappa.",
    ...
    ["%d matches found and added to map."] = {
        ...
        ["itIT"] = "Trovate %d corrispondenze e aggiunte alla mappa.",
    ...
    ["No match found, nothing added to map."] = {
        ...
        ["itIT"] = "Nessuna corrispondenza trovata, non è stato aggiunto nulla alla mappa.",
    ...
    ["Please wait a moment for Questie to finish loading"] = {
        ...
        ["itIT"] = "Attendi un momento che Questie finisca di caricare",
    ...
    ["There was a problem initializing Questie's database. This can usually be fixed by recompiling the database."] = {
        ...
        ["itIT"] = "Si è verificato un problema durante l'inizializzazione del database di Questie. Di solito è possibile risolverlo ricompilando il database.",
    ...
    ["There was an error populating objectives for %s %s %s %s"] = {
        ...
        ["itIT"] = "Si è verificato un errore durante la creazione degli obiettivi per %s %s %s %s",
    ...
    ["Questie tracker in invalid location, resetting..."] = {
        ["enUS"] = true,
        ["deDE"] = "Der Questie-Tracker ist in einer ungültigen Position und wird zurückgesetzt...",
        ["esES"] = "Rastreador en ubicación inválida, restableciendo...",
        ["esMX"] = "Rastreador en ubicación inválida, restableciendo...",
        ["frFR"] = "Le suivi des quêtes dans un endroit non valide, réinitialisation…",
        ["itIT"] = "Tracciatore Questie in una posizione non valida, reimpostazione in corso...",
        ["koKR"] = "Questie 추적기가 허용되지 않은 위치에 있습니다, 재설정 중...",
        ["ptBR"] = "Rastreador de Questie em um local inválido, redefinindo...",
        ["ruRU"] = "трекер Questie в неправильном положении, сброс...",
        ["zhCN"] = "Questie任务追踪的框架跑到奇怪的地方去了，重置一下……",
        ["zhTW"] = "Questie 的任務追蹤清單跑到奇怪的地方去了，正在重置……",
    },
    ["Setting icon limit value to %s : Redrawing!"] = {
        ...
        ["itIT"] = "Impostazione del valore del limite delle icone a %s : Ridisegno in corso!",
        ["koKR"] = "아이콘 제한 값을 %s 로 설정하는중: 다시 그리는 중!",
    ...
    ["Questie DB is updating — "] = {
        ...
        ["esMX"] = "La base de datos de Questie se está actualizando — ",
        ["frFR"] = "La base de données de Questie est en cours de mise à jour — ",
        ["itIT"] = "Il database di Questie è in aggiornamento — ",
        ["koKR"] = "Questie DB가 업데이트 중입니다 — ",
        ["ptBR"] = "O banco de dados de Questie está sendo atualizado — ",
    ...
    ["Data is being processed, this may take a few moments and cause some lag..."] = {
        ...
        ["itIT"] = "I dati sono in elaborazione; questa operazione può richiedere alcuni istanti e causare un po' di lag...",
    ...
    ["Updating NPCs"] = {
        ...
        ["esES"] = "Actualizando PNJ",
        ["esMX"] = "Actualizando PNJ",
        ["frFR"] = "Mise à jour des PNJ",
        ["itIT"] = "Aggiornamento PNG",
        ["koKR"] = "NPC 업데이트중",
    ...
    ["Applying database corrections"] = {
        ...
        ["itIT"] = "Applicazione delle correzioni al database",
        ["koKR"] = "데이터베이스 수정 적용중",
    ...
    ["Initializing locale"] = {
        ...
        ["itIT"] = "Inizializzazione della lingua",
        ["koKR"] = "로케일 초기화 중",
    ...
    ["Initializing townsfolk"] = {
        ...
        ["itIT"] = "Inizializzazione dei cittadini",
        ["koKR"] = "도시 마을 주민 초기화 중",
    ...
    ["Optimizing waypoints"] = {
        ...
        ["itIT"] = "Ottimizzazione dei punti di percorso",
        ["koKR"] = "웨이 포인트 조정 중",
    ...
    ["Questie DB update complete!"] = {
        ...
        ["frFR"] = "La base de données de Questie a été mise à jour !",
        ["itIT"] = "Aggiornamento del database di Questie completato!",
        ["koKR"] = "Questie DB 업데이트 완료!",
        ["ptBR"] = "A base de dados do Questie foi atualizada!",
    ...
    ["You picked up %s which starts %s!"] = {
        ...
        ["itIT"] = "Hai raccolto %s che inizia %s!",
    ...
    ["Error during initialization!"] = {
        ...
        ["itIT"] = "Errore durante l'inizializzazione!",
        ["koKR"] = "설치중에 에러 발생!",
    ...
    ["The quest %s is missing from Questie's database. Please report this on GitHub or Discord!"] = {
        ...
        ["itIT"] = "La missione %s è assente dal database di Questie. Segnalalo su GitHub o Discord!",
    ...
    ["Please report this on GitHub or Discord!"] = {
        ...
        ["itIT"] = "Segnalalo su GitHub o Discord!",
    ...
    ["Coordinates addon is enabled and will cause buggy behavior. Disabling global map and mini map coordinates. These can be re-enabled in settings"] = {
        ...
        ["itIT"] = "L'addon delle coordinate è attivo e causerà comportamenti anomali. Disattivazione delle coordinate della mappa del mondo e della minimappa. Queste possono essere riattivate nelle impostazioni.",
    ...
    ["Missing objective data for quest "] = {
        ...
        ["itIT"] = "Dati degli obiettivi mancanti per la missione ",
    ...
    ["Prints whether you are eligibile to do a quest"] = {
        ...
        ["itIT"] = "Indica se sei idoneo a svolgere una missione",
    ...
    ["Prints Questie and client version info"] = {
        ...
        ["itIT"] = "Mostra le informazioni sulla versione di Questie e del client",
    ...
    ["Questie Debug Info"] = {
        ...
        ["itIT"] = "Informazioni di debug di Questie",
        ["koKR"] = "퀘스티 디버그 정보",
    ...
    ["Please share this info with us on"] = {
        ...
        ["itIT"] = "Condividi queste informazioni con noi su",
    ...
    ["You can copy the data above"] = {
        ...
        ["itIT"] = "Puoi copiare i dati qui sopra",
    ...
    ["Would you like to help us fix it?"] = {
        ...
        ["itIT"] = "Vuoi aiutarci a risolverlo?",
    ...
    ["An item you just encountered has data missing from the Questie database."] = {
        ...
        ["itIT"] = "Un oggetto appena incontrato ha dati mancanti nel database di Questie.",
    ...
    ["A quest you just encountered is missing from the Questie database."] = {
        ...
        ["itIT"] = "Una missione appena incontrata è assente dal database di Questie.",
    ...
    ["A quest in your quest log is missing from the Questie database and can't be tracked."] = {
        ...
        ["itIT"] = "Una missione nel tuo diario missioni è assente dal database di Questie e non può essere tracciata.",
    ...
    ["The NPC you just targeted is missing from the Questie database."] = {
        ...
        ["itIT"] = "Il PNG che hai appena preso di mira è assente dal database di Questie.",
    ...
    ["Questie has detected the database to be corrupted. You may type \"/run ReloadUI()\" or \"/reload\" to start the recompiling process when the conditions allow it.\n\nThe process will take 1-2 minutes depending on your configuration."] = {
        ...
        ["itIT"] = "Questie ha rilevato che il database è corrotto. Puoi digitare \"/run ReloadUI()\" o \"/reload\" per avviare il processo di ricompilazione quando le condizioni lo consentono.\n\nIl processo richiederà 1-2 minuti a seconda della tua configurazione.",
