...
local debugMessagesLocales = {
    ...
    ["Toggles the Tracker. Add 'show', 'hide', 'reset' to explicit show/hide or reset the Tracker"] = {
        ...
        ["koKR"] = nil,
        ["esMX"] = "Muestra el Rastreador. Agrega 'mostrar', 'ocultar y 'reestablecer' para mostrar/ocultar y reestablecer el Rastreador",
        ["enUS"] = true,
    ...
    ["Data is being processed, this may take a few moments and cause some lag..."] = {
        ...
        ["deDE"] = "Die Daten werden verarbeitet, dies kann einige Momente dauern und eine Verzögerung verursachen...",
        ["koKR"] = nil,
