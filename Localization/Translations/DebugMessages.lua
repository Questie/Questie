...
local debugMessagesLocales = {
    ...
    ["Toggles the Config window"] = {
        ["ptBR"] = "Mostra/oculta a janela de configurações",
        ["ruRU"] = "показать/скрыть окно настроек.",
        ["deDE"] = "Zeigen/Verstecken des Einstellungsfensters",
        ["koKR"] = "설정 창을 엽니다",
        ["esMX"] = "Muestra/oculta la ventana de configuración",
        ["enUS"] = true,
        ["zhCN"] = "打开设置窗口",
        ["zhTW"] = "切換顯示設定選項",
        ["esES"] = "Muestra/oculta la ventana de configuración",
        ["frFR"] = "Active ou désactive la fenêtre de configuration.",
    },
