...
local debugMessagesLocales = {
    ...
    ["[Questie] With the move to Burning Crusade, Questie is undergoing rapid development, as such you may encounter bugs. Please keep Questie up to date for the best experience! We will also be releasing a large update some time after TBC launch, with many improvements and new features."] = {
        ...
        ["deDE"] = "[Questie] Für den Wechsel zu Burning Crusade untergeht Questie schnellen Entwicklungen, weshalb vermehrt Bugs auftreten können. Bitte halten Sie Questie immer aktuell für die best mögliche Spielerfahrung! Wir werden ein großes Update kurz nach dem Start von TBC veröffentlichen, mit vielen Verbesserungen und neuen Funktionalitäten.",
        ["esES"] = nil,
        ["esMX"] = nil,
    },
