...
local minimapIconLocales = {
    ...
    ["Hide Minimap Button"] = {
        ...
        ["itIT"] = "Nascondere il pulsante della minimappa",
        ["koKR"] = "미니맵 버튼 가리기",
    ...
    ["Trivial Quest"] = {
        ...
        ["itIT"] = "Missione di basso livello",
        ["koKR"] = "기타 퀘스트",
    ...
    ["Questie will open after combat ends."] = {
        ...
        ["itIT"] = "Questie si aprirà dopo la fine del combattimento.",
