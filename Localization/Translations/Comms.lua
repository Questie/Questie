...
local commsLocales = {
    ["A Major patch for Questie exists!"] = {
        ...
        ["itIT"] = "È disponibile una patch importante per Questie!",
    ...
    ["Please update as soon as possible!"] = {
        ...
        ["itIT"] = "Ti preghiamo di aggiornare il prima possibile!",
    ...
    ["You have an outdated version of Questie!"] = {
        ...
        ["itIT"] = "Hai una versione obsoleta di Questie!",
    ...
    ["Please consider updating!"] = {
        ...
        ["itIT"] = "Ti preghiamo di considerare un aggiornamento!",
    ...
    ["You have an incompatible QuestieComms message! Please update!"] = {
        ...
        ["itIT"] = "Hai un messaggio QuestieComms incompatibile! Ti preghiamo di aggiornare!",
    ...
    ["has an incompatible Questie version, QuestieComms won't work!"] = {
        ...
        ["itIT"] = "ha una versione di Questie incompatibile, QuestieComms non funzionerà!",
