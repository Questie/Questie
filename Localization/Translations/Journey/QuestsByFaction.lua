...
local questsByFactionLocales = {
    ...
    ["Select Expansion and Faction"] = {
        ...
        ["esES"] = "Selecciona expansión y facción",
        ["esMX"] = "Selecciona expansión y facción",
        ["frFR"] = "Sélectionne l’extension et la faction",
        ["itIT"] = "Seleziona espansione e fazione",
        ["koKR"] = "확장팩 및 진영 선택",
        ["ptBR"] = "Seleciona expansão e facção",
    ...
    ["Reputation Reward"] = {
        ...
        ["itIT"] = "Ricompensa di reputazione",
        ["koKR"] = "관계 보상",
