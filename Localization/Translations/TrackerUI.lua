...
local trackerUILocales = {
    ...
    ["Reset tracker (Auto)"] = {
        ["ptBR"] = "Redefinir rastreador (automático)",
        ["ruRU"] = "Сбросить трекер (Авто)",
        ["deDE"] = "Tracker zurücksetzen (Auto)",
        ["koKR"] = "추적기 재설정(자동)",
        ["esMX"] = "Restablecer rastreador (Auto)",
        ["enUS"] = true,
        ["zhCN"] = "重置跟踪器（自动）",
        ["zhTW"] = "重置跟踪器（自动）",
        ["esES"] = "Restablecer rastreador (Auto)",
        ["frFR"] = "Réinitialiser le traqueur (Auto)",
    },
    ["Current Size Mode"] = {
        ["ptBR"] = "Modo de Tamanho Atual",
        ["ruRU"] = "Режим текущего размера",
        ["deDE"] = "Aktueller Größenmodus",
        ["koKR"] = "현재 크기 모드",
        ["esMX"] = "Modo de tamaño actual",
        ["enUS"] = true,
        ["zhCN"] = "当前大小模式",
        ["zhTW"] = "当前大小模式",
        ["esES"] = "Modo de tamaño actual",
        ["frFR"] = "Mode Taille actuelle",
    },
    ["NOTE"] = {
        ["ptBR"] = "OBSERVAÇÃO",
        ["ruRU"] = "ПРИМЕЧАНИЕ",
