...
local keyboardShortcutLocales = {
    ...
    ["Ctrl + Left Click + Hold"] = {
        ...
        ["itIT"] = "Ctrl + Clic sinistro + Tenere premuto",
    ...
    ["Ctrl + Shift + Left Click"] = {
        ...
        ["itIT"] = "Ctrl + Maiusc + Clic sinistro",
    ...
    ["Left Click + Hold"] = {
        ...
        ["itIT"] = "Clic sinistro + Tenere premuto",
        ["koKR"] = "왼쪽 클릭 길게누르기",
