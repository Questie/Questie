...
local genericsLocales = {
    ...
    ["Shift-click to hide"] = {
        ...
        ["itIT"] = "Maiusc + clic per nascondere",
        ["koKR"] = "Shift + 클릭으로 숨기기",
