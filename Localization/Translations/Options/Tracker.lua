...
local trackerOptionsLocales = {
    ...
    ["Auto Minimize Completed Quests"] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Minimizar automáticamente misiones completadas",
        ["enUS"] = true,
        ["zhCN"] = "自动收起已完成的任务",
        ["zhTW"] = "自動最小化已完成的任務",
        ["esES"] = "Minimizar automáticamente misiones completadas",
        ["frFR"] = false,
    },
    ...
    ["Hide Completed Quest Objectives"] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Ocultar objetivos de misión completados",
        ["enUS"] = true,
        ["zhCN"] = "隐藏已完成的任务目标",
        ["zhTW"] = "隱藏已完成的任務目標",
        ["esES"] = "Ocultar objetivos de misión completados",
        ["frFR"] = false,
    },
    ["When this is checked, completed Quest Objectives will automatically be removed from the Questie Tracker."] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Cuando está marcado, los objetivos de misión completados se eliminarán automáticamente del Rastreador de Questie.",
        ["enUS"] = true,
        ["zhCN"] = "启用时，已完成的任务目标将会自动从任务列表中移除。",
        ["zhTW"] = "啟用時，已完成的任務目標將會自動從任務清單中移除。",
        ["esES"] = "Cuando está marcado, los objetivos de misión completados se eliminarán automáticamente del Rastreador de Questie.",
        ["frFR"] = false,
    },
    ---------------------------------------------------------
    ...
    ["When this is checked, the Active Quests Header will become visible and the total number of Quests you have in your Quest Log will be shown.\n\nNOTE: When this is disabled, the Questie Icon will fade in while your mouse is over the Tracker."] = {
        ...
        ["deDE"] = "Wenn diese Option aktiviert ist, wird die Kopfzeile 'Aktive Quests' sichtbar und die Gesamtzahl der Quests im Quest-Log wird angezeigt.\n\nHINWEIS: Wenn dies deaktiviert ist, wird das Questie-Icon eingeblendet, während sich die Maus über dem Tracker befindet.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["Auto Move Active Quests Header"] = {
        ...
        ["deDE"] = "Kopfzeile automatisch verschieben",
        ["koKR"] = "자동 이동 헤더",
    ...
    ["When this is checked, the Active Quests Header will automatically move to the bottom of the Questie Tracker.\n\nNOTE: This setting only works while the 'Tracker Growth Direction' setting is set to 'Up & Right' or 'Up & Left'."] = {
        ...
        ["deDE"] = "Wenn diese Option aktiviert ist, wird die Kopfzeile 'Aktive Quests' automatisch nach unten verschoben.\n\nHINWEIS: Diese Einstellung funktioniert nur, wenn 'Tracker Wachstumsrichtung' auf 'Oben & Rechts' oder 'Oben & Links' eingestellt ist.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["When this is checked, the Questie Trackers 'Active Quests Header' will always be visible when nothing is being tracked versus being hidden completely.\n\nNOTE: If the 'Active Quests Header' is in a disabled state, enabling this option will toggle it on when nothing is being tracked then toggle back off when you track something."] = {
        ...
        ["deDE"] = "Wenn diese Option aktiviert ist, wird die Kopfzeile 'Aktive Quests' immer sichtbar sein, wenn nichts verfolgt wird, statt sie vollständig auszublenden.\n\nHINWEIS: Wenn die Kopfzeile 'Aktive Quests' deaktiviert ist, wird sie beim Aktivieren dieser Option eingeschaltet, wenn nichts verfolgt wird, und beim Verfolgen von etwas wieder ausgeschaltet.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["When this is checked, the Questie Tracker is locked and you need to hold CTRL when you want to move it."] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Cuando esto está marcado, el Rastreador de Questie está bloqueado y debes mantener presionada la tecla CTRL cuando quieras moverlo.",
        ["enUS"] = true,
        ["zhCN"] = "启用此选项，追踪器被锁定，您需要按住 CTRL 键才能移动它。",
        ["zhTW"] = "啟用時，會鎖定任務清單，必須按住 CTRL 鍵才能移動它。",
        ["esES"] = "Cuando esto está marcado, el Rastreador de Questie está bloqueado y debes mantener presionada la tecla CTRL cuando quieras moverlo.",
    ...
    ["This determines the direction in which the Questie Tracker grows when you add or remove Quests. For example, if you use the 'Up & Right' option then the ideal place for the Tracker should be in the lower left-hand corner of your screen. This allows the 'Sizer Mode: Auto' to push the Tracker Height and Width 'Up & Right' so the Tracker doesn't inadvertently cover up elements of your UI.\n\nNOTE: This will also move the Active Quests Header (if enabled) to the bottom of the Questie Tracker when using the options 'Up & Right' or the 'Up & Left' setting. You can override this behavior by disabling the 'Auto Move Active Quests Header' option to force the Active Quests Header to remain at the top of the Questie Tracker. The 'Auto Move Active Quests Header' option is disabled when the options 'Down & Right' or 'Down & Left' are used."] = {
        ...
        ["deDE"] = "Dies bestimmt die Richtung, in der der Questie Tracker wächst, wenn Quests hinzugefügt oder entfernt werden. Wenn du beispielsweise die Option 'Oben & Rechts' verwendest, sollte sich der Tracker idealerweise in der unteren linken Ecke deines Bildschirms befinden. Dies ermöglicht es dem 'Sizer-Modus: Auto', die Tracker-Höhe und -Breite 'Oben & Rechts' zu verschieben, damit der Tracker nicht versehentlich Elemente deiner UI verdeckt.\n\nHINWEIS: Dies verschiebt auch die Überschrift 'Aktive Quests' (falls aktiviert) nach unten, wenn die Optionen 'Oben & Rechts' oder die Einstellung 'Oben & Links' verwendet werden. Du kannst dieses Verhalten deaktivieren, indem du die Option 'Kopfzeile automatisch verschieben' deaktivierst, um die Überschrift 'Aktive Quests' oben im Questie Tracker zu belassen. Die Option 'Kopfzeile automatisch verschieben' ist deaktiviert, wenn die Option 'Unten & Rechts' oder 'Unten & Links' verwendet wird.",
        ["koKR"] = false,
        ["esMX"] = "Esto determina la dirección en la que crece el rastreador cuando agregas o eliminas misiones. Por ejemplo, si usas la opción 'Arriba y derecha', el lugar ideal para el rastreador debe ser en la esquina inferior izquierda de la pantalla. Esto permite que el 'Modo de medición: Automático' empuje la altura y el ancho del rastreador hacia arriba y hacia la derecha para que el rastreador no cubra inadvertidamente elementos de su interfaz de usuario.\n\nNOTA: Esto también moverá el encabezado de misiones activas (si está habilitado) en la parte inferior del Questie Tracker cuando se utilizan las opciones 'Arriba y derecha' o la configuración 'Arriba e izquierda'. Puede anular este comportamiento deshabilitando la opción 'Mover automáticamente el encabezado de misiones activas' para forzar el encabezado de misiones activas permanecer en la parte superior del rastreador. La opción 'Mover automáticamente el encabezado de misiones activas' está deshabilitada cuando se usan las opciones 'Abajo y derecha' o 'Abajo e izquierda'.",
        ["enUS"] = true,
