...
local trackerOptionsLocales = {
    ...
    ["Enable Tracker Header"] = {
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Trackerüberschrift aktivieren",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
        ["zhCN"] = false,
    ...
    ["When this is enabled the Tracker Header with the number of active quests and the Questie Icon will be permanently visible.\n\nWhen this is disabled the Questie Icon will fade in while your mouse is over the Tracker."] = {
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Wenn dies aktiviert ist sind die Trackerüberschrift und das Questie Icon permanent sichtbar.\n\nWenn dies deaktiviert ist blendet sich das Questie Icon ein sobald die Maus über dem Tracker ist.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
        ["zhCN"] = false,
    ...
    ["Show Tracker Header At The Bottom"] = {
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Trackerüberschrift unten anzeigen",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
        ["zhCN"] = false,
    ...
    ["Show Header For Empty Tracker"] = {
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Trackerüberschrift Für Leeren Tracker Anzeigen",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
        ["zhCN"] = false,
    ...
    ["When this is enabled the Tracker Header will be visible even when no quests are being tracked versus the Tracker being hidden completely."] = {
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Wenn dies aktiviert ist wird die Trackerüberschrift sichtbar sein selbst when keine Quests verfolgt werden anstatt dass der Tracker komplett versteckt wird",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
        ["zhCN"] = false,
