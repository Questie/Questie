...
local trackerOptionsLocales = {
    ...
    ["When this is checked, Blizzard Completion Text will be hidden for completed Quests and instead show the old Questie tags: \"Quest Complete!\" or \"Quest Failed!\""] = {
        ["ptBR"] = "Quando esta opção está marcada, o texto de conclusão da Blizzard será ocultado para as missões concluídas e, em vez disso, mostrará as antigas etiquetas do Questie: \"Missão concluída!\" ou \"Missão falhou!\"",
        ...
        ["koKR"] = false,
        ["esMX"] = "Cuando está marcado, el texto de completa de Blizzard se ocultará para las misiones completadas y en su lugar mostrará las etiquetas de misión antiguas: \"¡Misión completada!\" o \"¡Misión fallida!\"",
        ["enUS"] = true,
        ["zhCN"] = "启用时，完成任务时不会显示游戏内建的完成信息，而会显示传统的信息：\"任务完成！\" 和 \"任务失败！\"",
        ["zhTW"] = "啟用時，完成任務時不會顯示遊戲內建的完成訊息，而會顯示傳統的訊息: \"任務完成！\" or \"任務失敗！\"",
        ["esES"] = "Cuando está marcado, el texto de completa de Blizzard se ocultará para las misiones completadas y en su lugar mostrará las etiquetas de misión antiguas: \"¡Misión completada!\" o \"¡Misión fallida!\"",
    ...
    ["When this is checked, completed Achievement Objectives will automatically be removed from the Questie Tracker."] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Cuando está habilitado los objetivos de logro completados serán eliminados automáticamente del rastreador de Questie.",
        ["enUS"] = true,
    ...
    ["Change the color of Objectives in the Questie Tracker by how complete they are.\n\nNOTE: The Minimalistic option will not display the \"Blizzard Completion Text\" and just label the Quest as either \"Quest Complete!\" or \"Quest Failed!\"."] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Cambia el color de los objetivos en el rastreador de misiones según lo completos que estén.\n\nNOTA: La opción Minimalista no mostrará el \"Texto de completo de Blizzard\" y solo etiquetará la misión como \"¡Misión completada!\" o \"¡Misión fallida!\".",
        ["enUS"] = true,
