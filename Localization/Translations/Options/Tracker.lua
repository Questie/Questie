...
local trackerOptionsLocales = {
    ...
    ["If checked, completed Achievement Objectives will automatically be removed from the Questie Tracker."] = {
        ...
        ["esES"] = "Si está seleccionado, los objetivos de logro completados serán eliminados automáticamente del rastreador de Questie.",
        ["esMX"] = "Si está seleccionado, los objetivos de logro completados serán eliminados automáticamente del rastreador de Questie.",
        ["frFR"] = "Si cette option est cochée, les objectifs des hauts faits terminées seront automatiquement supprimés du suivi de quêtes.",
    ...
    ["If checked, the Tracker Header and/or the Questie Icon will be moved to the bottom of the Questie Tracker and the sizer to the top."] = {
        ...
        ["frFR"] = "Si cette option est cochée, l'en-tête du suivi et/ou l'icône de Questie seront déplacés en bas du suivi de quêtes et le calibreur en haut.",
    ...
    ["If checked, the durability frame will be placed on the left or right side of the Questie Tracker depending on where the Tracker is placed on your screen."] = {
        ...
        ["frFR"] = "Si cette option est cochée, le cadre de durabilité sera placé à gauche ou à droite du suivi de quête en fonction de l’emplacement de celui-ci sur votre écran.",
    ...
    ["If checked, the Questie Tracker will automatically be minimized while entering combat."] = {
        ...
        ["frFR"] = "Si cette option est cochée, le suivi de quête sera automatiquement réduit lors des combats.",
    ...
    ["If checked, the Questie Tracker will automatically be hidden when entering combat."] = {
        ...
        ["frFR"] = "Si cette option est cochée, le suivi de quête sera automatiquement caché lors des combats.",
    ...
    ["If checked, the Questie Tracker Sizer that appears in the bottom or top right hand corner will be hidden."] = {
        ...
        ["frFR"] = "Si cette option est cochée, le calibreur du suivi de quêtes qui apparaît dans le coin inférieur ou supérieur droit sera caché.",
    ...
    ["If checked, the Questie Tracker will list Achievements first then Quests."] = {
        ...
        ["frFR"] = "Si cette option est cochée, le suivi de Questie affichera d'abord les hauts faits, puis les quêtes.",
        ["koKR"] = "이 옵션을 선택하면 Questie 추적기가 먼저 업적을 나열한 후 퀘스트를 나열합니다.",
        ["ptBR"] = "Se marcado, o rastreador de Questie listará primeiro as conquistas e depois as missões.",
    ...
    ["If checked, the VoiceOver talking head / sound queue frame will be placed on the left or right side of the Questie Tracker depending on where the Tracker is placed on your screen."] = {
        ...
        ["esES"] = "Si está seleccionado, el marco de la cabeza parlante de VoiceOver / cola de sonido se colocará en el lado izquierdo o derecho del rastreador de Questie dependiendo de dónde esté ubicado el rastreador en la pantalla.",
        ["esMX"] = "Si está seleccionado, el marco de la cabeza parlante de VoiceOver / cola de sonido se colocará en el lado izquierdo o derecho del rastreador de Questie dependiendo de dónde esté ubicado el rastreador en la pantalla.",
        ["frFR"] = "Si cette option est cochée, le cadre de tête parlante / file d'attente sonore de VoiceOver sera placé sur le côté gauche ou droit du suivi de Questie en fonction de l'emplacement du suivi sur l'écran.",
        ["koKR"] = "이 옵션을 선택하면 화면에서 트래커가 배치된 위치에 따라 VoiceOver 토킹 헤드 / 음향 대기열 프레임이 Questie 트래커의 왼쪽 또는 오른쪽에 배치됩니다.",
        ["ptBR"] = "Se marcado, o quadro de cabeça falante / fila de som do VoiceOver será colocado no lado esquerdo ou direito do rastreador de Questie, dependendo de onde o rastreador estiver localizado na tela.",
    ...
    ["If checked, the Questie Tracker is locked and you need to hold CTRL when you want to move it."] = {
        ...
        ["ptBR"] = "Se marcado, o rastreador de Questie estará bloqueado e você precisará manter pressionada a tecla CTRL quando quiser movê-lo.",
