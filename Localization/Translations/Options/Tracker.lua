...
local trackerOptionsLocales = {
    ...
    ["|cff30fc96Questie|r: Forced WoW client setting '%s' to enabled to match Questie settings. Please disable it in the Questie's tracker settings if you want it turned off."] = {
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = false,
        ["koKR"] = false,
