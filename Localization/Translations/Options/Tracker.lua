...
local trackerOptionsLocales = {
    ...
    ["Minimize In Pet Battles"] = {
        ...
        ["esMX"] = "Minimizar en duelos de mascotas",
        ["frFR"] = "Réduire pendant les combats de mascottes",
        ["koKR"] = "펫 배틀시 최소화",
        ["ptBR"] = "Minimizar em batalhas de mascotes",
        ["ruRU"] = false,
        ["zhCN"] = false,
        ["zhTW"] = false,
    },
    ["When this is checked, the Questie Tracker will automatically be hidden when entering a pet battle."] = {
        ...
        ["koKR"] = "이 옵션을 선택하면 펫 배틀을 시작할 때 Questie 추적기가 자동으로 최소화됩니다.",
