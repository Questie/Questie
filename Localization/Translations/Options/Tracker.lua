...
local trackerOptionsLocales = {
    ...
    ["If checked, the Questie Tracker will automatically be minimized when entering a dungeon, raid, or battleground."] = {
        ...
        ["itIT"] = "Se selezionata, il tracciatore di Questie verrà ridotto automaticamente quando entri in un dungeon, un raid o un campo di battaglia.",
    ...
    ["If checked, the Questie Tracker will automatically be hidden when entering a dungeon, raid, or battleground."] = {
        ...
        ["itIT"] = "Se selezionata, il tracciatore di Questie verrà nascosto automaticamente quando entri in un dungeon, un raid o un campo di battaglia.",
    ...
    ["Untrack / Link"] = {
        ...
        ["itIT"] = "Smetti di tracciare / Collega",
        ["koKR"] = "추적종료 / 링크 퀘스트",
        ["ptBR"] = "Remover rastreio/vincular missão",
        ["ruRU"] = "Отмена / Ссылка",
        ["zhCN"] = "停止追踪 / 链接",
