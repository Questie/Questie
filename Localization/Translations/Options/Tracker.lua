...
local trackerOptionsLocales = {
    ...
    ["If checked, the Questie Tracker will automatically be minimized when entering a dungeon/raid/battleground."] = {
        ["enUS"] = true,
    ...
    ["If checked, the Questie Tracker will automatically be hidden when entering a dungeon/raid/battleground."] = {
        ["enUS"] = true,
