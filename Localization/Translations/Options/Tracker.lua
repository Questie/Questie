...
local trackerOptionsLocales = {
    ...
    ["When this is checked, the Quest Level Tags for Quest Titles will show in the Questie Tracker."] = {
        ["ptBR"] = "Se ativado, as tags de nível de missão para títulos de missão serão exibidas no Questie Rastreador.",
        ...
        ["esMX"] = "Si está activado, las etiquetas de nivel de búsqueda para los títulos de búsqueda se mostrarán en el rastreador.",
        ["enUS"] = true,
        ["zhCN"] = "选中后，任务标题的任务等级将显示在Questie追踪窗口",
        ["zhTW"] = "啟用時，任務清單中的任務標題將會顯示任務等級。",
        ["esES"] = "Si está activado, las etiquetas de nivel de búsqueda para los títulos de búsqueda se mostrarán en el rastreador.",
    ...
    ["When this is checked, completed Quest Objectives will automatically be removed from the Questie Tracker."] = {
        ["ptBR"] = "Se ativado, os objetivos de missões concluídos serão automaticamente removidos do rastreador de missões de Questie.",
        ...
        ["esMX"] = "Si está activado, los objetivos de misión completados se eliminarán automáticamente del rastreador.",
        ["enUS"] = true,
        ["zhCN"] = "启用时，已完成的任务目标将会自动从任务列表中移除。",
        ["zhTW"] = "啟用時，已完成的任務目標將會自動從任務清單中移除。",
        ["esES"] = "Si está activado, los objetivos de misión completados se eliminarán automáticamente del rastreador.",
        ["frFR"] = "Si cette option est activée, les objectifs de quêtes terminés seront automatiquement supprimés du suivi de quêtes de Questie.",
    },
    ---------------------------------------------------------
    ...
    ["When this is checked, Blizzard Completion Text will be hidden for completed Quests and instead show the old Questie tags: \"Quest Complete!\" or \"Quest Failed!\""] = {
        ["ptBR"] = "Se ativado, o texto de conclusão da Blizzard será ocultado para as missões concluídas e, em vez disso, mostrará as antigas etiquetas de Questie: \"Missão concluída!\" ou \"Missão falhou!\"",
        ...
        ["esMX"] = "Si está activado, el texto de completa de Blizzard se ocultará para las misiones completadas y en su lugar mostrará las etiquetas de misión antiguas: \"¡Misión completada!\" o \"¡Misión fracasada!\"",
        ["enUS"] = true,
        ["zhCN"] = "启用时，完成任务时不会显示游戏内建的完成信息，而会显示传统的信息：\"任务完成！\" 和 \"任务失败！\"",
        ["zhTW"] = "啟用時，完成任務時不會顯示遊戲內建的完成訊息，而會顯示傳統的訊息: \"任務完成！\" or \"任務失敗！\"",
        ["esES"] = "Si está activado, el texto de completa de Blizzard se ocultará para las misiones completadas y en su lugar mostrará las etiquetas de misión antiguas: \"¡Misión completada!\" o \"¡Misión fracasada!\"",
    ...
    ["When this is enabled the Tracker Header and/or the Questie Icon will be moved to the bottom of the Questie Tracker and the sizer to the top."] = {
        ["ptBR"] = "Se ativado, o cabeçalho do rastreador e/ou o ícone de Questie serão movidos para a parte inferior do rastreador de Questie e o redimensionador para o topo.",
    ...
    ["When this is checked, the Quest Item Buttons will fade and become transparent when not in use."] = {
        ["ptBR"] = "Se ativado, os botões de itens da missão desaparecerão e se tornarão transparentes quando não estiverem em uso.",
        ...
        ["esMX"] = "Si está activado, los botones de objetos de búsqueda se desvanecerán y se volverán transparentes cuando no estén en uso.",
        ["enUS"] = true,
        ["zhCN"] = "选中此项时，任务项按钮将在不使用时自动淡化",
        ["zhTW"] = "啟用時，滑鼠沒有指向任務物品按鈕時會變成透明。",
        ["esES"] = "Si está activado, los botones de objetos de búsqueda se desvanecerán y se volverán transparentes cuando no estén en uso.",
    ...
    ["When this is checked, the Questie Tracker Sizer that appears in the bottom or top right hand corner will be hidden."] = {
        ["ptBR"] = "Se ativado, o redimensionador do rastreador de Questie que aparece no canto inferior ou superior direito será ocultado.",
        ...
        ["frFR"] = "Si cette option est activée, le redimensionneur du suivi de quêtes de Questie qui apparaît dans le coin inférieur ou supérieur droit sera caché.",
    },
    ---------------------------------------------------------
    ...
    ["When this is checked, the VoiceOver talking head / sound queue frame will be placed on the left or right side of the Questie Tracker depending on where the Tracker is placed on your screen."] = {
        ["ptBR"] = "Se ativado, o quadro de cabeça falante / fila de som do VoiceOver será colocado no lado esquerdo ou direito do rastreador de Questie, dependendo de onde o rastreador estiver localizado na sua tela.",
        ...
        ["esMX"] = "Si está activado, el marco de la cabeza parlante de VoiceOver / cola de sonido se colocará en el lado izquierdo o derecho del rastreador de Questie dependiendo de dónde esté ubicado el rastreador en tu pantalla.",
        ["enUS"] = true,
        ["zhCN"] = "启用时，语音框会放在任务列表的左侧或右侧，根据任务列表在界面上的位置而定。",
        ["zhTW"] = "啟用時，語音框架會放在任務清單的左側或右側，依據任務清單在畫面上的位置而定。",
        ["esES"] = "Si está activado, el marco de la cabeza parlante de VoiceOver / cola de sonido se colocará en el lado izquierdo o derecho del rastreador de Questie dependiendo de dónde esté ubicado el rastreador en tu pantalla.",
        ["frFR"] = "Si cette option est activée, le cadre de tête parlante / file d'attente sonore de VoiceOver sera placé sur le côté gauche ou droit du suivi de Questie en fonction de l'emplacement du suivi sur votre écran.",
    },
    ---------------------------------------------------------
    ["Lock Tracker"] = {
    ...
    ["When this is checked, the Questie Tracker is locked and you need to hold CTRL when you want to move it."] = {
        ...
        ["esMX"] = "Si está activado, el rastreador está bloqueado y debes mantener presionada la tecla CTRL cuando quieras moverlo.",
        ["enUS"] = true,
        ["zhCN"] = "启用此选项，追踪器被锁定，您需要按住 CTRL 键才能移动它。",
        ["zhTW"] = "啟用時，會鎖定任務清單，必須按住 CTRL 鍵才能移動它。",
        ["esES"] = "Si está activado, el rastreador está bloqueado y debes mantener presionada la tecla CTRL cuando quieras moverlo.",
        ["frFR"] = "Si cette option est activée, le traqueur est vérouillé, maintenez CTRL lorsque vous souhaitez le déplacer.",
    },
    ---------------------------------------------------------
    ["Enable Tracker"] = {
    ...
    ["Enabling the Tracker will replace the default Blizzard Quest Tracker with the Questie Tracker.\n\nNOTE: Changing this setting will reload the UI."] = {
        ["ptBR"] = "Ativar o rastreador substituirá o rastreador de missões padrão da Blizzard pelo rastreador de Questie.\n\nNOTA: Alterar essa configuração recarregará a IU.",
        ...
        ["esMX"] = "Al activar el rastreador se reemplazará el rastreador Blizzard predeterminado por el rastreador.\n\nNOTA: al cambiar esta configuración se recargará la interfaz de usuario",
        ["enUS"] = true,
        ["zhCN"] = "启用跟踪器会将默认的暴雪自带任务追踪器替换为Questie追踪器。 \n\n注意：更改后会重新载入介面。",
        ["zhTW"] = "啟用任務位置提示插件的任務清單來取代遊戲內建的。\n\n更改後會重新載入介面。",
        ["esES"] = "Al activar el rastreador se reemplazará el rastreador Blizzard predeterminado por el rastreador.\n\nNOTA: al cambiar esta configuración se recargará la interfaz de usuario",
    ...
    ["Change the color of Objectives in the Questie Tracker by how complete they are.\n\nNOTE: The Minimalistic option will not display the \"Blizzard Completion Text\" and just label the Quest as either \"Quest Complete!\" or \"Quest Failed!\"."] = {
        ["ptBR"] = "Mude a cor dos objetivos no rastreador de Questie conforme estiverem completos.\n\nNOTA: A opção Minimalista não exibirá o \"Texto de conclusão de Blizzard\" e apenas rotulará a missão como \"Missão concluída!\" ou \"Missão Falhou!\".",
        ...
        ["esMX"] = "Cambia el color de los objetivos en el rastreador de misiones según lo completos que estén.\n\nNOTA: La opción Minimalista no mostrará el \"Texto de completación de Blizzard\" y solo etiquetará la misión como \"¡Misión completada!\" o \"¡Misión fracasada!\".",
        ["enUS"] = true,
    ...
    ["This shortcut removes a Quest from the Questie Tracker when the chat input box is NOT visible, otherwise this will link a Quest to chat."] = {
        ["ptBR"] = "Este atalho remove uma missão do rastreador de Questie quando a caixa de entrada do bate-papo NÃO está visível; caso contrário, ele vinculará uma missão ao bate-papo.",
    ...
    ["The outline used for Quest Zones, Titles, and Objectives in the Questie Tracker."] = {
        ["ptBR"] = "O contorno usado para as zonas de missão, títulos e objetivos no rastreador de Questie.",
    ...
    ["The height of the Questie Tracker based on percentage of usable screen height. A setting of 100 percent would make the Tracker fill the players entire screen height.\n\nNOTE: This setting only applies while in Sizer Mode: Auto"] = {
        ["ptBR"] = "A altura do rastreador de Questie baseada em percentagem da altura de tela utilizável. Uma configuração de 100 por cento faria com que o rastreador preenchesse toda a altura da tela do jogador.\n\nNOTA: Esta configuração só se aplica enquanto estiver no Modo de Redimensionamento: Automático.",
