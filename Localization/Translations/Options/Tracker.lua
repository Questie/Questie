...
local trackerOptionsLocales = {
    ...
    ["This is the same as 'Enable automatic quest tracking' in interface options. When enabled, the Questie Tracker will automatically track all quests in your log. This prevents shift-click manual tracking."] = {
        ...
        ["esMX"] = "Esto es lo mismo que 'Habilitar el seguimiento automático de misiones' en las opciones de la interfaz. Cuando está habilitado, el Questie Tracker rastreará automáticamente todas las misiones en tu registro. Esto evita el seguimiento manual de clic de cambio.",
        ["enUS"] = true,
        ...
        ["esES"] = "Esto es lo mismo que 'Habilitar el seguimiento automático de misiones' en las opciones de la interfaz. Cuando está habilitado, el Questie Tracker rastreará automáticamente todas las misiones en tu registro. Esto evita el seguimiento manual de clic de cambio.",
    ...
    ["When this is checked, the Quest Level Tags for Quest Titles will show in the Questie Tracker."] = {
        ...
        ["esMX"] = "Cuando esto está marcado, las etiquetas de nivel de búsqueda para los títulos de búsqueda se mostrarán en el Questie Tracker.",
        ["enUS"] = true,
        ["zhCN"] = "选中后，任务标题的任务等级标签将显示在Questie 追踪中",
        ["zhTW"] = "將任務等級顯示在追蹤視窗",
        ["esES"] = "Cuando esto está marcado, las etiquetas de nivel de búsqueda para los títulos de búsqueda se mostrarán en el Questie Tracker.",
    ...
    ["When this is checked, completed quests will show in the Questie Tracker."] = {
        ...
        ["esMX"] = "Cuando esto está marcado, las misiones completadas se mostrarán en el Questie Tracker.",
        ["enUS"] = true,
        ["zhCN"] = "选中后，完成的任务将显示在Questie 追踪中",
        ["zhTW"] = "讓已完成的任務持續顯示在任務追蹤列表中",
        ["esES"] = "Cuando esto está marcado, las misiones completadas se mostrarán en el Questie Tracker.",
    ...
    ["Show Blizzard Timer"] = {
        ...
        ["koKR"] = "블리자드 타이머 표시",
        ["esMX"] = "Mostrar temporizador de ventisca",
        ["enUS"] = true,
        ["zhCN"] = "显示暴风雪计时器",
        ["zhTW"] = "顯示暴雪任務計時器",
        ["esES"] = "Mostrar temporizador de ventisca",
    ...
    ["When this is checked, the default Blizzard Timer Frame for quests will be shown instead of being embedded inside the tracker."] = {
        ...
        ["enUS"] = true,
        ["zhCN"] = "选中该选项时，将显示任务的默认暴雪计时器帧，而不是嵌入到追踪器中",
    ...
    ["When this is checked, the Minimize and Maximize Buttons will fade and become transparent when not in use."] = {
        ...
        ["enUS"] = true,
        ["zhCN"] = "选中时，“最小化”和“最大化”按钮将在不使用时淡出并变为透明",
    ...
    ["Enable hooking the Blizzard quest tracker. This is required for some features of the Questie tracker, and to integrate with other addons. If you are having issues with quest tracking you may need to disable this (requires /reload)."] = {
        ...
        ["enUS"] = true,
        ["zhCN"] = "启用挂钩暴雪任务追踪器。这对于Questie追踪器的某些功能是必需的，并且与其他插件集成。如果您在任务追踪方面遇到问题，则可能需要禁用此功能（需要/ reload ）",
    ...
    ["When this is checked, the Questie Tracker Background becomes visible."] = {
        ...
        ["esMX"] = "Cuando esto está marcado, el fondo del Questie Tracker se vuelve visible",
        ["enUS"] = true,
        ["zhCN"] = "选中后，将显示 Questie 追踪背景",
        ["zhTW"] = "顯示背景",
        ["esES"] = "Cuando esto está marcado, el fondo del Questie Tracker se vuelve visible",
    ...
    ["When this is checked, the Questie Tracker Backdrop and Border (if enabled) will fade and become transparent when not in use."] = {
        ...
        ["esMX"] = "Cuando esto está marcado, el fondo y el borde del Questie Tracker (si está habilitado) se desvanecerán y se volverán transparentes cuando no estén en uso",
        ["enUS"] = true,
        ["zhCN"] = "选中后，Questie 追踪的背景和边框（如果启用）将褪色并在不使用时变为透明",
        ["zhTW"] = "未使用時，自動淡化背景與邊框",
        ["esES"] = "Cuando esto está marcado, el fondo y el borde del Questie Tracker (si está habilitado) se desvanecerán y se volverán transparentes cuando no estén en uso",
    ...
    ["When this is checked, the Questie Tracker Border becomes visible."] = {
        ...
        ["esMX"] = "Cuando esto está marcado, el borde del Questie Tracker se vuelve visible",
        ["enUS"] = true,
        ["zhCN"] = "显示边框",
        ["zhTW"] = "顯示邊框",
        ["esES"] = "Cuando esto está marcado, el borde del Questie Tracker se vuelve visible",
    ...
    ["When this is checked, the Questie Tracker Header will automatically move to the bottom of the Questie Tracker while the Tracker is placed in the bottom area of your screen. Otherwise, it will remain at the top always.\n\nNOTE: This setting only works while the 'Tracker SetPoint' is using the default 'Auto' mode."] = {
        ...
        ["esMX"] = "Cuando está marcado, el Encabezado del Questie Tracker se moverá automáticamente a la parte inferior del Questie Tracker mientras el Tracker se coloca en la parte inferior de la pantalla. De lo contrario, permanecerá en la parte superior siempre.\n\nNOTA: Esta configuración solo funciona mientras el 'Tracker SetPoint' está usando el modo predeterminado 'Automático'.",
        ["enUS"] = true,
        ["zhCN"] = "当选中此选项时，当追踪放置在屏幕底部时，Questie 追踪标题将自动移至Questie 追踪的底部。否则，它将始终保持在顶部。\n\n注意：此设置仅在启用自动移动标题模式时有效",
        ["zhTW"] = "Questie的標題列將會自動選擇在上方或下方顯示。\n\n注意：僅在自動移動標題列被啟用才有效",
        ["esES"] = "Cuando está marcado, el Encabezado del Questie Tracker se moverá automáticamente a la parte inferior del Questie Tracker mientras el Tracker se coloca en la parte inferior de la pantalla. De lo contrario, permanecerá en la parte superior siempre.\n\nNOTA: Esta configuración solo funciona mientras el 'Tracker SetPoint' está usando el modo predeterminado 'Automático'.",
    ...
    ["When this is checked, the Questie Tracker Header will become visible and the total number of quests you have in your log will be shown."] = {
        ...
        ["esMX"] = "Cuando esto esté marcado, el Encabezado de Questie Tracker se hará visible y se mostrará el número total de misiones que tienes en tu registro",
        ["enUS"] = true,
        ["zhCN"] = "选中后，“追踪标题”将变为可见，并且将显示您在日志中拥有的任务总数",
        ["zhTW"] = "顯示Questie標題列並包含目前的任務總數",
        ["esES"] = "Cuando esto esté marcado, el Encabezado de Questie Tracker se hará visible y se mostrará el número total de misiones que tienes en tu registro",
    ...
    ["If the Questie tracker is stuck offscreen or lost, you can reset it's location to the center of the screen with this button (may require /reload)."] = {
        ...
        ["enUS"] = true,
        ["zhCN"] = "如果Questie追踪器卡在屏幕外或丢失，您可以使用此按钮将其位置重置到屏幕中央（可能需要/reload）",
    ...
    ["You are currently saving the  Questie Tracker Location and Size Globally. This allows you to have one setting for all characters.\n\nNOTE: Upon enabling Global, the Tracker will be reset to the center of your screen. Move the Tracker to your desired location and set the size. When you are ready, type '/reload' to finalize your settings."] = {
        ...
        ["esMX"] = "Actualmente está guardando la ubicación y el tamaño del Questie Tracker a nivel mundial. Esto le permite tener una configuración para todos los caracteres.\n\nNOTA: Al habilitar Global, el Tracker se restablecerá en el centro de su pantalla . Mueva el Rastreador a su ubicación deseada y establezca el tamaño. Cuando esté listo, escriba '/reload' para finalizar su configuración.",
        ["enUS"] = true,
        ["zhCN"] = "您当前正在全局保存Questie 追踪的位置和大小。这使您可以对所有字符进行一次设置。\n\n注意：启用“全局”后，追踪将会重置为屏幕中心。将追踪移至所需位置并设置尺寸。准备好后，键入'/reload'完成设置。",
        ["zhTW"] = "將Questie任務追蹤視窗的位置與大小針對所有腳色做統一儲存。這可讓你對所有腳色擁有單一設定。\n\n注意: 啟用這設定時，會先將視窗重設到畫面中央。將任務追蹤視窗移動您想要的位置，並調整好大小。完成後，輸入'/reload'來完成所有設定。",
        ["esES"] = "Actualmente está guardando la ubicación y el tamaño del Questie Tracker a nivel mundial. Esto le permite tener una configuración para todos los caracteres.\n\nNOTA: Al habilitar Global, el Tracker se restablecerá en el centro de su pantalla . Mueva el Rastreador a su ubicación deseada y establezca el tamaño. Cuando esté listo, escriba '/reload' para finalizar su configuración.",
