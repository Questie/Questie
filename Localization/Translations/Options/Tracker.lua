...
local trackerOptionsLocales = {
    ...
    ["Tracker Options"] = {
        ...
        ["frFR"] = "Options du suivi",
        ["itIT"] = "Opzioni del tracciatore",
        ["koKR"] = "퀘스트 추적기 설정",
        ["ptBR"] = "Opções do rastreador",
    ...
    ["Auto Track Quests"] = {
        ...
        ["itIT"] = "Tracciamento automatico delle missioni",
        ["koKR"] = "자동 추적 퀘스트",
    ...
    ["This is the same as \"Enable Automatic Quest Tracking\" in the Blizzard Interface Options. If checked, the Questie Tracker will automatically track all Quests in your Quest Log. Disabling this option will untrack all Quests. You will have to manually select which Quests to track.\n\nNOTE: \"Show Complete Quests\" is disabled while this option is not being used."] = {
        ["enUS"] = true,
        ["deDE"] = "Dies ist dasselbe wie \"Automatische Questverfolgung aktivieren\" in den Schnittstellenoptionen. Wenn aktiviert, verfolgt der Questie-Tracker automatisch alle Quests im Questlog. Dies verhindert die manuelle Verfolgung durch \"Shift + Linksklick\".",
        ...
        ["itIT"] = "Questa opzione equivale a \"Abilita il tracciamento automatico delle missioni\" nelle opzioni dell'interfaccia di Blizzard. Se selezionata, il tracciatore di Questie traccerà automaticamente tutte le missioni nel tuo registro missioni. La disattivazione di questa opzione rimuoverà il tracciamento di tutte le missioni: dovrai selezionare manualmente quali missioni tracciare.\n\nNOTA: Con questa opzione disattivata, anche \"Mostra missioni completate\" risulterà disabilitata.",
    ...
    ["Show Completed Quests"] = {
        ...
        ["itIT"] = "Mostrare missioni completate",
        ["koKR"] = "완료된 퀘스트 표시",
    ...
    ["If checked, completed Quests will show in the Questie Tracker.\n\nNOTE: This setting only works when \"Auto Track Quests\" is enabled."] = {
        ...
        ["frFR"] = "Si cette option est cochée, les quêtes terminées s'afficheront dans le suivi.\n\nREMARQUE : Ce paramètre ne fonctionne que lorsque l'option « Suivi automatique des quêtes » est cochée.",
        ["itIT"] = "Se selezionata, le missioni completate verranno mostrate nel tracciatore di Questie.\n\nNOTA: Questa impostazione funziona solo quando \"Tracciamento automatico delle missioni\" è attivo.",
    ...
    ["Show Quest Level"] = {
        ...
        ["itIT"] = "Mostrare il livello delle missioni",
        ["koKR"] = "퀘스트 레벨 표시",
    ...
    ["If checked, the Quest Level Tags for Quest Titles will show in the Questie Tracker."] = {
        ...
        ["esES"] = "Si está seleccionado, el nivel de la misión se mostrará en el rastreador.",
        ["esMX"] = "Si está seleccionado, el nivel de la misión se mostrará en el rastreador.",
        ["frFR"] = "Si cette option est cochée, le niveau de la quête sera affiché dans le suivi.",
        ["itIT"] = "Se selezionata, le etichette del livello delle missioni verranno mostrate accanto ai titoli delle missioni nel tracciatore di Questie.",
        ["koKR"] = "이 옵션을 선택하면 퀘스트 제목에 대한 퀘스트 레벨 태그가 Questie 트래커에 표시됩니다.",
        ["ptBR"] = "Se marcado, o nível da missão será mostrado no rastreador.",
    ...
    ["Auto Minimize Completed Quests"] = {
        ...
        ["itIT"] = "Ridurre automaticamente le missioni completate",
        ["koKR"] = "완료된 퀘스트 자동 최소화",
    ...
    ["If checked, completed Quests will automatically minimize."] = {
        ...
        ["esES"] = "Si está seleccionado, las misiones completadas se minimizarán automáticamente.",
        ["esMX"] = "Si está seleccionado, las misiones completadas se minimizarán automáticamente.",
        ["frFR"] = "Si cette option est cochée, les quêtes terminées seront automatiquement réduites.",
        ["itIT"] = "Se selezionata, le missioni completate verranno ridotte automaticamente.",
        ["koKR"] = "이 옵션을 선택하면 완료된 퀘스트가 자동으로 최소화됩니다.",
        ["ptBR"] = "Se marcado, as missões concluídas serão automaticamente minimizadas.",
    ...
    ["Hide Completed Quest Objectives"] = {
        ...
        ["itIT"] = "Nascondere gli obiettivi delle missioni completate",
        ["koKR"] = "완료된 퀘스트 목표 숨기기",
    ...
    ["If checked, completed Quest Objectives will automatically be removed from the Questie Tracker."] = {
        ...
        ["esES"] = "Si está seleccionado, los objetivos de misiones completados se eliminarán automáticamente del rastreador.",
        ["esMX"] = "Si está seleccionado, los objetivos de misiones completados se eliminarán automáticamente del rastreador.",
        ["frFR"] = "Si cette option est cochée, les objectifs des quêtes terminées seront automatiquement supprimés du suivi.",
        ["itIT"] = "Se selezionata, gli obiettivi delle missioni completate verranno rimossi automaticamente dal tracciatore di Questie.",
    ...
    ["Hide Blizzard Completion Text"] = {
        ...
        ["itIT"] = "Nascondere il testo di completamento di Blizzard",
    ...
    ["If checked, Blizzard Completion Text will be hidden for completed Quests and instead show the old Questie tags: \"Quest Complete!\" or \"Quest Failed!\""] = {
        ...
        ["itIT"] = "Se selezionata, il testo di completamento di Blizzard verrà nascosto per le missioni completate e al suo posto verranno mostrate le vecchie etichette di Questie: \"Missione completata!\" o \"Missione fallita!\"",
    ...
    ["Hide Completed Achieve Objectives"] = {
        ...
        ["itIT"] = "Nascondere gli obiettivi dei risultati completati",
        ["koKR"] = "완료된 업적 목표 숨기기",
    ...
    ["If checked, completed Achievement Objectives will automatically be removed from the Questie Tracker."] = {
        ...
        ["esES"] = "Si está seleccionado, los objetivos de logro completados serán eliminados automáticamente del rastreador.",
        ["esMX"] = "Si está seleccionado, los objetivos de logro completados serán eliminados automáticamente del rastreador.",
        ["frFR"] = "Si cette option est cochée, les objectifs des hauts faits terminées seront automatiquement supprimés du suivi.",
        ["itIT"] = "Se selezionata, gli obiettivi dei risultati completati verranno rimossi automaticamente dal tracciatore di Questie.",
        ["koKR"] = "이 옵션을 선택하면 완료된 업적 목표가 자동으로 Questie 추적기에서 제거됩니다.",
        ["ptBR"] = "Se marcado, os objetivos de conquistas concluídos serão automaticamente removidos do rastreador.",
    ...
    ["Show Blizzard Timer"] = {
        ...
        ["itIT"] = "Mostrare il timer di Blizzard",
        ["koKR"] = "블리자드 타이머 표시",
    ...
    ["If checked, the default Blizzard Timer Frame for Quests will be shown instead of being embedded inside the Questie Tracker."] = {
        ...
        ["esES"] = "Si está seleccionado, se mostrará el marco del temporizador de Blizzard para las misiones en lugar de estar incorporado dentro del rastreador.",
        ["esMX"] = "Si está seleccionado, se mostrará el marco del temporizador de Blizzard para las misiones en lugar de estar incorporado dentro del rastreador.",
        ["frFR"] = "Si cette option est cochée, le cadre du chronomètre pour les quêtes est affiché au lieu d’être intégré au suivi.",
        ["itIT"] = "Se selezionata, verrà mostrato il riquadro del timer standard di Blizzard per le missioni, invece di essere incorporato nel tracciatore di Questie.",
        ["koKR"] = "이 옵션을 선택하면 추적기에 내장 된 대신 퀘스트에 대한 기본 블리자드 타이머 프레임이 표시됩니다.",
        ["ptBR"] = "Se marcado, o quadro do temporizador de Blizzard para missões será mostrado em vez de incorporado no rastreador.",
        ["ruRU"] = "Когда включено, будет отображаться стандартный таймер Blizzard вместо встраивания его в трекер",
        ["zhCN"] = "启用时，将显示暴雪默认的任务计时框架，而非将其嵌入Questie追踪器内",
    ...
    ["Enable Tracker Header"] = {
        ...
        ["itIT"] = "Attivare l'intestazione del tracciatore",
        ["koKR"] = "추적기 헤더 활성화",
    ...
    ["If checked, the Tracker Header with the number of active quests and the Questie Icon will be permanently visible.\n\nWhen this is disabled the Questie Icon will fade in while your mouse is over the Tracker."] = {
        ...
        ["esES"] = "Si está seleccionado, el encabezado del rastreador con el número de misiones activas y el icono de Questie estarán permanentemente visibles.\n\nSi está desactivado, el icono de Questie desaparecerá mientras el ratón esté sobre el rastreador.",
        ["esMX"] = "Si está seleccionado, el encabezado del rastreador con el número de misiones activas y el icono de Questie estarán permanentemente visibles.\n\nSi está desactivado, el icono de Questie desaparecerá mientras el ratón esté sobre el rastreador.",
        ["frFR"] = "Si cette option est cochée, l'en-tête du suivi avec le nombre de quêtes actives et l'icône de Questie restera visible en permanence.\n\nSi cette option est désactivée, l'icône de Questie s'estompera lorsque votre souris survolera le suivi.",
        ["itIT"] = "Se selezionata, l'intestazione del tracciatore con il numero di missioni attive e l'icona di Questie sarà sempre visibile.\n\nQuando questa opzione è disattivata, l'icona di Questie apparirà in dissolvenza quando il mouse passa sopra il tracciatore.",
        ...
        ["zhCN"] = "启用时，带有当前活跃任务数量的追踪器标题以及Questie图标将始终可见\n\n停用时，当鼠标悬停在追踪器上时，Questie图标才会淡化显示",
    ...
    ["Show Tracker Header At The Bottom"] = {
        ...
        ["esES"] = "Mostrar en la parte inferior",
        ["esMX"] = "Mostrar en la parte inferior",
        ["frFR"] = "Afficher l'en-tête du suivi en bas",
        ["itIT"] = "Mostrare l'intestazione del tracciatore in basso",
        ["koKR"] = "추적기 헤더 하단 표시",
    ...
    ["If checked, the Tracker Header and/or the Questie Icon will be moved to the bottom of the Questie Tracker and the sizer to the top."] = {
        ...
        ["esES"] = "Si está seleccionado, el encabezado del rastreador y/o el icono de Questie se moverán a la parte inferior del rastreador y el medidor a la parte superior.",
        ["esMX"] = "Si está seleccionado, el encabezado del rastreador y/o el icono de Questie se moverán a la parte inferior del rastreador y el medidor a la parte superior.",
        ["frFR"] = "Si cette option est cochée, l'en-tête du suivi et/ou l'icône de Questie seront déplacés en bas du suivi et le calibreur en haut.",
        ["itIT"] = "Se selezionata, l'intestazione del tracciatore e/o l'icona di Questie verranno spostate in fondo al tracciatore di Questie e il dispositivo di ridimensionamento in alto.",
        ["koKR"] = "이 옵션을 선택하면 추적기 헤더와 Questie 아이콘이 Questie 추적기 하단으로 이동하고 크기 조정기가 상단으로 이동합니다.",
        ["ptBR"] = "Se marcado, o cabeçalho do rastreador e/ou o ícone de Questie serão movidos para a parte inferior do rastreador e o medidor para o topo.",
    ...
    ["Sticky Durability Frame"] = {
        ...
        ["frFR"] = "Cadre de durabilité fixe",
        ["itIT"] = "Riquadro della durabilità fisso",
        ["koKR"] = "달라붙는 프레임",
    ...
    ["If checked, the durability frame will be placed on the left or right side of the Questie Tracker depending on where the Tracker is placed on your screen."] = {
        ...
        ["esES"] = "Si está seleccionado, el marco de durabilidad se colocará en el lado izquierdo o derecho del rastreador, dependiendo de dónde esté ubicado el rastreador en su pantalla.",
        ["esMX"] = "Si está seleccionado, el marco de durabilidad se colocará en el lado izquierdo o derecho del rastreador, dependiendo de dónde esté ubicado el rastreador en su pantalla.",
        ["frFR"] = "Si cette option est cochée, le cadre de durabilité sera placé à gauche ou à droite du suivi en fonction de l’emplacement de celui-ci sur votre écran.",
        ["itIT"] = "Se selezionata, il riquadro della durabilità verrà posizionato sul lato sinistro o destro del tracciatore di Questie, a seconda di dove si trova il tracciatore sullo schermo.",
        ["koKR"] = "이 옵션을 선택하면 화면에서 트래커의 위치에 따라 내구성 프레임이 트래커의 왼쪽 또는 오른쪽에 배치됩니다.",
        ["ptBR"] = "Se marcado, o quadro de durabilidade será colocado no lado esquerdo ou direito do Rastreador, dependendo de onde o Rastreador estiver colocado na tela.",
        ...
        ["zhCN"] = "启用时，耐久度框架会根据追踪器在屏幕上的位置，显示在Questie追踪器的左侧或右侧",
    ...
    ["If checked, the Questie Tracker will automatically be minimized while entering combat."] = {
        ...
        ["esES"] = "Si está seleccionado, el rastreador se minimizará automáticamente al entrar en combate.",
        ["esMX"] = "Si está seleccionado, el rastreador se minimizará automáticamente al entrar en combate.",
        ["frFR"] = "Si cette option est cochée, le suivi sera automatiquement réduit lors des combats.",
        ["itIT"] = "Se selezionata, il tracciatore di Questie verrà ridotto automaticamente quando entri in combattimento.",
    ...
    ["Minimize In Instances"] = {
        ...
        ["esES"] = "Minimizar en estancias",
        ["esMX"] = "Minimizar en estancias",
        ["frFR"] = "Réduire dans les instances",
        ["itIT"] = "Ridurre nelle istanze",
        ["koKR"] = "인스턴스 내 최소화",
        ["ptBR"] = "Minimizar em instâncias",
        ["ruRU"] = "Свернуть в инстансах",
        ["zhCN"] = "副本中最小化",
        ["zhTW"] = "副本中最小化",
    },
    ["If checked, the Questie Tracker will automatically be minimized when entering a dungeon, raid, or battleground."] = {
        ...
        ["itIT"] = "Se selezionata, il tracciatore di Questie verrà ridotto automaticamente quando entri in una spedizione, un'incursione o un campo di battaglia.",
        ...
        ["ruRU"] = "Когда включено, трекер Questie будет автоматически свернут при входе в подземелье, рейд или на поле боя",
    ...
    ["Hide In Combat"] = {
        ...
        ["itIT"] = "Nascondere in combattimento",
        ["koKR"] = "전투 중 숨기기",
    ...
    ["If checked, the Questie Tracker will automatically be hidden when entering combat."] = {
        ...
        ["itIT"] = "Se selezionata, il tracciatore di Questie verrà nascosto automaticamente quando entri in combattimento.",
    ...
    ["Hide In Instances"] = {
        ...
        ["esES"] = "Ocultar en estancias",
        ["esMX"] = "Ocultar en estancias",
        ["frFR"] = "Cacher dans les instances",
        ["itIT"] = "Nascondere nelle istanze",
        ["koKR"] = "인스턴스에서 숨기기",
        ["ptBR"] = "Ocultar em instâncias",
        ["ruRU"] = "Скрывать в инстансах",
        ["zhCN"] = "在副本中隐藏",
        ["zhTW"] = "在副本中隱藏",
    },
    ["If checked, the Questie Tracker will automatically be hidden when entering a dungeon, raid, or battleground."] = {
        ...
        ["itIT"] = "Se selezionata, il tracciatore di Questie verrà nascosto automaticamente quando entri in una spedizione, un'incursione o un campo di battaglia.",
        ...
        ["ruRU"] = "Когда включено, трекер Questie будет автоматически скрыт при входе в подземелье, рейд или на поле боя",
    ...
    ["Hide In Pet Battles"] = {
        ...
        ["itIT"] = "Nascondere durante le battaglie tra animali",
        ["koKR"] = "펫 배틀 시 숨기기",
    ...
    ["If checked, the Questie Tracker will automatically be hidden when entering a pet battle."] = {
        ...
        ["itIT"] = "Se selezionata, il tracciatore di Questie verrà nascosto automaticamente quando inizi una battaglia tra animali.",
        ...
        ["ruRU"] = "Когда включено, трекер Questie будет автоматически скрыт при входе в битву питомцев",
    ...
    ["Fade Min/Max Buttons"] = {
        ...
        ["itIT"] = "Dissolvenza dei pulsanti min/max",
        ["koKR"] = "페이드 최소 / 최대 BTN",
    ...
    ["If checked, the Minimize and Maximize Buttons will fade and become transparent when not in use."] = {
        ...
        ["esES"] = "Si está seleccionado, los botones minimizar y maximizar se desvanecerán y se volverán transparentes cuando no estén en uso.",
        ["esMX"] = "Si está seleccionado, los botones minimizar y maximizar se desvanecerán y se volverán transparentes cuando no estén en uso.",
        ["frFR"] = "Si cette option est cochée, les boutons min. et max. s’estompent et deviennent transparents lorsqu’ils ne sont pas utilisés.",
        ["itIT"] = "Se selezionata, i pulsanti Riduci e Ingrandisci si dissolveranno diventando trasparenti quando non vengono utilizzati.",
        ["koKR"] = "이 옵션을 선택하면 사용하지 않을 때 최소화 및 최대화 버튼이 사라지고 투명 해집니다.",
        ["ptBR"] = "Se marcado, os botões minimizar e maximizar desaparecerão e se tornarão transparentes quando não estiverem em uso.",
    ...
    ["Fade Quest Item Buttons"] = {
        ...
        ["itIT"] = "Dissolvenza dei pulsanti degli oggetti missione",
        ["koKR"] = "페이드 퀘스트 아이템 버튼",
    ...
    ["If checked, the Quest Item Buttons will fade and become transparent when not in use."] = {
        ...
        ["esES"] = "Si está seleccionado, los botones de objetos de misión se desvanecerán y se volverán transparentes cuando no estén en uso.",
        ["esMX"] = "Si está seleccionado, los botones de objetos de misión se desvanecerán y se volverán transparentes cuando no estén en uso.",
        ["frFR"] = "Si cette option est cochée, les boutons des objets de quête s’estompent et deviennent transparents lorsqu’ils ne sont pas utilisés.",
        ["itIT"] = "Se selezionata, i pulsanti degli oggetti missione si dissolveranno diventando trasparenti quando non vengono utilizzati.",
        ["koKR"] = "이 옵션을 선택하면 퀘스트 아이템 버튼이 사라지고 사용하지 않을 때 투명해집니다.",
        ["ptBR"] = "Se marcado, os botões de itens de missão desaparecerão e se tornarão transparentes quando não estiverem em uso.",
    ...
    ["If checked, the Questie Tracker Background becomes visible."] = {
        ...
        ["esES"] = "Si está seleccionado, el fondo del rastreador se vuelve visible.",
        ["esMX"] = "Si está seleccionado, el fondo del rastreador se vuelve visible.",
        ["frFR"] = "Si cette option est cochée, l’arrière-plan du suivi devient visible.",
        ["itIT"] = "Se selezionata, lo sfondo del tracciatore di Questie diventa visibile.",
        ["koKR"] = "이 옵션을 선택하면 Questie 추적기 배경이 나타납니다.",
        ["ptBR"] = "Se marcado, o fundo do rastreador de missões fica visível.",
    ...
    ["If checked, the Questie Tracker Border becomes visible."] = {
        ...
        ["esES"] = "Si está seleccionado, el borde del rastreador se vuelve visible.",
        ["esMX"] = "Si está seleccionado, el borde del rastreador se vuelve visible.",
        ["frFR"] = "Si cette option est cochée, la bordure du suivi devient visible.",
        ["itIT"] = "Se selezionata, il bordo del tracciatore di Questie diventa visibile.",
        ["koKR"] = "이 옵션을 선택하면 Questie 트래커 테두리가 나타납니다.",
        ["ptBR"] = "Se marcado, a borda do rastreador de missões fica visível.",
        ["ruRU"] = "Показать/скрыть границу фона трекера",
        ["zhCN"] = "启用时，Questie追踪器的边框将变得可见",
        ["zhTW"] = "啟用時，任務清單會顯示邊框",
    },
    ---------------------------------------------------------
    ["Fade Background"] = {
    ...
    ["If checked, the Questie Tracker background and border (if enabled) will fade and become transparent when not in use."] = {
        ...
        ["esES"] = "Si está seleccionado, el fondo y el borde del rastreador (si está activado) se desvanecerán y se volverán transparentes cuando no estén en uso.",
        ["esMX"] = "Si está seleccionado, el fondo y el borde del rastreador (si está activado) se desvanecerán y se volverán transparentes cuando no estén en uso.",
        ["frFR"] = "Si cette option est cochée, l’arrière-plan et la bordure du suivi (si activée) s’estompent et deviennent transparents lorsqu’ils ne sont pas utilisés.",
        ["itIT"] = "Se selezionata, lo sfondo e il bordo del tracciatore di Questie (se attivati) si dissolveranno diventando trasparenti quando non vengono utilizzati.",
        ["koKR"] = "이 옵션을 선택하면 Questie 트래커 배경 및 테두리 (사용 가능한 경우)가 사라지고 사용하지 않을 때 투명 해집니다.",
        ["ptBR"] = "Se marcado, o fundo e a borda do rastreador (se ativado) desaparecerão e se tornarão transparentes quando não estiverem em uso.",
        ["ruRU"] = "Когда включено, фон и граница трекера исчезают и становятся прозрачными при неиспользовании",
        ["zhCN"] = "启用时，Questie追踪器的背景和边框（若已启用）在不使用时会淡化并变为透明。",
    ...
    ["Disable Quest Hover Fade"] = {
        ...
        ["frFR"] = "Désactiver l’estompage au survol",
        ["itIT"] = "Disattivare la dissolvenza al passaggio del mouse sulle missioni",
        ["koKR"] = "퀘스트 호버 페이드 비활성화",
    ...
    ["If checked, the other quests in the tracker will stay fully opaque while hovering a quest."] = {
        ...
        ["esES"] = "Si está seleccionado, las demás misiones del rastreador permanecerán totalmente opacas al pasar el cursor sobre una misión.",
        ["esMX"] = "Si está seleccionado, las demás misiones del rastreador permanecerán totalmente opacas al pasar el cursor sobre una misión.",
        ["frFR"] = "Si cette option est cochée, les autres quêtes du suivi resteront entièrement opaques lors du survol d’une quête.",
        ["itIT"] = "Se selezionata, le altre missioni del tracciatore rimarranno completamente opache mentre passi il mouse su una missione.",
        ["koKR"] = "이 옵션을 선택하면 퀘스트에 마우스를 올려도 추적기 내의 다른 퀘스트가 완전히 불투명하게 유지됩니다.",
        ["ptBR"] = "Se marcado, as outras missões do rastreador permanecerão totalmente opacas ao passar o cursor sobre uma missão.",
        ["ruRU"] = "Когда включено, другие задания в трекере останутся полностью непрозрачными при наведении курсора на задание",
        ["zhCN"] = "启用时，将鼠标悬停在某个任务上时，追踪器中的其他任务将保持完全不透明",
        ["zhTW"] = "啟用時，將滑鼠懸停在某個任務上時，追蹤器中的其他任務將保持完全不透明",
    },
    ---------------------------------------------------------
    ["Hide Tracker Sizer"] = {
        ["enUS"] = true,
        ...
        ["itIT"] = "Nascondere il dispositivo di ridimensionamento del tracciatore",
        ["koKR"] = "추적기 크기 조정기 숨기기",
    ...
    ["If checked, the Questie Tracker Sizer that appears in the bottom or top right hand corner will be hidden."] = {
        ...
        ["esES"] = "Si está seleccionado, el medidor del rastreador que aparece en la esquina inferior o superior derecha estará oculto.",
        ["esMX"] = "Si está seleccionado, el medidor del rastreador que aparece en la esquina inferior o superior derecha estará oculto.",
        ["frFR"] = "Si cette option est cochée, le calibreur du suivi qui apparaît dans le coin inférieur ou supérieur droit sera caché.",
        ["itIT"] = "Se selezionata, il dispositivo di ridimensionamento del tracciatore di Questie, che appare nell'angolo inferiore o superiore destro, verrà nascosto.",
        ["koKR"] = "이 옵션을 선택하면 오른쪽 하단 또는 상단에 나타나는 Questie 추적기 크기 조정기가 숨겨집니다.",
        ["ptBR"] = "Se marcado, o redimensionador do rastreador que aparece no canto inferior ou superior direito será ocultado.",
        ...
        ["zhCN"] = "启用时，出现在右下角或右上角的Questie追踪器缩放点将被隐藏",
    ...
    ["Show Header For Empty Tracker"] = {
        ...
        ["itIT"] = "Mostrare l'intestazione per il tracciatore vuoto",
        ["koKR"] = "빈 추적기 헤더 표시",
    ...
    ["If checked, the Tracker Header will be visible even when no quests are being tracked versus the Tracker being hidden completely."] = {
        ...
        ["esES"] = "Si está seleccionado, el encabezado del rastreador será visible incluso cuando no se estén rastreando misiones, en lugar de que el rastreador esté completamente oculto.",
        ["esMX"] = "Si está seleccionado, el encabezado del rastreador será visible incluso cuando no se estén rastreando misiones, en lugar de que el rastreador esté completamente oculto.",
        ["frFR"] = "Si cette option est cochée, l'en-tête du suivi sera visible même lorsque aucune quête n'est suivie, contrairement à la dissimulation complète du suivi.",
        ["itIT"] = "Se selezionata, l'intestazione del tracciatore sarà visibile anche quando non viene tracciata nessuna missione, invece di nascondere completamente il tracciatore.",
        ...
        ["zhCN"] = "启用时，即使没有正在追踪的任务，追踪器标题也会保持可见，而不是整个追踪器完全隐藏。",
    ...
    ["If checked, the Questie Tracker will list Achievements first then Quests."] = {
        ...
        ["esES"] = "Si está seleccionado, el rastreador listará primero los logros y después las misiones.",
        ["esMX"] = "Si está seleccionado, el rastreador listará primero los logros y después las misiones.",
        ["frFR"] = "Si cette option est cochée, le suivi affichera d'abord les hauts faits, puis les quêtes.",
        ["itIT"] = "Se selezionata, il tracciatore di Questie elencherà prima i risultati e poi le missioni.",
        ["koKR"] = "이 옵션을 선택하면 Questie 추적기가 먼저 업적을 나열한 후 퀘스트를 나열합니다.",
        ["ptBR"] = "Se marcado, o rastreador listará primeiro as conquistas e depois as missões.",
        ["ruRU"] = "Когда включено, достижения в трекере будут отображаться сверху заданий",
        ["zhCN"] = "启用时，Questie追踪器将先列出成就，然后再列出任务",
    ...
    ["If checked, the VoiceOver talking head / sound queue frame will be placed on the left or right side of the Questie Tracker depending on where the Tracker is placed on your screen."] = {
        ...
        ["esES"] = "Si está seleccionado, el marco de la cabeza parlante de VoiceOver / cola de sonido se colocará en el lado izquierdo o derecho del rastreador dependiendo de dónde esté ubicado el rastreador en la pantalla.",
        ["esMX"] = "Si está seleccionado, el marco de la cabeza parlante de VoiceOver / cola de sonido se colocará en el lado izquierdo o derecho del rastreador dependiendo de dónde esté ubicado el rastreador en la pantalla.",
        ["frFR"] = "Si cette option est cochée, le cadre de tête parlante / file d'attente sonore de VoiceOver sera placé sur le côté gauche ou droit du suivi en fonction de l'emplacement du suivi sur l'écran.",
        ["itIT"] = "Se selezionata, il riquadro della testa parlante / della coda sonora di VoiceOver verrà posizionato sul lato sinistro o destro del tracciatore di Questie, a seconda di dove si trova il tracciatore sullo schermo.",
        ...
        ["zhCN"] = "启用时，VoiceOver框架将根据追踪器在屏幕上的位置，放置在 Questie 追踪器的左侧或右侧",
        ["zhTW"] = "啟用時，VoiceOver框架會放在任務清單的左側或右側，依據任務清單在畫面上的位置而定",
    },
    ---------------------------------------------------------
    ["Lock Tracker"] = {
        ["enUS"] = true,
        ...
        ["frFR"] = "Verrouiller le suivi",
        ["itIT"] = "Bloccare il tracciatore",
        ["koKR"] = "추적기 잠금",
    ...
    ["If checked, the Questie Tracker is locked and you need to hold CTRL when you want to move it."] = {
        ...
        ["esES"] = "Si está seleccionado, el rastreador estará bloqueado y debes mantener presionada la tecla CTRL cuando quieras moverlo.",
        ["esMX"] = "Si está seleccionado, el rastreador estará bloqueado y debes mantener presionada la tecla CTRL cuando quieras moverlo.",
        ["frFR"] = "Si cette option est cochée, le suivi est vérouillé, maintenez CTRL lorsque vous souhaitez le déplacer.",
        ["itIT"] = "Se selezionata, il tracciatore di Questie è bloccato e devi tenere premuto CTRL per spostarlo.",
        ["koKR"] = "이 옵션을 선택하면 Questie 추적기를 고정하며, 추적기의 위치를 이동하려면 CTRL 키를 눌러야 합니다.",
        ["ptBR"] = "Se marcado, o rastreador estará bloqueado e você precisará manter pressionada a tecla CTRL quando quiser movê-lo.",
        ["ruRU"] = "Когда включено, то трекер заблокирован, и для его перемещения вам нужно зажать Ctrl",
        ["zhCN"] = "启用时，Questie追踪器被锁定，您需要按住 CTRL 键才能移动它",
    ...
    ["Enable Tracker"] = {
        ...
        ["esES"] = "Activar rastreador",
        ["esMX"] = "Activar rastreador",
        ["frFR"] = "Activer le suivi",
        ["itIT"] = "Attivare il tracciatore",
        ["koKR"] = "트래커 활성화",
    ...
    ["Enabling the Tracker will replace the default Blizzard Quest Tracker with the Questie Tracker.\n\nNOTE: Changing this setting will reload the UI."] = {
        ...
        ["itIT"] = "Attivare il tracciatore sostituirà il tracciatore missioni standard di Blizzard con il tracciatore di Questie.\n\nNOTA: La modifica di questa impostazione ricaricherà l'interfaccia utente.",
    ...
    ["Reset Tracker"] = {
        ...
        ["itIT"] = "Ripristinare il tracciatore",
        ["koKR"] = "추적기 위치 재설정",
    ...
    ["If the Questie Tracker is stuck offscreen or lost, you can reset it's location to the center of the screen with this button."] = {
        ...
        ["esES"] = "Si el rastreador está atascado o perdido, puede restablecer su ubicación en el centro de la pantalla con este botón.",
        ["esMX"] = "Si el rastreador está atascado o perdido, puede restablecer su ubicación en el centro de la pantalla con este botón.",
        ["frFR"] = "Si le suivi est bloqué hors écran ou perdu, vous pouvez réinitialiser son emplacement au centre de l'écran avec ce bouton (peut nécessiter de /reload).",
        ["itIT"] = "Se il tracciatore di Questie è bloccato fuori dallo schermo o è andato perso, puoi ripristinarne la posizione al centro dello schermo con questo pulsante.",
        ["koKR"] = "Questie 트래커가 화면을 벗어나거나 잃어버린 경우, 이 버튼을 사용하여 화면 중앙으로 위치를 재설정 할 수 있습니다 (/reload 필요).",
        ["ptBR"] = "Se o rastreador estiver preso fora da tela ou perdido, você poderá redefinir sua localização para o centro da tela com este botão (pode exigir / recarregar).",
    ...
    ["Change the color of Objectives in the Questie Tracker by how complete they are.\n\nNOTE: The Minimalistic option will not display the \"Blizzard Completion Text\" and just label the Quest as either \"Quest Complete!\" or \"Quest Failed!\"."] = {
        ...
        ["frFR"] = "Modifiez la couleur des objectifs dans le suivi en fonction de leur état de terminaison.\n\nREMARQUE : L'option Minimaliste n'affichera pas le \"Texte de terminaison de Blizzard\" et se contentera d'afficher la quête comme \"Quête terminée !\" ou \"Quête échec !\".",
        ["itIT"] = "Cambia il colore degli obiettivi nel tracciatore di Questie in base al loro livello di completamento.\n\nNOTA: L'opzione Minimalista non mostrerà il \"testo di completamento di Blizzard\" e si limiterà a etichettare la missione come \"Missione completata!\" o \"Missione fallita!\".",
    ...
    ["Objective Sorting"] = {
        ...
        ["itIT"] = "Ordinamento degli obiettivi",
        ["koKR"] = "퀘스트 목표 정렬",
    ...
    ["How Objectives are sorted in the Questie Tracker."] = {
        ...
        ["itIT"] = "Come vengono ordinati gli obiettivi nel tracciatore di Questie.",
    ...
    ["How Objectives are sorted in the Questie Tracker.\n\nNOTE: This will not sort Achievements."] = {
        ...
        ["itIT"] = "Come vengono ordinati gli obiettivi nel tracciatore di Questie.\n\nNOTA: Questo non ordinerà i risultati.",
    ...
    ["By %% Complete (Reversed)"] = {
        ...
        ["itIT"] = "Per %% di completamento (inverso)",
        ["koKR"] = "완료된 퍼센트 (역순)",
    ...
    ["By Zone Prox (Reversed)"] = {
        ...
        ["itIT"] = "Per vicinanza di zona (inverso)",
        ["koKR"] = "지역 근접도 (역순)",
    ...
    ["Set |cFF54e33bTomTom|r Target"] = {
        ...
        ["itIT"] = "Imposta la destinazione |cFF54e33bTomTom|r",
    ...
    ["This shortcut will set the TomTom arrow to point to either an NPC or the first incomplete Quest Objective (if location data is available)."] = {
        ...
        ["itIT"] = "Questa scorciatoia farà puntare la freccia di TomTom a un NPC o al primo obiettivo di missione incompleto (se sono disponibili i dati sulla posizione).",
    ...
    ["This shortcut will set the TomTom arrow to point to either an NPC or the first incomplete Quest Objective (if location data is available).\n\nNOTE: This will not work with Achievements."] = {
        ...
        ["itIT"] = "Questa scorciatoia farà puntare la freccia di TomTom a un NPC o al primo obiettivo di missione incompleto (se sono disponibili i dati sulla posizione).\n\nNOTA: Questo non funzionerà con i risultati.",
    ...
    ["Show in Quest Log"] = {
        ...
        ["itIT"] = "Mostrare nel registro missioni",
        ["koKR"] = "퀘스트 로그에서 표시",
    ...
    ["This shortcut will open the Quest Log with the clicked Quest selected."] = {
        ...
        ["itIT"] = "Questa scorciatoia aprirà il registro missioni con la missione selezionata su cui hai fatto clic.",
    ...
    ["Show Quest / Achievement"] = {
        ...
        ["itIT"] = "Mostrare missione / risultato",
        ["koKR"] = "퀘스트 / 업적 표시",
    ...
    ["This shortcut will open the Quest Log with the clicked Quest selected or open Achievements with the clicked Achievement selected."] = {
        ...
        ["itIT"] = "Questa scorciatoia aprirà il registro missioni con la missione selezionata su cui hai fatto clic, oppure aprirà i risultati con quello selezionato su cui hai fatto clic.",
    ...
    ["Untrack / Link Quest"] = {
        ...
        ["itIT"] = "Smetti di tracciare / Collega missione",
        ["koKR"] = "퀘스트 추적 취소 / 링크",
    ...
    ["This shortcut removes a Quest from the Questie Tracker when the chat input box is NOT visible, otherwise this will link a Quest to chat."] = {
        ...
        ["itIT"] = "Questa scorciatoia rimuove una missione dal tracciatore di Questie quando la finestra di input della chat NON è visibile; altrimenti collegherà la missione in chat.",
    ...
    ["Untrack / Link"] = {
        ...
        ["itIT"] = "Smettere di tracciare / Collegare",
        ["koKR"] = "추적종료 / 링크 퀘스트",
        ["ptBR"] = "Remover rastreio/vincular missão",
        ["ruRU"] = "Отмена / Ссылка",
        ["zhCN"] = "停止追踪 / 链接",
    ...
    ["This shortcut removes a Quest or an Achievement from the Questie Tracker when the chat input box is NOT visible, otherwise this will link a Quest or an Achievement to chat."] = {
        ...
        ["esES"] = "Este atajo elimina una misión o un logro del rastreador cuando la caja de entrada de chat NO está visible; de lo contrario, vinculará una misión o un logro al chat.",
        ["esMX"] = "Este atajo elimina una misión o un logro del rastreador cuando la caja de entrada de chat NO está visible; de lo contrario, vinculará una misión o un logro al chat.",
        ["frFR"] = "Ce raccourci retire une quête ou un haut fait du suivi lorsque la boîte de saisie de discussion n'est PAS visible, sinon il liera une quête ou un haut fait au discussion.",
        ["itIT"] = "Questa scorciatoia rimuove una missione o un risultato dal tracciatore di Questie quando la finestra di input della chat NON è visibile; altrimenti collegherà la missione o il risultato in chat.",
        ["koKR"] = "이 단축키는 채팅 입력창이 보이지 않을 때 Questie 추적기에서 퀘스트나 업적을 제거하며, 그렇지 않으면 퀘스트나 업적을 채팅에 링크합니다.",
        ["ptBR"] = "Este atalho remove uma missão ou uma conquista do rastreador quando a caixa de entrada do bate-papo NÃO está visível; caso contrário, ele vinculará uma missão ou uma conquista ao bate-papo.",
    ...
    ["Tracker Growth Direction"] = {
        ...
        ["itIT"] = "Direzione di crescita del tracciatore",
        ["koKR"] = "추적기 성장 방향",
    ...
    ["This determines the direction in which the Questie Tracker grows when you add or remove Quests. For example, if you use the \"Up & Right\" option then the ideal place for the Tracker should be in the lower left-hand corner of your screen. This allows the \"Sizer Mode: Auto\" to push the Tracker Height and Width \"Up & Right\" so the Tracker doesn't inadvertently cover up elements of your UI."] = {
        ...
        ["frFR"] = "Cela détermine la direction dans laquelle le suivi se développe lorsque vous ajoutez ou supprimez des quêtes. Par exemple, si vous utilisez l'option \"Haut et Droite\", alors l'endroit idéal pour le suivi devrait être dans le coin inférieur gauche de votre écran. Cela permet au \"Mode de calibrage : Automatique\" de pousser la hauteur et la largeur du suivi \"Haut et Droite\" afin que le suivi ne recouvre pas involontairement des éléments de votre interface utilisateur.",
        ["itIT"] = "Questa opzione determina la direzione in cui cresce il tracciatore di Questie quando aggiungi o rimuovi missioni. Ad esempio, se usi l'opzione \"In alto e a destra\", la posizione ideale per il tracciatore dovrebbe essere l'angolo in basso a sinistra dello schermo. In questo modo la \"Modalità di ridimensionamento: Auto\" potrà spingere l'altezza e la larghezza del tracciatore \"In alto e a destra\", così il tracciatore non coprirà inavvertitamente elementi della tua interfaccia.",
    ...
    ["Font Size for Active Quests Header"] = {
        ...
        ["itIT"] = "Dimensione del carattere per l'intestazione delle missioni attive",
        ["koKR"] = "활성 퀘스트의 글꼴 크기",
    ...
    ["The font size used for the Active Quests Header."] = {
        ...
        ["itIT"] = "La dimensione del carattere usata per l'intestazione delle missioni attive.",
    ...
    ["Font for Active Quests Header"] = {
        ...
        ["itIT"] = "Carattere per l'intestazione delle missioni attive",
        ["koKR"] = "활성 퀘스트를위한 글꼴",
    ...
    ["The font used for the Active Quests Header."] = {
        ...
        ["itIT"] = "Il carattere usato per l'intestazione delle missioni attive.",
    ...
    ["Font Size for Zone Names"] = {
        ...
        ["itIT"] = "Dimensione del carattere per i nomi delle zone",
        ["koKR"] = "영역 이름의 글꼴 크기",
    ...
    ["The font size used for zone names."] = {
        ...
        ["itIT"] = "La dimensione del carattere usata per i nomi delle zone.",
    ...
    ["Font for Zone Names"] = {
        ...
        ["itIT"] = "Carattere per i nomi delle zone",
        ["koKR"] = "영역 이름의 글꼴",
    ...
    ["The font used for zone names."] = {
        ...
        ["itIT"] = "Il carattere usato per i nomi delle zone.",
    ...
    ["Font Size for Quest Titles"] = {
        ...
        ["itIT"] = "Dimensione del carattere per i titoli delle missioni",
        ["koKR"] = "퀘스트 제목의 글꼴 크기",
    ...
    ["The font size used for Quest Titles.\n\nNOTE: Objective font size will auto adjust to less than or equal to Quest font size. This is necessary to avoid any text collisions and formatting abnormalities."] = {
        ...
        ["itIT"] = "La dimensione del carattere usata per i titoli delle missioni.\n\nNOTA: La dimensione del carattere degli obiettivi si adeguerà automaticamente a una dimensione minore o uguale a quella delle missioni. Questo è necessario per evitare collisioni di testo e anomalie di formattazione.",
    ...
    ["Font for Quest Titles"] = {
        ...
        ["itIT"] = "Carattere per i titoli delle missioni",
        ["koKR"] = "퀘스트 타이틀용 글꼴",
    ...
    ["The font used for Quest Titles."] = {
        ...
        ["itIT"] = "Il carattere usato per i titoli delle missioni.",
    ...
    ["Font Size for Objectives"] = {
        ...
        ["itIT"] = "Dimensione del carattere per gli obiettivi",
        ["koKR"] = "목표를위한 글꼴 크기",
    ...
    ["The font size used for Objectives.\n\nNOTE: Objective font size will auto adjust to less than or equal to Quest font size. This is necessary to avoid any text collisions and formatting abnormalities."] = {
        ...
        ["itIT"] = "La dimensione del carattere usata per gli obiettivi.\n\nNOTA: La dimensione del carattere degli obiettivi si adeguerà automaticamente a una dimensione minore o uguale a quella delle missioni. Questo è necessario per evitare collisioni di testo e anomalie di formattazione.",
    ...
    ["Font for Objectives"] = {
        ...
        ["itIT"] = "Carattere per gli obiettivi",
        ["koKR"] = "목표를위한 글꼴",
    ...
    ["The font used for Objectives."] = {
        ...
        ["itIT"] = "Il carattere usato per gli obiettivi.",
        ["koKR"] = "목표에 사용되는 글꼴입니다.",
    ...
    ["Padding Between Quests"] = {
        ...
        ["itIT"] = "Spaziatura tra le missioni",
        ["koKR"] = "퀘스트간 간격 설정",
    ...
    ["The amount of padding between Quests in the Questie Tracker.\n\nNOTE: Changing this setting while in Sizer Manual Mode will reset the Sizer back to Auto Mode"] = {
        ...
        ["frFR"] = "La quantité d'espace entre les quêtes dans le suivi.\n\nREMARQUE : Modifier ce paramètre en mode manuel de calibrage réinitialisera le calibreur en mode automatique.",
        ["itIT"] = "La quantità di spazio tra le missioni nel tracciatore di Questie.\n\nNOTA: Modificare questa impostazione mentre si è in Modalità di ridimensionamento Manuale riporterà il ridimensionamento in Modalità Auto",
    ...
    ["Outline for Zones, Titles, and Objectives"] = {
        ...
        ["itIT"] = "Contorno per zone, titoli e obiettivi",
    ...
    ["The outline used for Quest Zones, Titles, and Objectives in the Questie Tracker."] = {
        ...
        ["itIT"] = "Il contorno usato per le zone, i titoli e gli obiettivi delle missioni nel tracciatore di Questie.",
    ...
    ["Choose the color for the Questie Tracker background."] = {
        ...
        ["itIT"] = "Scegli il colore dello sfondo del tracciatore di Questie.",
    ...
    ["Tracker Height Ratio"] = {
        ...
        ["itIT"] = "Rapporto di altezza del tracciatore",
        ["koKR"] = "추적기 높이 비율",
    ...
    ["The height of the Questie Tracker based on percentage of usable screen height. A setting of 100 percent would make the Tracker fill the players entire screen height.\n\nNOTE: This setting only applies while in Sizer Mode: Auto"] = {
        ...
        ["itIT"] = "L'altezza del tracciatore di Questie in base alla percentuale dell'altezza dello schermo utilizzabile. Un'impostazione al 100 percento farà riempire al tracciatore l'intera altezza dello schermo del giocatore.\n\nNOTA: Questa impostazione si applica solo in Modalità di ridimensionamento: Auto",
    ...
    ["Tracker Width Ratio"] = {
        ...
        ["itIT"] = "Rapporto di larghezza del tracciatore",
        ["koKR"] = "추적기 너비 비율",
    ...
    ["The width of the Questie Tracker based on percentage of usable screen width. A setting of 100 percent would make the Tracker fill the players entire screen width.\n\nNOTE: This setting only applies while in Sizer Mode: Auto"] = {
        ...
        ["itIT"] = "La larghezza del tracciatore di Questie in base alla percentuale della larghezza dello schermo utilizzabile. Un'impostazione al 100 percento farà riempire al tracciatore l'intera larghezza dello schermo del giocatore.\n\nNOTA: Questa impostazione si applica solo in Modalità di ridimensionamento: Auto",
    ...
    ["Quest and Achievement Options"] = {
        ...
        ["itIT"] = "Opzioni di missioni e risultati",
        ["koKR"] = "퀘스트 및 업적 옵션",
    ...
    ["Tracker Window Options"] = {
        ...
        ["itIT"] = "Opzioni della finestra del tracciatore",
        ["koKR"] = "추적기 창 옵션",
    ...
    ["Tracker Header"] = {
        ...
        ["itIT"] = "Intestazione del tracciatore",
        ["koKR"] = "추적기 헤더",
