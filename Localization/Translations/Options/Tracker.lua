...
local trackerOptionsLocales = {
    ...
    ["When this is checked, Blizzard Completion Text will be hidden for completed Quests and instead show the old Questie tags: \"Quest Complete!\" or \"Quest Failed!\""] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Cuando está marcado, el texto de completa de Blizzard se ocultará para las misiones completadas y en su lugar mostrará las etiquetas de misión antiguas: \"¡Misión completada!\" o \"¡Misión fracasada!\"",
        ["enUS"] = true,
        ["zhCN"] = "启用时，完成任务时不会显示游戏内建的完成信息，而会显示传统的信息：\"任务完成！\" 和 \"任务失败！\"",
        ["zhTW"] = "啟用時，完成任務時不會顯示遊戲內建的完成訊息，而會顯示傳統的訊息: \"任務完成！\" or \"任務失敗！\"",
        ["esES"] = "Cuando está marcado, el texto de completa de Blizzard se ocultará para las misiones completadas y en su lugar mostrará las etiquetas de misión antiguas: \"¡Misión completada!\" o \"¡Misión fracasada!\"",
