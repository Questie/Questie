...
local trackerOptionsLocales = {
    ...
    ["When this is checked, the Questie Tracker will automatically be hidden when entering combat."] = {
        ["enUS"] = true,
        ["deDE"] = false,
        ["esES"] = "Si está activado, el rastreador de Questie se ocultará automáticamente al entrar en combate.",
        ["esMX"] = "Si está activado, el rastreador de Questie se ocultará automáticamente al entrar en combate.",
        ["frFR"] = "Si cette option est activée, le suivi de Questie sera automatiquement caché en entrant en combat.",
        ["koKR"] = false,
        ["ptBR"] = "Se ativado, o rastreador de Questie será ocultado automaticamente ao entrar em combate.",
        ["ruRU"] = "Когда включено, трекер Questie будет автоматически скрываться при вступлении в бой",
        ["zhCN"] = false,
        ["zhTW"] = false,
    },
    ---------------------------------------------------------
    ...
    ["When this is checked, the Questie Tracker will automatically be hidden when entering a dungeon."] = {
        ["enUS"] = true,
        ["deDE"] = false,
        ["esES"] = "Si está activado, el rastreador de Questie se ocultará automáticamente al entrar en una mazmorra.",
        ["esMX"] = "Si está activado, el rastreador de Questie se ocultará automáticamente al entrar en un calabozo.",
        ["frFR"] = "Si cette option est activée, le suivi de Questie sera automatiquement caché en entrant dans un donjon.",
        ["koKR"] = false,
        ["ptBR"] = "Se ativado, o rastreador de Questie será ocultado automaticamente ao entrar em uma masmorra.",
        ["ruRU"] = "Когда включено, трекер Questie будет автоматически скрываться при входе в подземелье",
        ["zhCN"] = false,
        ["zhTW"] = false,
    },
    ---------------------------------------------------------
