...
local trackerOptionsLocales = {
    ...
    ["When this is checked, the Questie Tracker will automatically be minimized when entering a dungeon, raid, or battleground."] = {
        ["enUS"] = true,
        ...
        ["esES"] = "Si está activado, el rastreador se minimizará automáticamente al entrar en una mazmorra, banda o campo de batalla.",
        ["esMX"] = "Si está activado, el rastreador se minimizará automáticamente al entrar en un calabozo, banda o campo de batalla.",
        ["frFR"] = "Si cette option est activée, le suivi sera automatiquement réduit lors de l’entrée dans un donjon, un raid ou un champ de bataille.",
    ...
    ["When this is checked, the Questie Tracker will automatically be hidden when entering a dungeon, raid, or battleground."] = {
        ["enUS"] = true,
        ...
        ["esES"] = "Si está activado, el rastreador se ocultará automáticamente al entrar en una mazmorra, banda o campo de batalla.",
        ["esMX"] = "Si está activado, el rastreador se ocultará automáticamente al entrar en un calabozo, banda o campo de batalla.",
        ["frFR"] = "Si cette option est activée, le suivi sera automatiquement caché lors de l’entrée dans un donjon, un raid ou un champ de bataille.",
