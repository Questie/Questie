...
local trackerOptionsLocales = {
    ...
    ["When this is checked, completed Achievement Objectives will automatically be removed from the Questie Tracker."] = {
        ...
        ["frFR"] = "Si cette option est activée, les objectifs des hauts faits terminées seront automatiquement supprimés du suivi de quêtes.",
    ...
    ["When this is checked, the default Blizzard Timer Frame for Quests will be shown instead of being embedded inside the Questie Tracker."] = {
        ...
        ["frFR"] = "Si cette option est activée, le cadre du chronomètre pour les quêtes est affiché au lieu d’être intégré au suivi.",
    ...
    ["When this is checked, the Questie Tracker will automatically be minimized while entering combat."] = {
        ...
        ["frFR"] = "Si cette option est activée, le suivi de quête sera automatiquement réduit lors des combats.",
    ...
    ["When this is checked, the Questie Tracker will automatically be hidden when entering combat."] = {
        ...
        ["frFR"] = "Si cette option est activée, le suivi de quête sera automatiquement caché lors des combats.",
    ...
    ["When this is checked, the Minimize and Maximize Buttons will fade and become transparent when not in use."] = {
        ...
        ["frFR"] = "Si cette option est activée, les boutons min. et max. s’estompent et deviennent transparents lorsqu’ils ne sont pas utilisés.",
    ...
    ["When this is checked, the Quest Item Buttons will fade and become transparent when not in use."] = {
        ...
        ["frFR"] = "Si cette option est activée, les boutons des objets de quête s’estompent et deviennent transparents lorsqu’ils ne sont pas utilisés.",
    ...
    ["When this is checked, the Questie Tracker Background becomes visible."] = {
        ...
        ["frFR"] = "Si cette option est activée, l’arrière-plan du suivi devient visible.",
    ...
    ["When this is checked, the Questie Tracker Border becomes visible."] = {
        ...
        ["frFR"] = "Si cette option est activée, la bordure du suivi devient visible.",
    ...
    ["When this is checked, the Questie Tracker background and border (if enabled) will fade and become transparent when not in use."] = {
        ...
        ["frFR"] = "Si cette option est activée, l’arrière-plan et la bordure du suivi (si activée) s’estompent et deviennent transparents lorsqu’ils ne sont pas utilisés.",
