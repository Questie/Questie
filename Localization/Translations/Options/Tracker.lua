...
local trackerOptionsLocales = {
    ...
    ["Hide empty Tracker"] = {
        ...
        ["zhTW"] = false,
        ["esES"] = false,
        ["frFR"] = "Masquer le suivi de quête vide",
    },
    ["When this is checked, the Questie Tracker automatically hides itself if no quests are tracked in the quest log."] = {
        ...
        ["zhTW"] = false,
        ["esES"] = false,
        ["frFR"] = "Si coché, le suivi de Questie se masque automatiquement si aucune quête n’est en suivie dans le journal de quête.",
    },
