...
local socialOptionsLocales = {
    ...
    ["Remove all Questie chat messages coming from other players and disable sending your own."] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Elimina tus mensajes de Questie y los de otros jugadores.",
        ["enUS"] = true,
        ["zhCN"] = "屏蔽来自其他玩家的所有 Questie 聊天消息，并禁止发送您自己的消息。",
        ["zhTW"] = "移除所有來自其他玩家的任務位置提示聊天訊息，你自己也停止發送訊息。",
        ["esES"] = "Elimina tus mensajes de Questie y los de otros jugadores.",
        ["frFR"] = "Supprimez vos messages Questie ainsi que ceux des autres joueurs.",
    },
    ["Both"] = {
        ["ptBR"] = "Ambos",
        ["ruRU"] = "Группа и рейд",
    ...
    ["Announce quest acceptance to other players"] = {
        ["ptBR"] = "Anuncia a aceitação da missão para outros jogadores.",
    ...
    ["Announce quest abortion to other players"] = {
        ["ptBR"] = "Anuncia o abandono de missão para outros jogadores.",
        ...
        ["frFR"] = "Annonce l'annulation des quêtes aux autres joueurs.",
    },
    ["Objective completed"] = {
    ...
    ["Announce completed objectives to other players"] = {
        ["ptBR"] = "Anuncia objetivos concluídos para outros jogadores.",
        ["ruRU"] = "Оповещение о достижении целей задания",
        ["deDE"] = "Teilt die Erfüllung von Questzielen anderen Spielern mit.",
        ["koKR"] = false,
        ["esMX"] = "Anuncia objetivos completados a otros jugadores.",
        ["enUS"] = true,
        ["zhCN"] = "向其他玩家通报完成目标",
        ["zhTW"] = "任務目標完成時向其他玩家通報",
        ["esES"] = "Anunciar objetivos completados a otros jugadores.",
        ["frFR"] = "Annonce les objectifs terminés aux autres joueurs.",
    },
    ["Quest completed"] = {
    ...
    ["Announce quest completion to other players"] = {
        ["ptBR"] = "Anuncia a conclusão da missão para outros jogadores.",
        ["ruRU"] = "Оповещение о выполнении задания",
        ["deDE"] = "Teilt den Abschluß von Quests anderen Spielern mit.",
        ["koKR"] = false,
        ["esMX"] = "Anuncia la completación de la misión a otros jugadores.",
        ["enUS"] = true,
        ["zhCN"] = "向其他玩家通报任务完成",
        ["zhTW"] = "任務完成時向其他玩家通報",
        ["esES"] = "Anuncia la completación de la misión a otros jugadores.",
