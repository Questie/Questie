...
local socialOptionsLocales = {
    ...
    ["Display party members' quest objective pins on the map and minimap. Requires party members to also have Questie installed."] = {
        ["enUS"] = true,
        ["deDE"] = false,
        ["esES"] = false,
        ["esMX"] = false,
    ...
    ["Show completed party quest objectives"] = {
        ["enUS"] = true,
        ["deDE"] = false,
        ["esES"] = false,
        ["esMX"] = false,
    ...
    ["Also show objectives that party members have already completed."] = {
        ["enUS"] = true,
        ["deDE"] = false,
        ["esES"] = false,
        ["esMX"] = false,
