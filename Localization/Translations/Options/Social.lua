...
local socialOptionsLocales = {
    ...
    ["Announce that you just picked up a quest for which you have an incomplete breadcrumb quest"] = {
        ...
        ["ptBR"] = "Anuncia que você acabou de aceitar uma missão sem ter completado sua missão de encaminhamento",
    ...
    ["You have accepted %s without completing its breadcrumb quest %s"] = {
        ...
        ["esES"] = "Has aceptado %s sin haber completado su misión de rastro %s",
        ["esMX"] = "Has aceptado %s sin haber completado su misión de migajas %s",
        ["frFR"] = "Tu as accepté %s sans avoir complété sa quête préliminaire %s",
        ["koKR"] = "%s 퀘스트를 길잡이 퀘스트 %s 이(가) 완료되기 전에 수락했습니다.",
        ["ptBR"] = "Você aceitou %s antes de completar sua missão de encaminhamento %s",
