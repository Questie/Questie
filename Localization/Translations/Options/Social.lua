...
local socialOptionsLocales = {
    ...
    ["Announce that you just picked up a quest for which you have an incomplete breadcrumb quest"] = {
        ...
        ["frFR"] = "Annonce que vous venez d’accepter une quête pour laquelle vous avez une quête préliminaire incomplète.",
    ...
    ["You have accepted %s without completing its breadcrumb quest %s"] = {
        ...
        ["frFR"] = "Vous avez accepté la quête %s avant de terminer sa quête préliminaire %s",
