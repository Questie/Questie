...
local generalOptionsLocales = {
    ...
    ["Enable Minimap Button"] = {
        ...
        ["itIT"] = "Attivare il pulsante della minimappa",
        ["koKR"] = "미니맵 버튼 활성화",
    ...
    ["Enable or disable the Questie minimap button. You can still access the options menu with /questie."] = {
        ...
        ["itIT"] = "Attiva o disattiva il pulsante della minimappa di Questie. Puoi comunque accedere al menu delle opzioni con il comando /questie.",
    ...
    ["Enable Instant Quest Text"] = {
        ...
        ["itIT"] = "Attivare il testo istantaneo delle missioni",
        ["koKR"] = "퀘스트 내용 바로 표시",
    ...
    ["Toggles the default Instant Quest Text option. This is just a shortcut for the WoW option in Interface."] = {
        ...
        ["itIT"] = "Attiva o disattiva l'opzione standard del testo istantaneo delle missioni. È solo una scorciatoia per l'opzione di WoW nell'interfaccia.",
    ...
    ["Auto Accept Quests"] = {
        ...
        ["itIT"] = "Accettazione automatica delle missioni",
        ["koKR"] = "자동 퀘스트 수락",
    ...
    ["Enable or disable Questie auto-accepting quests."] = {
        ...
        ["itIT"] = "Attiva o disattiva l'accettazione automatica delle missioni da parte di Questie.",
    ...
    ["Enable or disable Questie auto-completing quests."] = {
        ...
        ["itIT"] = "Attiva o disattiva il completamento automatico delle missioni da parte di Questie.",
    ...
    ["Enable Automatic NPC Dialog"] = {
        ...
        ["itIT"] = "Attivare il dialogo automatico con gli NPC",
        ["koKR"] = "자동 NPC 대화 활성화",
    ...
    ["Enable or disable Questie automatically advancing through NPC dialog."] = {
        ...
        ["itIT"] = "Attiva o disattiva l'avanzamento automatico di Questie attraverso i dialoghi con gli NPC.",
    ...
    ["The modifier to NOT auto-accept/-complete quests when either option is enabled and you interact with a quest NPC."] = {
        ...
        ["itIT"] = "Il modificatore per NON accettare/completare automaticamente le missioni quando una delle due opzioni è attiva e interagisci con un NPC di missioni.",
    ...
    ["Accept trivial (low level) quests"] = {
        ...
        ["itIT"] = "Accetta le missioni banali (di basso livello)",
        ["koKR"] = "저레벨 퀘스트 수락",
    ...
    ["If checked, trivial (gray) quests will be auto accepted as well."] = {
        ...
        ["esES"] = "Si está seleccionado, las misiones triviales (grises) también se aceptarán automáticamente.",
        ["esMX"] = "Si está seleccionado, las misiones triviales (grises) también se aceptarán automáticamente.",
        ["frFR"] = "Si cette option est cochée, les quêtes obsolètes (grises) seront également acceptées automatiquement.",
        ["itIT"] = "Se selezionata, anche le missioni banali (grigie) verranno accettate automaticamente.",
    ...
    ["Quest Level Options"] = {
        ...
        ["itIT"] = "Opzioni del livello delle missioni",
        ["koKR"] = "퀘스트 레벨 설정",
    ...
    ["Player level offset"] = {
        ...
        ["itIT"] = "Differenza di livello del giocatore",
        ["koKR"] = "플레이어 레벨 오프셋",
    ...
    ["Show only quests granting experience (Default)"] = {
        ...
        ["itIT"] = "Mostrare solo le missioni che assegnano esperienza (Predefinito)",
    ...
    ["Show all low level quests"] = {
        ...
        ["itIT"] = "Mostrare tutte le missioni di basso livello",
        ["koKR"] = "모든 저레벨 퀘스트 표시",
    ...
    ["Show quests to a set level below the player"] = {
        ...
        ["itIT"] = "Mostrare le missioni fino a un livello impostato sotto quello del giocatore",
    ...
    ["Show quests between two set levels"] = {
        ...
        ["itIT"] = "Mostrare le missioni tra due livelli impostati",
    ...
    ["Which available quests should be displayed"] = {
        ...
        ["itIT"] = "Quali missioni disponibili devono essere mostrate",
        ["koKR"] = "표시할 수 있는 퀘스트",
    ...
    ["How many levels below your character to show. (Default: %s)"] = {
        ...
        ["itIT"] = "Quanti livelli sotto il tuo personaggio mostrare. (Predefinito: %s)",
    ...
    ["Minimum quest level to show."] = {
        ...
        ["itIT"] = "Livello minimo delle missioni da mostrare.",
        ["koKR"] = "표시하는 최소 퀘스트 레벨",
    ...
    ["Maximum quest level to show."] = {
        ...
        ["itIT"] = "Livello massimo delle missioni da mostrare.",
        ["koKR"] = "표시하는 최고 퀘스트 레벨",
    ...
    ["Isle of Quel'Danas Phase"] = {
        ...
        ["itIT"] = "Fase dell'Isola di Quel'Danas",
        ["koKR"] = "쿠엘다나스 섬 단계",
    ...
    ["Select the phase fitting your realm progress on the Isle of Quel'Danas"] = {
        ...
        ["itIT"] = "Seleziona la fase che corrisponde al progresso del tuo reame sull'Isola di Quel'Danas",
    ...
    ["Disable Phase reminder"] = {
        ...
        ["itIT"] = "Disattivare il promemoria della fase",
        ["koKR"] = "단계 알림 비활성화",
    ...
    ["Enable or disable the reminder on login to set the Isle of Quel'Danas phase"] = {
        ...
        ["itIT"] = "Attiva o disattiva il promemoria al login per impostare la fase dell'Isola di Quel'Danas",
    ...
    ["Current active phase of Isle of Quel'Danas is '%s'. Check the General settings to change the phase or disable this message."] = {
        ...
        ["itIT"] = "La fase attualmente attiva dell'Isola di Quel'Danas è '%s'. Controlla le impostazioni generali per cambiarla o per disattivare questo messaggio.",
    ...
    ["You picked up a quest from '%s'. Automatically switching to this phase..."] = {
        ...
        ["itIT"] = "Hai accettato una missione da '%s'. Passaggio automatico a questa fase...",
    ...
    ["Phase 1 - Sun's Reach Sanctum"] = {
        ...
        ["itIT"] = "Fase 1 - Santuario dei Confini del Sole",
        ["koKR"] = "1단계 - 태양의 요새 성소",
    ...
    ["Phase 2 - Activating the Sunwell Portal"] = {
        ...
        ["itIT"] = "Fase 2 - Attivazione del portale della Sorgente Solare",
    ...
    ["Phase 2.1 - Sun's Reach Armory"] = {
        ...
        ["itIT"] = "Fase 2.1 - Armeria dei Confini del Sole",
    ...
    ["Phase 3 - Rebuilding the Anvil and Forge"] = {
        ...
        ["itIT"] = "Fase 3 - Ricostruzione dell'incudine e della forgia",
        ["koKR"] = "3단계 - 모루와 제련소 재건",
    ...
    ["Phase 3.1 - Sun's Reach Harbor"] = {
        ...
        ["itIT"] = "Fase 3.1 - Porto dei Confini del Sole",
    ...
    ["Phase 4 - Creating the Alchemy Lab"] = {
        ...
        ["itIT"] = "Fase 4 - Creazione del laboratorio di alchimia",
        ["koKR"] = "4단계 - 연금술 연구소 건설",
    ...
    ["Phase 4.1 - Building the Monument to the Fallen"] = {
        ...
        ["itIT"] = "Fase 4.1 - Costruzione del monumento ai caduti",
    ...
    ["Phase 4.2 - Sun's Reach"] = {
        ...
        ["itIT"] = "Fase 4.2 - Confini del Sole",
        ["koKR"] = "4.2단계 - 태양의 요새",
    ...
    ["By default, Questie only shows quests that are relevant for your level. You can change this behavior below."] = {
        ...
        ["itIT"] = "Per impostazione predefinita, Questie mostra solo le missioni pertinenti al tuo livello. Puoi modificare questo comportamento qui sotto.",
    ...
    ["Show quest level in tooltips"] = {
        ...
        ["itIT"] = "Mostrare il livello delle missioni nei tooltip",
        ["koKR"] = "툴팁에 퀘스트 레벨 표시",
    ...
    ["If checked, the level of quests will show in the tooltips."] = {
        ...
        ["esES"] = "Si está seleccionado, el nivel de las misiones se mostrará en los tooltips.",
        ["esMX"] = "Si está seleccionado, el nivel de las misiones se mostrará en los tooltips.",
        ["frFR"] = "Si cette option est cochée, le niveau des quêtes sera affiché dans les infobulles.",
        ["itIT"] = "Se selezionata, il livello delle missioni verrà mostrato nei tooltip.",
    ...
    ["Enable World Tooltips"] = {
        ...
        ["itIT"] = "Attivare i tooltip del mondo",
        ["koKR"] = "세계 툴팁 활성화",
    ...
    ["If checked, quest info will be added to relevant mob/item tooltips."] = {
        ...
        ["esES"] = "Si está seleccionado, la información de la mision se mostrará en el tooltip de los monstruos/objetos relevantes.",
        ["esMX"] = "Si está seleccionado, la información de la mision se mostrará en el tooltip de los monstruos/objetos relevantes.",
        ["frFR"] = "Si cette option est cochée, les informations de quête seront ajoutées aux infobulles des monstres et objets concernés.",
        ["itIT"] = "Se selezionata, le informazioni sulle missioni verranno aggiunte ai tooltip di mob/oggetti pertinenti.",
    ...
    ["Bell Toll Alliance"] = {
        ...
        ["itIT"] = "Rintocco di campana Alleanza",
        ["koKR"] = "얼라이언스 종 울림",
    ...
    ["Trim Objective Text"] = {
        ...
        ["itIT"] = "Ridurre il testo degli obiettivi",
        ["koKR"] = "목표 텍스트 자르기",
    ...
    ["Simplify quest objective text by removing \"slain\" from it."] = {
        ...
        ["itIT"] = "Semplifica il testo degli obiettivi delle missioni rimuovendo \"ucciso\" da esso.",
