...
local generalOptionsLocales = {
    ...
    ["Show Minimap Button"] = {
        ["enUS"] = true,
        ["deDE"] = "Minimap-Button anzeigen",
        ["esES"] = "Mostrar botón del minimapa",
        ["esMX"] = "Mostrar botón del minimapa",
        ["frFR"] = "Afficher le bouton de la minicarte",
        ["koKR"] = "미니맵 버튼 표시",
        ["ptBR"] = "Mostrar botão do minimapa",
        ["ruRU"] = "Показывать кнопку у миникарты",
        ["zhCN"] = "显示小地图按钮",
        ["zhTW"] = "顯示小地圖按鈕",
    },
    ["Enable or disable the Questie minimap button. You can still access the options menu with /questie."] = {
        ...
        ["ptBR"] = "Ativa ou desativa o botão do minimapa. Você ainda pode acessar o menu de opções com o comando /questie.",
        ...
        ["zhTW"] = "啟用或停用Questie小地圖按鈕，停用後仍可輸入 /questie 開啟設定選項",
    },
    ["Show Questie in addon compartment"] = {
        ["enUS"] = true,
        ["deDE"] = "Questie im Addonfach anzeigen",
        ["esES"] = "Mostrar Questie en el compartimento",
        ["esMX"] = "Mostrar Questie en el compartimento",
        ["frFR"] = "Afficher Questie dans le compartiment",
        ["koKR"] = "애드온 모음에 Questie 표시",
        ["ptBR"] = "Mostrar Questie no compartimento",
        ["ruRU"] = "Показывать Questie во вкладке с аддонами",
        ["zhCN"] = "在整合栏中显示Questie",
        ["zhTW"] = "在整合欄中顯示Questie",
    },
    ["Enable or disable the Questie button in the addon compartment. You can still access the options menu with /questie."] = {
        ["enUS"] = true,
        ["deDE"] = "Questie Button im Addonfach aktivieren/deaktivieren. Mit /questie kannst du trotzdem die Einstellungen aufrufen.",
        ["esES"] = "Activa o desactiva el botón de Questie en el compartimento de addons. Puedes seguir accediendo al menú de opciones con el comando /questie.",
        ["esMX"] = "Activa o desactiva el botón de Questie en el compartimento de addons. Puedes seguir accediendo al menú de opciones con el comando /questie.",
        ["frFR"] = "Active le bouton Questie dans le compartiment d'add-ons. Le panneau de configuration reste accessible avec la commande /questie.",
        ["koKR"] = "애드온 모음에 Questie 버튼을 표시하거나 숨깁니다. /questie 명령어로도 설정 메뉴를 열 수 있습니다.",
        ["ptBR"] = "Ativa ou desativa o botão do Questie no compartimento dos addons. Você ainda pode acessar o menu de opções com o comando /questie.",
        ["ruRU"] = "Показать/скрыть кнопку Questie во вкладке с аддонами у миникарты. Доступ к настройкам аддона также можно получить через команду /questie",
        ["zhCN"] = "启用或禁用插件整合栏中的Questie按钮，你仍然可以使用“/questie”命令访问选项菜单",
        ["zhTW"] = "啟用或停用Questie整合欄按鈕，停用後仍可輸入 /questie 開啟設定選項",
    },
