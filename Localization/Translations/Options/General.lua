...
local generalOptionsLocales = {
    ...
    ["Show compartment button"] = {
        ["enUS"] = true,
        ["deDE"] = "Kompartiment-Schaltfläche anzeigen",
        ["esES"] = "Mostrar botón de compartimento",
        ["esMX"] = "Mostrar botón de compartimento",
        ["frFR"] = "Afficher le bouton de compartiment",
        ["koKR"] = "애드온 모음 버튼에 표시",
        ["ptBR"] = "Mostrar botão do compartimento",
        ["ruRU"] = "Отображать значок Questie в 'Отделении для аддонов'",
        ["zhCN"] = "显示小地图整合按钮",
        ["zhTW"] = "顯示整合按鈕",
    },
    ["Enable or disable the Questie button in the addon compartment. You can still access the options menu with /questie."] = {
        ["enUS"] = true,
        ["deDE"] = "Questie-Schaltfläche im Kompartiment aktivieren/deaktivieren. Mit /questie kannst du trotzdem die Einstellungen aufrufen.",
        ["esES"] = "Activa o desactiva el botón de compartimento. Puedes seguir accediendo al menú de opciones con el comando /questie.",
        ["esMX"] = "Activa o desactiva el botón de compartimento. Puedes seguir accediendo al menú de opciones con el comando /questie.",
        ["frFR"] = "Active le bouton dans le compartiment. Le panneau de configuration reste accessible avec la commande /questie.",
        ["koKR"] = "애드온 모음에 Questie 버튼을 표시하거나 숨깁니다. /questie 명령어로도 설정 메뉴를 열 수 있습니다.",
        ["ptBR"] = "Ativa ou desativa o botão do compartimento. Você ainda pode acessar o menu de opções com o comando /questie.",
        ["ruRU"] = "Показать/скрыть кнопку Questie в 'Отделении для аддонов'. Доступ к настройкам аддона также можно получить через команду '/questie'",
        ["zhCN"] = "启用或禁用插件整合栏中的Questie按钮，你仍然可以使用“/questie”命令访问选项菜单",
        ["zhTW"] = "啟用或停用插件整合欄中的Questie按鈕，停用後仍可輸入 /questie 開啟設定選項",
    },
