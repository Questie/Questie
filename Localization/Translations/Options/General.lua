...
local generalOptionsLocales = {
    ...
    ["Show compartment button"] = {
        ...
        ["esES"] = "Mostrar botón del compartimento",
        ["esMX"] = "Mostrar botón del compartimento",
        ["frFR"] = "Afficher le bouton du compartiment",
        ["koKR"] = "애드온 모음 버튼 표시",
        ["ptBR"] = "Mostrar botão do compartimento",
        ["ruRU"] = "Показывать кнопку в отделении для аддонов",
        ["zhCN"] = "显示整合栏按钮",
        ["zhTW"] = "顯示整合欄按鈕",
    },
    ["Enable or disable the Questie button in the addon compartment. You can still access the options menu with /questie."] = {
        ["enUS"] = true,
        ["deDE"] = "Questie Kompartiment-Button aktivieren/deaktivieren. Mit /questie kannst du trotzdem die Einstellungen aufrufen.",
        ["esES"] = "Activa o desactiva el botón del compartimento. Puedes seguir accediendo al menú de opciones con el comando /questie.",
        ["esMX"] = "Activa o desactiva el botón del compartimento. Puedes seguir accediendo al menú de opciones con el comando /questie.",
        ["frFR"] = "Active le bouton du compartiment. Le panneau de configuration reste accessible avec la commande /questie.",
        ["koKR"] = "Questie 애드온 모음 버튼을 사용합니다. /questie 명령어로도 설정 메뉴를 열 수 있습니다.",
        ...
        ["zhCN"] = "启用或禁用Questie整合栏按钮，你仍然可以使用“/questie”命令访问选项菜单",
        ["zhTW"] = "啟用或停用任務位置提示的整合欄按鈕，停用後仍可輸入 /questie 開啟設定選項",
    },
