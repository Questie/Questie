...
local advancedOptionsLocales = {
    ...
    ["When this is checked, the ID of quests will show in tooltips and the tracker."] = {
        ...
        ["zhTW"] = "啟用時，會在滑鼠提示和任務追蹤清單內顯示任務 ID。",
    ...
    ["When this is checked, the ID of items will shown in tooltips."] = {
        ...
        ["deDE"] = "Wenn diese Option aktiviert ist, werden die Gegenstands IDs in den Tooltips angezeigt."
        ["koKR"] = false,
    ...
    ["When this is checked, the ID of objects will be shown in tooltips. These are guesses and only show the first matching ID in the QuestieDB."] = {
        ...
        ["deDE"] = "Wenn diese Option aktiviert ist, werden die Objekt IDs in den Tooltips angezeigt. Diese sind Schätzungen und zeigen nur die erste passende ID in der QuestieDB.",
        ["koKR"] = false,
    ...
    ["When this is checked, the ID of NPCs will be shown in tooltips."] = {
        ...
        ["deDE"] = "When this is checked, the ID of NPCs will be shown in tooltips.",
        ["koKR"] = false,
