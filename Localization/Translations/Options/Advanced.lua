...
local advancedOptionsLocales = {
    ...
    ["When enabled, Questie will hotfix vanilla UI bugs."] = {
        ["ptBR"] = "Se ativado, o Questie corrigirá bugs da interface do usuário.",
    ...
    ["When this is checked, the ID of quests will show in tooltips and the tracker."] = {
        ["ptBR"] = "Se ativado, o ID das missões será exibido nas dicas de ferramentas e no rastreador.",
        ...
        ["esMX"] = "Si está activado, la ID de misiones mostrará en los tooltips y el rastreador.",
        ["enUS"] = true,
        ["zhCN"] = "勾选此选项后，任务ID将显示在鼠标提示和跟踪器中",
        ["zhTW"] = "啟用時，會在浮動提示資訊和任務追蹤清單內顯示任務 ID。",
        ["esES"] = "Si está activado, la ID de misiones mostrará en los tooltips y el rastreador.",
    ...
    ["Enable or disable debug functionality."] = {
        ["ptBR"] = "Ativa ou desativa o modo de depuração.",
    ...
    ["When this is checked, the ID of items will shown in tooltips."] = {
        ["ptBR"] = "Se ativado, o ID dos itens será mostrado nas dicas de ferramentas.",
        ...
        ["esMX"] = "Si está activado, la identificación de los artículos se mostrará en los tooltips.",
        ["enUS"] = true,
        ["zhCN"] = "启用后，物品ID会在悬浮窗中显示",
        ["zhTW"] = "啟用時，會在浮動提示資訊中顯示物品 ID。",
        ["esES"] = "Si está activado, la identificación de los artículos se mostrará en los tooltips.",
    ...
    ["When this is checked, the ID of objects will be shown in tooltips. These are guesses and only show the first matching ID in the QuestieDB."] = {
        ["ptBR"] = "Se ativado, o ID dos objetos será mostrado nas dicas de ferramentas. Esses são palpites e mostram apenas o primeiro ID correspondente no QuestieDB.",
        ...
        ["esMX"] = "Si está activado, la identificación de los objetos se mostrará en los tooltips. Estas son conjeturas y solo muestran la primera identificación coincidente en QuestieDB.",
        ["enUS"] = true,
        ["zhCN"] = "启用后，物件ID会在悬浮窗中显示。有些值为猜测值，因此只显示与插件数据库中第一个符合的ID",
        ["zhTW"] = "啟用時，會在浮動提示資訊中顯示物品 ID。僅顯示 QuestieDB 中第一個符合的 ID，為猜測的值。",
        ["esES"] = "Si está activado, la identificación de los objetos se mostrará en los tooltips. Estas son conjeturas y solo muestran la primera identificación coincidente en QuestieDB.",
        ["frFR"] = "Si cette option est activée, l'ID des objets sera affiché dans les infobulles. Ce ne sont que des suppositions et ne montrent que le premier ID correspondant dans la base de données de Questie.",
    },
    ["Show NPC IDs"] = {
    ...
    ["When this is checked, the ID of NPCs will be shown in tooltips."] = {
        ["ptBR"] = "Se ativado, o ID dos NPCs será mostrado nas dicas de ferramentas.",
        ...
        ["esMX"] = "Si está activado, la identificación de los PNJs se mostrará en los tooltips.",
        ["enUS"] = true,
        ["zhCN"] = "启用后，NPC ID会在悬浮窗中显示",
        ["zhTW"] = "啟用時，會在浮動提示資訊中顯示 NPC ID。",
        ["esES"] = "Si está activado, la identificación de los PNJs se mostrará en los tooltips.",
        ["frFR"] = "Si cette option est activée, l'ID des PNJ sera affiché dans les infobulles.",
    },
    ...
    ["Enables the bug hint windows for all game versions, usually used for bug reports in SoD."] = {
        ...
        ["esMX"] = "Activa las ventanas de sugerencias de errores para todas las versiones del juego, generalmente utilizadas para informes de errores en SoD.",
        ["enUS"] = true,
        ["zhCN"] = false,
        ["zhTW"] = "為所有遊戲版本啟用，通常用於探索賽季中回報錯誤的錯誤提示視窗。",
        ["esES"] = "Activa las ventanas de sugerencias de errores para todas las versiones del juego, generalmente utilizadas para informes de errores en SoD.",
