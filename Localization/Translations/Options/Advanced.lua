...
local advancedOptionsLocales = {
    ...
    ["Skip database validation upon recompile. Validation is only present with debug enabled in the first place."] = {
        ...
        ["esES"] = "Si está seleccionado, se omitirá la validación de la base de datos al volver a compilar. La validación solo está presente con la depuración activada.",
        ["esMX"] = "Si está seleccionado, se omitirá la validación de la base de datos al volver a compilar. La validación solo está presente con la depuración activada.",
        ["frFR"] = "Si cette option est cochée, la validation de la base de données sera ignorée lors de la recompilation. La validation est uniquement présente lorsque le débogage est activé.",
   ...
   ["Object ID"] = {
    ...
    ["Party icon limit"] = {
        ["enUS"] = true,
        ["deDE"] = "Gruppen-Icon-Limit",
        ["esES"] = "Límite de iconos del grupo",
        ["esMX"] = "Límite de iconos del grupo",
        ["frFR"] = "Limite d'icônes du groupe",
        ["koKR"] = "파티 아이콘 개수 제한",
        ["ptBR"] = "Limite de ícones do grupo",
        ["ruRU"] = "Лимит количества значков группы",
        ["zhCN"] = "队伍图标限制",
        ["zhTW"] = "隊伍圖示數量限制",
    },
    ["Limits the total number of party members' quest icons drawn on the map. (Default: %s)"] = {
        ["enUS"] = true,
        ["deDE"] = "Limitiert die Anzahl an Icons für die Quests von Gruppenmitgliedern auf der Karte. (Standard: %s)",
        ["esES"] = "Limita el número total de iconos de misión de los miembros del grupo que se muestran en el mapa. (Predeterminado: %s)",
        ["esMX"] = "Limita el número total de iconos de misión de los miembros del grupo que se muestran en el mapa. (Predeterminado: %s)",
        ["frFR"] = "Limite le nombre total d'icônes de quête des membres du groupe affichées sur la carte. (Par défaut : %s)",
        ["koKR"] = "지도에 표시되는 파티원의 퀘스트 아이콘 총 개수를 제한합니다. (기본값: %s)",
        ["ptBR"] = "Limita o número total de ícones de missão dos membros do grupo exibidos no mapa. (Padrão: %s)",
        ["ruRU"] = "Ограничивает общее количество значков заданий участников группы, отображаемых на карте. (По умолчанию: %s)",
        ["zhCN"] = "限制地图上显示的队伍成员任务图标总数。（默认：%s）",
        ["zhTW"] = "限制地圖上顯示的隊伍成員任務圖示總數。（預設值：%s）",
    },
    ["Party objective icon filter distance"] = {
        ["enUS"] = true,
        ["deDE"] = "Filterdistanz für Questziele von Gruppenmitgliedern",
        ["esES"] = "Distancia de filtrado de iconos de objetivo del grupo",
        ["esMX"] = "Distancia de filtrado de iconos de objetivo del grupo",
        ["frFR"] = "Distance de filtrage des icônes d'objectif du groupe",
        ["koKR"] = "파티원 목표 아이콘 필터 거리",
        ["ptBR"] = "Distância de filtragem dos ícones de objetivo do grupo",
        ["ruRU"] = "Расстояние фильтрации значков целей участников группы",
        ["zhCN"] = "队伍成员目标图标过滤距离",
        ["zhTW"] = "隊伍成員目標圖示過濾距離",
    },
    ["Minimum distance between two party members' objective icons in the same zone.\n\nSet to 0 to show all icons. Higher values reduce icon clutter."] = {
        ["enUS"] = true,
        ["deDE"] = "Minimale Distanz zwischen zwei Questziel-Icons von Gruppenmitgliedern in derselben Zone.\n\nAuf 0 setzen, um alle Icons anzuzeigen. Höhere Werte reduzieren die Anzahl der Icons.",
        ["esES"] = "Distancia mínima entre los iconos de objetivo de dos miembros del grupo en la misma zona.\n\nEstablece en 0 para mostrar todos los iconos. Valores más altos reducen la saturación de iconos.",
        ["esMX"] = "Distancia mínima entre los iconos de objetivo de dos miembros del grupo en la misma zona.\n\nEstablece en 0 para mostrar todos los iconos. Valores más altos reducen la saturación de iconos.",
        ["frFR"] = "Distance minimale entre les icônes d'objectif de deux membres du groupe dans une même zone.\n\nDéfinir sur 0 pour tout afficher. Une valeur plus élevée réduit le nombre d'icônes.",
        ["koKR"] = "같은 지역 내 두 파티원의 목표 아이콘 사이의 최소 거리입니다.\n\n0으로 설정하면 모든 아이콘을 표시합니다. 값이 높을수록 아이콘이 줄어듭니다.",
        ["ptBR"] = "Distância mínima entre os ícones de objetivo de dois membros do grupo na mesma zona.\n\nDefine como 0 para exibir todos os ícones. Valores mais altos reduzem a poluição visual de ícones.",
        ["ruRU"] = "Минимальное расстояние между значками целей заданий двух участников группы в одной игровой зоне.\n\nУстановите 0 для отображения всех значков. Более высокие значения уменьшают кол-во значков",
        ["zhCN"] = "同一区域内两名队伍成员的目标图标之间的最小距离。\n\n设置为0将显示所有图标。数值越高，图标杂乱程度越低。",
        ["zhTW"] = "同一區域內兩名隊伍成員的目標圖示之間的最小距離。\n\n設為0將顯示所有圖示。數值越高，圖示雜亂程度越低。",
    },
}
