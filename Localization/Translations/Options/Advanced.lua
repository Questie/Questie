...
local advancedOptionsLocales = {
    ...
    ["Enable or disable debug functionality."] = {
        ...
        ["koKR"] = "디버그 기능을 사용합니다.",
        ["esMX"] = "Si está activado, se activará el modo de depuración.",
        ["enUS"] = true,
        ["zhCN"] = "启用或停用Debug功能",
        ["zhTW"] = "啟用或停用除錯的功能。",
        ["esES"] = "Si está activado, se activará el modo de depuración.",
    ...
    ["When this is checked, the ID of NPCs will be shown in tooltips."] = {
        ["ptBR"] = "Se ativado, a ID dos NPCs será mostrado nas dicas de ferramentas.",
