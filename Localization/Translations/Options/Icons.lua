...
local iconOptionsLocales = {
    ...
    ["Shows or hides the icons that Questie draws on the world map and minimap."] = {
        ...
        ["itIT"] = "Mostra o nasconde le icone che Questie disegna sulla mappa del mondo e sulla minimappa.",
    ...
    ["Config Tracking Icons"] = {
        ...
        ["itIT"] = "Configura le icone di tracciamento",
        ["koKR"] = "추적 아이콘 설정",
    ...
    ["Allows to select which tracking icons (like Mailbox, Repair-NPCs) to show on the map and minimap."] = {
        ...
        ["itIT"] = "Permette di selezionare quali icone di tracciamento (come la cassetta della posta e gli NPC di riparazione) mostrare sulla mappa e sulla minimappa.",
    ...
    ["Allows to select which profession trainers to show on the map and minimap."] = {
        ...
        ["itIT"] = "Permette di selezionare quali istruttori di professioni mostrare sulla mappa e sulla minimappa.",
    ...
    ["Allows to select which vendors to show on the map and minimap."] = {
        ...
        ["itIT"] = "Permette di selezionare quali venditori mostrare sulla mappa e sulla minimappa.",
    ...
    ["If checked, the quest turn-in locations will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le posizioni in cui consegnare le missioni verranno mostrate sulla mappa/minimappa.",
    ...
    ["Enable Map Icons"] = {
        ...
        ["itIT"] = "Attivare le icone sulla mappa",
        ["koKR"] = "지도 아이콘 활성화",
    ...
    ["Show/hide all icons from the main map."] = {
        ...
        ["itIT"] = "Mostra/nascondi tutte le icone sulla mappa principale.",
    ...
    ["Enable Minimap Icons"] = {
        ...
        ["itIT"] = "Attivare le icone sulla minimappa",
        ["koKR"] = "미니맵 아이콘 활성화",
    ...
    ["Show/hide all icons from the minimap."] = {
        ...
        ["itIT"] = "Mostra/nascondi tutte le icone sulla minimappa.",
    ...
    ["Hide Icons in Unexplored Areas"] = {
        ...
        ["itIT"] = "Nascondere le icone nelle aree inesplorate",
        ["koKR"] = "미탐험 지역 아이콘 가리기",
    ...
    ["Hide icons in unexplored map regions."] = {
        ...
        ["itIT"] = "Nasconde le icone nelle aree inesplorate della mappa.",
    ...
    ["Hide icons of untracked quests"] = {
        ...
        ["itIT"] = "Nascondere le icone delle missioni non tracciate",
    ...
    ["Hide icons for quests that are not tracked."] = {
        ...
        ["itIT"] = "Nasconde le icone delle missioni che non vengono tracciate.",
    ...
    ["Show custom quest frame icons"] = {
        ...
        ["itIT"] = "Mostrare le icone personalizzate delle missioni",
    ...
    ["Use custom Questie icons for NPC dialogs, reflecting the status and type of each quest."] = {
        ...
        ["itIT"] = "Usa le icone personalizzate di Questie per i dialoghi degli NPC, che riflettono lo stato e il tipo di ogni missione.",
    ...
    ["Enable Available Quest Icons"] = {
        ...
        ["itIT"] = "Attivare le icone delle missioni disponibili",
    ...
    ["If checked, the locations of available quests will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le posizioni delle missioni disponibili verranno mostrate sulla mappa/minimappa.",
    ...
    ["Enable Event Quest Icons"] = {
        ...
        ["itIT"] = "Attivare le icone delle missioni evento",
    ...
    ["If checked, the locations of active event quests will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le posizioni delle missioni evento attive verranno mostrate sulla mappa/minimappa.",
    ...
    ["Enable Objective Icons"] = {
        ...
        ["itIT"] = "Attivare le icone degli obiettivi",
        ["koKR"] = "퀘스트 목표 아이콘 활성화",
    ...
    ["If checked, quest objective icons will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le icone degli obiettivi delle missioni verranno mostrate sulla mappa/minimappa.",
    ...
    ["Enable Repeatable Quest Icons"] = {
        ...
        ["itIT"] = "Attivare le icone delle missioni ripetibili",
        ["koKR"] = "지도에 반복 퀘스트를 표시",
    ...
    ["If checked, the locations of repeatable quests will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le posizioni delle missioni ripetibili verranno mostrate sulla mappa/minimappa.",
    ...
    ["Enable Raid Quest Icons"] = {
        ...
        ["itIT"] = "Attivare le icone delle missioni di incursione",
    ...
    ["If checked, the locations of raid quests will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le posizioni delle missioni di incursione verranno mostrate sulla mappa/minimappa.",
    ...
    ["Enable Dungeon Quest Icons"] = {
        ...
        ["itIT"] = "Attivare le icone delle missioni di spedizione",
        ["koKR"] = "던전 퀘스트 활성화",
    ...
    ["If checked, the locations of dungeon quests will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le posizioni delle missioni di spedizione verranno mostrate sulla mappa/minimappa.",
    ...
    ["Enable Completed Quest Icons"] = {
        ...
        ["itIT"] = "Attivare le icone delle missioni completate",
        ["koKR"] = "퀘스트 완료 아이콘 활성화",
    ...
    ["Enable PvP Quest Icons"] = {
        ...
        ["itIT"] = "Attivare le icone delle missioni PvP",
    ...
    ["If checked, the locations of PvP quests will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le posizioni delle missioni PvP verranno mostrate sulla mappa/minimappa.",
    ...
    ["Available AQ War Effort Quests"] = {
        ...
        ["itIT"] = "Missioni disponibili dello sforzo bellico di Ahn'Qiraj",
    ...
    ["If checked, the locations of the AQ War Effort quests will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le posizioni delle missioni dello sforzo bellico di Ahn'Qiraj verranno mostrate sulla mappa/minimappa.",
    ...
    ["The AQ War Effort quests are shown for you. If your server is done you can hide those quests in the Icons settings of Questie!"] = {
        ...
        ["itIT"] = "Le missioni dello sforzo bellico di Ahn'Qiraj vengono mostrate per te. Se il tuo server le ha completate, puoi nasconderle nelle impostazioni delle icone di Questie!",
    ...
    ["Toggle pfQuest/ClassicCodex icon style"] = {
        ...
        ["itIT"] = "Alternare lo stile delle icone pfQuest/ClassicCodex",
    ...
    ["Toggles between Questie icon style and pfQuest/ClassicCodex icon style.\n\nToggling affects the following settings:\n\n- Objective icons\n- "] = {
        ...
        ["itIT"] = "Alterna tra lo stile delle icone di Questie e lo stile delle icone di pfQuest/ClassicCodex.\n\nL'alternanza influisce sulle seguenti impostazioni:\n\n- Icone degli obiettivi\n- ",
    ...
    ["Icon Overrides (show/hide)"] = {
        ...
        ["itIT"] = "Sostituzioni delle icone (mostra/nascondi)",
    ...
    ["The icon that is displayed for quest objectives where you need to kill an NPC"] = {
        ...
        ["itIT"] = "L'icona mostrata per gli obiettivi delle missioni in cui devi uccidere un NPC.",
    ...
    ["The icon that is displayed for quest objectives where you need to loot an item"] = {
        ...
        ["itIT"] = "L'icona mostrata per gli obiettivi delle missioni in cui devi saccheggiare un oggetto.",
    ...
    ["The icon that is displayed for quest objectives where you need to interact with an object"] = {
        ...
        ["itIT"] = "L'icona mostrata per gli obiettivi delle missioni in cui devi interagire con un oggetto.",
    ...
    ["The icon that is displayed for quest objectives where you need to do something in a certain area, like exploring it or casting a spell there"] = {
        ...
        ["itIT"] = "L'icona mostrata per gli obiettivi delle missioni in cui devi fare qualcosa in una determinata area, come esplorarla o lanciare un incantesimo lì.",
    ...
    ["Talk objectives"] = {
        ...
        ["itIT"] = "Obiettivi di conversazione",
        ["koKR"] = "NPC 대화 목표",
    ...
    ["The icon that is displayed for quest objectives where you need to talk to an NPC"] = {
        ...
        ["itIT"] = "L'icona mostrata per gli obiettivi delle missioni in cui devi parlare con un NPC.",
    ...
    ["The icon that is displayed for available quests"] = {
        ...
        ["itIT"] = "L'icona mostrata per le missioni disponibili.",
    ...
    ["Unavailable and trivial quests"] = {
        ...
        ["itIT"] = "Missioni non disponibili e banali",
    ...
    ["The icon that is displayed for quests that require additional conditions to be met before they can be accepted, or are so low level they don't reward experience"] = {
        ...
        ["itIT"] = "L'icona mostrata per le missioni che richiedono il soddisfacimento di condizioni aggiuntive prima di poter essere accettate, o che sono di livello così basso da non assegnare esperienza.",
    ...
    ["The icon that is displayed for completed quests that can be handed in"] = {
        ...
        ["itIT"] = "L'icona mostrata per le missioni completate che possono essere consegnate.",
    ...
    ["Available repeatable quests"] = {
        ...
        ["itIT"] = "Missioni ripetibili disponibili",
    ...
    ["The icon that is displayed for available repeatable quests like dailies"] = {
        ...
        ["itIT"] = "L'icona mostrata per le missioni ripetibili disponibili, come quelle giornaliere.",
    ...
    ["Complete repeatable quests"] = {
        ...
        ["itIT"] = "Missioni ripetibili completate",
        ["koKR"] = "완료된 반복 가능한 퀘스트",
    ...
    ["The icon that is displayed for repeatable quests that can be handed in"] = {
        ...
        ["itIT"] = "L'icona mostrata per le missioni ripetibili che possono essere consegnate.",
    ...
    ["Available event quests"] = {
        ...
        ["itIT"] = "Missioni evento disponibili",
        ["koKR"] = "실행 가능한 이벤트 퀘스트",
    ...
    ["The icon that is displayed for available event quests during holidays"] = {
        ...
        ["itIT"] = "L'icona mostrata per le missioni evento disponibili durante le festività.",
    ...
    ["Complete event quests"] = {
        ...
        ["itIT"] = "Missioni evento completate",
        ["koKR"] = "완료된 이벤트 퀘스트",
    ...
    ["The icon that is displayed for event quests that can be handed in"] = {
        ...
        ["itIT"] = "L'icona mostrata per le missioni evento che possono essere consegnate.",
    ...
    ["The icon that is displayed for available PvP quests"] = {
        ...
        ["itIT"] = "L'icona mostrata per le missioni PvP disponibili.",
    ...
    ["The icon that is displayed for PvP quests that can be handed in"] = {
        ...
        ["itIT"] = "L'icona mostrata per le missioni PvP che possono essere consegnate.",
    ...
    ["Available Normal Quests"] = {
        ...
        ["itIT"] = "Missioni normali disponibili",
        ["koKR"] = "실행 가능한 일반 퀘스트",
    ...
    ["Available Quests from Items"] = {
        ...
        ["itIT"] = "Missioni disponibili dagli oggetti",
    ...
    ["If checked, the locations of item drops that start quests will be shown on the map/minimap."] = {
        ...
        ["itIT"] = "Se selezionata, le posizioni dei drop di oggetti che danno inizio alle missioni verranno mostrate sulla mappa/minimappa.",
    ...
    ["Available Dungeon Quests"] = {
        ...
        ["itIT"] = "Missioni di spedizione disponibili",
        ["koKR"] = "실행 가능한 던전 퀘스트",
    ...
    ["Available Raid Quests"] = {
        ...
        ["itIT"] = "Missioni di incursione disponibili",
        ["koKR"] = "실행 가능한 레이드 퀘스트",
    ...
    ["Hide Icons on Continent Map"] = {
        ...
        ["itIT"] = "Nascondere le icone sulla mappa del continente",
    ...
    ["Hide icons on the continent map, when not viewing a specific zone."] = {
        ...
        ["itIT"] = "Nasconde le icone sulla mappa del continente quando non stai visualizzando una zona specifica.",
    ...
    ["Objective Icon Theme"] = {
        ...
        ["itIT"] = "Tema delle icone degli obiettivi",
        ["koKR"] = "목표 아이콘 테마",
    ...
    ["Change between themes for objective icons."] = {
        ...
        ["itIT"] = "Passa da un tema all'altro per le icone degli obiettivi.",
        ["koKR"] = "목표 아이콘의 테마 변경",
    ...
    ["Season of Discovery Runes"] = {
        ...
        ["itIT"] = "Rune della Stagione delle Scoperte",
        ["koKR"] = "발견의 시즌 룬",
    ...
    ["If checked, the locations of Season of Discovery Runes and Rune quests will be shown on the map/minimap."] = {
        ...
        ["esES"] = "Si está seleccionado, la ubicación de las runas de la Temporada de descubrimiento y las misiones de runas se mostrará en el mapa y minimapa.",
        ["esMX"] = "Si está seleccionado, la ubicación de las runas de la Temporada de descubrimiento y las misiones de runas se mostrará en el mapa y minimapa.",
        ["frFR"] = "Si cette option est cochée, les emplacements des Runes et des quêtes de Runes de la Saison de la Découverte seront affichés sur la carte et la minicarte.",
        ["itIT"] = "Se selezionata, le posizioni delle Rune della Stagione delle Scoperte e delle missioni delle rune verranno mostrate sulla mappa/minimappa.",
    ...
    ["The icon that is displayed for quest objectives where you need to use an item or interact with an NPC"] = {
        ...
        ["itIT"] = "L'icona mostrata per gli obiettivi delle missioni in cui devi usare un oggetto o interagire con un NPC.",
    ...
    ["pfQuest/Codex node"] = {
        ["enUS"] = true,
        ["deDE"] = "pfQuest/Codex Knoten",
        ["esES"] = "Nodo pfQuest/Codex",
        ["esMX"] = "Nodo pfQuest/Codex",
        ["frFR"] = "Noeud pfQuest/Codex",
        ["itIT"] = "Nodo pfQuest/Codex",
        ["koKR"] = "pfQuest/Codex 노드",
        ["ptBR"] = "Nó pfQuest/Codex",
        ["ruRU"] = "Точка pfQuest/Codex",
        ["zhCN"] = "pfQuest/Codex 节点",
        ["zhTW"] = "pfQuest/Codex 節點",
    },
    ["Party marker"] = {
        ["enUS"] = true,
        ["deDE"] = "Gruppenmarker",
        ["esES"] = "Marcador de grupo",
        ["esMX"] = "Marcador de grupo",
        ["frFR"] = "Marqueur de groupe",
        ["itIT"] = "Indicatore del gruppo",
        ["koKR"] = "파티 표시",
        ["ptBR"] = "Marcador de grupo",
        ["ruRU"] = "Маркер игрока",
        ["zhCN"] = "队伍标记",
        ["zhTW"] = "隊伍標記",
    },
    ...
    ["Available gray"] = {
        ["enUS"] = true,
        ["deDE"] = "Verfügbar grau",
        ["esES"] = "Disponible gris",
        ["esMX"] = "Disponible gris",
        ["frFR"] = "Disponible gris",
        ["itIT"] = "Disponibile grigio",
        ["koKR"] = "회색 사용 가능",
        ["ptBR"] = "Disponível cinza",
        ["ruRU"] = "Доступно серое",
        ["zhCN"] = "灰色可接",
        ["zhTW"] = "灰色可接",
    },
    ...
    ["Repeatable Complete"] = {
        ...
        ["esES"] = "Repetible completado",
        ["esMX"] = "Repetible completado",
        ["frFR"] = "Répétable terminé",
        ["itIT"] = "Ripetibile completato",
        ["koKR"] = "반복 완료",
    ...
    ["Event Quest Complete"] = {
        ...
        ["itIT"] = "Missione evento completata",
        ["koKR"] = "이벤트 퀘스트 완료",
    ...
    ["PvP Quest Complete"] = {
        ["enUS"] = true,
        ["deDE"] = "PvP-Quest abgeschlossen",
        ["esES"] = "Misión de JcJ completada",
        ["esMX"] = "Misión de JcJ completada",
        ["frFR"] = "Quête JcJ terminée",
        ["itIT"] = "Missione PvP completata",
        ["koKR"] = "PvP 퀘스트 완료",
        ["ptBR"] = "Missão JxJ concluída",
        ["ruRU"] = "PvP-задание выполнено",
        ["zhCN"] = "PvP任务完成",
        ["zhTW"] = "PvP任務完成",
    },
   ["Favourite"] = {
    ...
    ["pfQuest/Codex node cut center"] = {
        ["enUS"] = true,
        ["deDE"] = "pfQuest/Codex Knoten Mitte",
        ["esES"] = "Nodo pfQuest/Codex centro",
        ["esMX"] = "Nodo pfQuest/Codex centro",
        ["frFR"] = "Noeud pfQuest/Codex central",
        ["itIT"] = "Nodo pfQuest/Codex centro",
    ...
    ["Start and unfinished"] = {
        ["enUS"] = true,
        ["deDE"] = "Start und unvollständig",
        ["esES"] = "Inicio e incompleto",
        ["esMX"] = "Inicio e incompleto",
        ["frFR"] = "Début et non terminée",
        ["itIT"] = "Inizio e non completato",
        ["koKR"] = "시작과 미완료",
        ["ptBR"] = "Início e não concluída",
        ["ruRU"] = "Начало и незавершено",
        ["zhCN"] = "开始和未完成",
        ["zhTW"] = "開始和未完成",
    },
    ["Clean"] = {
    ...
    ["Available white"] = {
        ["enUS"] = true,
        ["deDE"] = "Verfügbar weiß",
        ["esES"] = "Disponible blanco",
        ["esMX"] = "Disponible blanco",
        ["frFR"] = "Disponible blanc",
        ["itIT"] = "Disponibile bianco",
        ["koKR"] = "흰색 사용 가능",
        ["ptBR"] = "Disponível branco",
        ["ruRU"] = "Доступно белое",
        ["zhCN"] = "白色可接",
        ["zhTW"] = "白色可接",
    },
