...
local iconOptionsLocales = {
    ...
    ["Shows or hides the icons that Questie draws on the world map and minimap."] = {
        ["ptBR"] = "Ativa ou desativa ícones no mapa.",
        ["ruRU"] = "Показать/скрыть значки Questie",
        ["deDE"] = "Aktivieren/Deaktivieren der Questie-Icons",
        ["koKR"] = "Questie 아이콘을 활성화합니다.",
        ["esMX"] = "Activa o desactiva iconos en el mapa.",
        ["enUS"] = true,
        ["zhCN"] = "在小地图和大地图上启用或禁用Questie图标",
        ["zhTW"] = "啟用或停用任務位置提示的圖示。",
        ["esES"] = "Activa o desactiva iconos en el mapa.",
        ["frFR"] = "Active les icônes sur la carte.",
    },
    ...
    ["When this is enabled, the quest turn-in locations will be shown on the map/minimap."] = {
        ["ptBR"] = "Se ativado, os locais de ativação da missão serão exibidos no mapa / mapa mínimo",
        ...
        ["esES"] = "Si está activado, los iconos de misión completada apareceran en el mapa y minimapa",
    ...
    ["Use custom Questie icons for NPC dialogs, reflecting the status and type of each quest."] = {
        ...
        ["frFR"] = "Utilisez des icônes Questie personnalisées pour les dialogues des PNJ, reflétant le statut et le type de chaque quête.",
    },
    ...
    ["When this is enabled, the locations of available quests will be shown on the map/minimap."] = {
        ["ptBR"] = "Se ativado, os locais de ativação da missão serão exibidos no mapa / mini mapa",
        ...
        ["esES"] = "Si está activado, los iconos de misión disponible apareceran en el mapa y minimapa.",
    ...
    ["Enable Event Quest Icons"] = {
        ...
        ["esMX"] = "Activar iconos de misiones de eventos",
        ["enUS"] = true,
        ["zhCN"] = "启用事件任务图标",
        ["zhTW"] = "啟用事件任務圖示",
        ["esES"] = "Activar iconos de misiones de eventos",
    ...
    ["When this is enabled, the locations of active event quests will be shown on the map/minimap."] = {
        ["ptBR"] = "Se ativado, a busca de locais de eventos será mostrada no mapa/minimapa.",
        ...
        ["esMX"] = "Si está activado, la localización de misiones de eventos mostrará en el mapa y minimapa.",
        ["enUS"] = true,
        ["zhCN"] = "启用此功能后，事件任务的位置将显示在 世界地图/小地图上。",
        ["zhTW"] = "啟用時，大地圖/小地圖上會顯示可取得事件任務的位置。",
        ["esES"] = "Si está activado, la localización de misiones de eventos mostrará en el mapa y minimapa.",
    ...
    ["When this is enabled, quest objective icons will be shown on the map/minimap."] = {
        ...
        ["esES"] = "Si está activado, los iconos de objetivo apareceran en el mapa y minimapa",
    ...
    ["When this is enabled, the locations of raid quests will be shown on the map/minimap."] = {
        ["ptBR"] = "Se ativado, os locais da missão da raide serão mostrados no mapa/minimapa.",
        ...
        ["esMX"] = "Si está activado, la localización de misiones de bandas mostrará en el mapa y minimapa.",
        ["enUS"] = true,
        ["zhCN"] = "启用此功能后，团队任务的位置将显示在 世界地图/小地图上。",
        ["zhTW"] = "啟用時，會在大地圖和小地圖上顯示團隊任務。",
        ["esES"] = "Si está activado, la localización de misiones de bandas mostrará en el mapa y minimapa.",
    ...
    ["Enable Dungeon Quest Icons"] = {
        ...
        ["koKR"] = "던전 퀘스트 활성화",
        ["esMX"] = "Activar iconos de misiones de calabozos",
        ["enUS"] = true,
        ["zhCN"] = "启用副本任务图标",
        ["zhTW"] = "啟用地城任務圖示",
        ["esES"] = "Activar iconos de misiones de mazmorras",
        ["frFR"] = "Icônes des quêtes de donjon",
    },
    ["When this is enabled, the locations of dungeon quests will be shown on the map/minimap."] = {
        ["ptBR"] = "Se ativado, os locais da missão da masmorra serão mostrados no mapa/minimapa.",
        ...
        ["esMX"] = "Si está activado, la localización de misiones de calabozos mostrará en el mapa y minimapa.",
        ["enUS"] = true,
        ["zhCN"] = "启用此功能后，副本任务的位置将显示在 世界地图/小地图上。",
        ["zhTW"] = "啟用時，會在大地圖和小地圖上顯示地城任務。",
        ["esES"] = "Si está activado, la localización de misiones de mazmorras mostrará en el mapa y minimapa.",
    ...
    ["When this is enabled, the locations of PvP quests will be shown on the map/minimap."] = {
        ["ptBR"] = "Se ativado, os locais da missão de JxJ serão mostrados no mapa/minimapa.",
        ...
        ["esMX"] = "Si está activado, la localización de misiones de JcJ mostrará en el mapa y minimapa.",
        ["enUS"] = true,
        ["zhCN"] = "启用此功能后，PVP任务的位置将显示在 世界地图/小地图上。",
        ["zhTW"] = "啟用時，會在大地圖和小地圖上顯示 PvP 任務。",
        ["esES"] = "Si está activado, la localización de misiones de JcJ mostrará en el mapa y minimapa.",
    ...
    ["When this is enabled, the locations of the AQ War Effort quests will be shown on the map/minimap."] = {
        ["ptBR"] = "Se ativado, os locais da missão do Esforço de Guerra de Ahn'Qiraj serão mostrados no mapa/minimapa.",
        ...
        ["esMX"] = "Si está activado, las localizaciones de las misiones de la campaña de guerra de Ahn'Qiraj mostrarán en el mapa/minimapa.",
        ["enUS"] = true,
        ["zhCN"] = "启用此功能后，安其拉战备任务的位置将显示在 世界地图/小地图上。",
        ["zhTW"] = "啟用時，會在大地圖和小地圖上顯示安其拉之門戰火任務。",
        ["esES"] = "Si está activado, las localizaciones de las misiones del esfuerzo de guerra de Ahn'Qiraj mostrarán en el mapa/minimapa.",
    ...
    ["The icon that is displayed for available event quests during holidays"] = {
        ...
        ["esMX"] = "El icono que se muestra para las misiones de eventos disponibles durante las fiestas.",
        ["enUS"] = true,
        ["zhCN"] = "节庆期间可以取得的节日任务",
        ["zhTW"] = "節慶期間可以取得的活動任務。",
        ["esES"] = "El icono que se muestra para las misiones de eventos disponibles durante las fiestas.",
    ...
    ["When this is enabled, the locations of Season of Discovery Runes and Rune quests will be shown on the map/minimap."] = {
        ["ptBR"] = "Se ativado, as localizações das runas da Temporada de Descoberta e das missões de runas serão mostradas no mapa/minimapa.",
        ...
        ["esMX"] = "Si está activado, las localizaciones de las runas de la Temporada de descubrimiento y las misiones de runas se mostrarán en el mapa/minimapa.",
        ["enUS"] = true,
        ["zhCN"] = "启用后，会在大地图和小地图上显示探索符文和符文任务的图标",
        ["zhTW"] = "啟用時，會在大地圖和小地圖上顯示探索賽季符文和符文任務。",
        ["esES"] = "Si está activado, las localizaciones de las runas de la Temporada de descubrimiento y las misiones de runas se mostrarán en el mapa/minimapa.",
