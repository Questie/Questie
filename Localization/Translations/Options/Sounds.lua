...
local soundsOptionsLocales = {
    ...
    ["When this is enabled, sounds added through LibSharedMedia are loaded."] = {
        ["ptBR"] = "Quando ativado, os sons adicionados através do LibSharedMedia são carregados.",
        ...
        ["koKR"] = false,
        ["esMX"] = "Cuando está habilitado los sonidos añadidos a través de LibSharedMedia se cargan.",
        ["enUS"] = true,
        ["zhCN"] = false,
        ["zhTW"] = "啟用時，會載入透過 LibSharedMedia 加入的音效。",
        ["esES"] = "Cuando está habilitado los sonidos añadidos a través de LibSharedMedia se cargan.",
        ["frFR"] = "Quand cette option est activée, les sons de la bibliothèque LibSharedMedia sont chargés.",
    },
    ["Play a short sound when completing a quest when it is ready to turn in."] = {
        ...
        ["frFR"] = "Jouer un court son lorsqu'une quête est terminée et prête à rendre.",
    },
