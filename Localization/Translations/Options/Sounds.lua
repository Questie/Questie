...
local soundsOptionsLocales = {
    ...
    ["Load custom sounds"] = {
        ...
        ["itIT"] = "Caricare suoni personalizzati",
    ...
    ["If checked, sounds added through LibSharedMedia are loaded."] = {
        ...
        ["esES"] = "Si está seleccionado, los sonidos añadidos a través de LibSharedMedia estarán cargados.",
        ["esMX"] = "Si está seleccionado, los sonidos añadidos a través de LibSharedMedia estarán cargados.",
        ["frFR"] = "Si cette option est cochée, les sons du LibSharedMedia sont chargés.",
        ["itIT"] = "Se selezionato, vengono caricati i suoni aggiunti tramite LibSharedMedia.",
    ...
    ["Play a short sound when completing a quest when it is ready to turn in."] = {
        ...
        ["itIT"] = "Riproduce un breve suono quando una missione è completata ed è pronta per essere consegnata.",
    ...
    ["Quest objective completed"] = {
        ...
        ["itIT"] = "Obiettivo di missione completato",
        ["koKR"] = "퀘스트 목표 완료",
    ...
    ["Play a short sound when completing a quest objective."] = {
        ...
        ["itIT"] = "Riproduce un breve suono quando completi un obiettivo di missione.",
    ...
    ["Quest Complete Sound Selection"] = {
        ...
        ["itIT"] = "Selezione del suono di completamento della missione",
        ["koKR"] = "퀘스트 완료 사운드 선택",
    ...
    ["The sound you hear when a quest is completed"] = {
        ...
        ["itIT"] = "Il suono che senti quando una missione è completata",
    ...
    ["Objective Complete Sound Selection"] = {
        ...
        ["itIT"] = "Selezione del suono di completamento dell'obiettivo",
        ["koKR"] = "목표 완료 사운드 선택",
    ...
    ["The sound you hear when an objective is completed"] = {
        ...
        ["itIT"] = "Il suono che senti quando un obiettivo è completato",
    ...
    ["Quest objective progress"] = {
        ...
        ["itIT"] = "Progressi dell'obiettivo della missione",
        ["koKR"] = "퀘스트 목표 진행",
    ...
    ["Play a short sound when making progress on a quest objective."] = {
        ...
        ["itIT"] = "Riproduce un breve suono quando fai progressi su un obiettivo di missione.",
    ...
    ["Objective Progress Sound Selection"] = {
        ...
        ["itIT"] = "Selezione del suono dei progressi dell'obiettivo",
        ["koKR"] = "목표 진행 사운드 선택",
    ...
    ["The sound you hear when you make progress on a quest objective"] = {
        ...
        ["itIT"] = "Il suono che senti quando fai progressi su un obiettivo di missione",
    ...
    ["Progress Sound Delay"] = {
        ...
        ["itIT"] = "Ritardo del suono di progresso",
        ["koKR"] = "진행음 지연",
    ...
    ["Delay (in seconds, default: %s) for playing objective progress and completion sounds. Increase this if you hear double sounds."] = {
        ...
        ["itIT"] = "Ritardo (in secondi, predefinito: %s) per la riproduzione dei suoni di progresso e completamento degli obiettivi. Aumentalo se senti suoni doppi.",
    ...
    ["The sound channel used for Questie's notification sounds."] = {
        ...
        ["itIT"] = "Il canale audio usato per i suoni di notifica di Questie.",
