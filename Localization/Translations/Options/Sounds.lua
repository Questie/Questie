...
local soundsOptionsLocales = {
    ...
    ["Load custom sounds"] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Carga sonidos personalizados",
        ["enUS"] = true,
        ["zhCN"] = false,
        ["zhTW"] = false,
        ["esES"] = "Carga sonidos personalizados",
    ...
    ["When this is enabled, sounds added through LibSharedMedia are loaded."] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Cuando esto está activado, sonidos agregados de LibSharedMedia se cargan.",
        ["enUS"] = true,
        ["zhCN"] = false,
        ["zhTW"] = false,
        ["esES"] = "Cuando esto está activado, sonidos agregados de LibSharedMedia se cargan.",
