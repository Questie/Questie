...
local soundsOptionsLocales = {
    ...
    ["When this is enabled, sounds added through LibSharedMedia are loaded."] = {
        ...
        ["esMX"] = "Si está activado, los sonidos añadidos a través de LibSharedMedia están cargados.",
        ["enUS"] = true,
        ["zhCN"] = false,
        ["zhTW"] = "啟用時，會載入透過 LibSharedMedia 加入的音效。",
        ["esES"] = "Si está activado, los sonidos añadidos a través de LibSharedMedia están cargados.",
    ...
    ["Quest Complete Sound Selection"] = {
        ...
        ["frFR"] = "Sélection du son de terminaison de quête",
    },
    ...
    ["Quest objective progress"] = {
        ["ptBR"] = "Progresso do objetivo de missão",
    ...
    ["The sound you hear when you make progress on a quest objective"] = {
        ["ptBR"] = "O som que você ouve quando faz progresso em um objetivo de missão.",
