...
local tooltipOptionsLocales = {
    ...
    ["Show next quests in chain"] = {
        ["ptBR"] = "Mostrar as próximas missões na série",
        ["ruRU"] = "Показывать следующие задания в цепочке",
        ["deDE"] = "Zeige nächste Quests der Reihe",
        ["koKR"] = false,
        ["esMX"] = "Mostrar siguientes misiones en la serie",
        ["enUS"] = true,
        ["zhCN"] = "显示下一个任务链中的任务",
        ["zhTW"] = "顯示後續任務",
        ["esES"] = "Mostrar siguientes misiones en la serie",
    ...
    ["When this is checked, the next quests in the chain will show in the expanded map tooltips."] = {
        ["ptBR"] = "Quando isso estiver marcado, as próximas missões na série serão mostradas nas dicas de mapa expandidas.",
        ...
        ["koKR"] = false,
        ["esMX"] = "Si está marcado, las siguientes misiones en la serie se mostrarán en los tooltips de mapa expandidos.",
        ["enUS"] = true,
        ["zhCN"] = "开启后，下一个任务链中的任务会在悬浮窗中显示",
        ["zhTW"] = "勾選時，會在展開的地圖浮動提示資訊中顯示任務串中的下一個任務。",
        ["esES"] = "Si está marcado, las siguientes misiones en la serie se mostrarán en los tooltips de mapa expandidos.",
