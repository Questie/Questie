...
local minimapOptionsLocales = {
    ...
    ["Draw a glow texture behind minimap icons, colored unique to each quest."] = {
        ...
        ["esMX"] = "Mostrar un aura detrás de los iconos de minimapa con colores unicos para cada misión",
        ["enUS"] = true,
        ["zhCN"] = "替小地图标记显示一圈光晕，且不同任务有不同的颜色",
        ["zhTW"] = "在小地圖圖示的後面繪製發光材質，每個任務都可以有不同的顏色。",
        ["esES"] = "Mostrar un aura detrás de los iconos de minimapa con colores unicos para cada misión",
