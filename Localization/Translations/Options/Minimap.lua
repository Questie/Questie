...
local minimapOptionsLocales = {
    ...
    ["Minimap Icons Glow"] = {
        ...
        ["itIT"] = "Icone della minimappa luminose",
        ["koKR"] = "미니맵 아이콘 반짝임 사용",
    ...
    ["Draw a glow texture behind minimap icons, colored unique to each quest."] = {
        ...
        ["itIT"] = "Disegna una texture luminosa dietro le icone della minimappa, con un colore unico per ogni missione.",
    ...
    ["Unique Minimap Icon Colors"] = {
        ...
        ["itIT"] = "Colori unici delle icone della minimappa",
        ["koKR"] = "고유 미니맵 아이콘 색상",
    ...
    ["Show minimap icons with colors that are randomly generated based on quest ID."] = {
        ...
        ["itIT"] = "Mostra le icone della minimappa con colori generati casualmente in base all'ID della missione.",
    ...
    ["Minimap Note Options"] = {
        ...
        ["itIT"] = "Opzioni delle note della minimappa",
        ["koKR"] = "미니맵 아이콘 설정",
    ...
    ["How large the minimap icons are.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanto sono grandi le icone della minimappa.\n(Predefinito: %s)",
    ...
    ["Fade Icons over Player"] = {
        ...
        ["itIT"] = "Dissolvenza delle icone vicino al giocatore",
    ...
    ["Minimap Icon Fade Distance"] = {
        ...
        ["itIT"] = "Distanza di dissolvenza delle icone della minimappa",
    ...
    ["How much objective icons should fade depending on distance.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanto dovrebbero dissolversi le icone degli obiettivi in base alla distanza.\n(Predefinito: %s)",
    ...
    ["Fades icons on the minimap when your player walks near them."] = {
        ...
        ["itIT"] = "Dissolve le icone sulla minimappa quando il tuo personaggio si avvicina.",
    ...
    ["Fade over Player Distance"] = {
        ...
        ["itIT"] = "Distanza di dissolvenza dal giocatore",
    ...
    ["Fade over Player Amount"] = {
        ...
        ["itIT"] = "Quantità di dissolvenza sul giocatore",
    ...
    ["How far from player should icons start to fade.\n(Default: %s)"] = {
        ...
        ["itIT"] = "A quale distanza dal giocatore le icone dovrebbero iniziare a dissolversi.\n(Predefinito: %s)",
    ...
    ["How much should the icons around the player fade.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanto dovrebbero dissolversi le icone intorno al giocatore.\n(Predefinito: %s)",
    ...
    ["Show Minimap Coordinates"] = {
        ...
        ["itIT"] = "Coordinate nella minimappa",
        ["koKR"] = "미니맵 좌표",
    ...
    ["Player coordinates on the Minimap"] = {
        ...
        ["itIT"] = "Coordinate del giocatore nella minimappa",
        ["koKR"] = "미니맵에 좌표 표시",
    ...
    ["Place the Player's coordinates on the Minimap title."] = {
        ...
        ["itIT"] = "Mostra le coordinate del giocatore nel titolo della minimappa.",
