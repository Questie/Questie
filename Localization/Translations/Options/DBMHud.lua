...
local dbmHudOptionsLocales = {
    ...
    ["Enable or disable the DBM Heads Up Display (HUD) overlay for showing map objects."] = {
        ["ptBR"] = "Ativa ou desativa a sobreposição do Heads Up Display (HUD) de DBM para mostrar objetos do mapa.",
        ...
        ["esMX"] = "Activa o desactiva la superposición del Heads Up Display (HUD) de DBM para mostar objetos del mapa.",
        ["enUS"] = true,
        ["zhCN"] = "启用/禁用叠加在地图插件上的 DBM HUD。",
        ["zhTW"] = "啟用或停用 DBM 畫面中顯示 (HUD) 圖層來顯示地圖物件。",
        ["esES"] = "Activa o desactiva la superposición del Heads Up Display (HUD) de DBM para mostrar objetos del mapa.",
    ...
    ["Refresh rate for HUD (Requires turning HUD off/on)"] = {
        ["ptBR"] = "Taxa de atualização para o HUD (requer que o HUD seja ativado/desativado)",
        ...
        ["esMX"] = "Frecuencia de actualización para el HUD (requiere activar/desactivar el HUD)",
        ["enUS"] = true,
        ["zhCN"] = "HUD的刷新率（需要关闭再打开HUD）",
        ["zhTW"] = "HUD 重新整理頻率 (需要將 HUD 停用後再啟用)",
        ["esES"] = "Frecuencia de actualización para el HUD (requiere activar/desactivar el HUD)",
