...
local dbmHudOptionsLocales = {
    ...
    ["Enable or disable the DBM Heads Up Display (HUD) overlay for showing map objects."] = {
        ...
        ["itIT"] = "Abilita o disabilita la sovrapposizione del DBM Heads Up Display (HUD) per mostrare gli oggetti della mappa.",
    ...
    ["Questie has activated DBM HUD overlay. For more options, visit DBM HUD tab in Questie options"] = {
        ...
        ["itIT"] = "Questie ha attivato la sovrapposizione DBM HUD. Per altre opzioni, visita la scheda DBM HUD nelle opzioni di Questie.",
    ...
    ["Show quest giver icons"] = {
        ...
        ["itIT"] = "Mostrare le icone degli assegnatori di missioni",
    ...
    ["Toggles whether or not available/complete quest icons appear on the HUD."] = {
        ...
        ["itIT"] = "Attiva o disattiva la visualizzazione delle icone delle missioni disponibili/completate sul HUD.",
    ...
    ["Show object interact icons"] = {
        ...
        ["itIT"] = "Mostrare le icone di interazione con gli oggetti",
    ...
    ["Refresh rate for HUD (Requires turning HUD off/on)"] = {
        ...
        ["itIT"] = "Frequenza di aggiornamento del HUD (richiede di spegnere e riaccendere il HUD)",
    ...
    ["Adjusts the fresh rate for HUD Icons which affects how often UI refreshes their position. (Default: %s)"] = {
        ...
        ["itIT"] = "Regola la frequenza di aggiornamento delle icone del HUD, che influisce sulla frequenza con cui l'interfaccia aggiorna la loro posizione. (Predefinito: %s)",
    ...
    ["Enable proximity visual for HUD icons"] = {
        ...
        ["itIT"] = "Attivare l'indicatore di prossimità per le icone del HUD",
    ...
    ["Adjusts the size of the icons that appear on the HUD. (Default: %s)"] = {
        ...
        ["itIT"] = "Regola la dimensione delle icone che appaiono sul HUD. (Predefinito: %s)",
    ...
    ["Toggles whether or not object (gear) icons appear on the HUD."] = {
        ...
        ["itIT"] = "Attiva o disattiva la visualizzazione delle icone degli oggetti (ingranaggio) sul HUD.",
    ...
    ["Size & Scale Options"] = {
        ...
        ["itIT"] = "Opzioni di dimensione e scala",
        ["koKR"] = "크기 & 비율 설정",
    ...
    ["Show loot icons"] = {
        ...
        ["itIT"] = "Mostrare le icone del bottino",
        ["koKR"] = "수집 아이콘 표시",
    ...
    ["Toggles whether or not loot icons appear on the HUD."] = {
        ...
        ["itIT"] = "Attiva o disattiva la visualizzazione delle icone del bottino sul HUD.",
    ...
    ["Global zoom level for HUD Icons"] = {
        ...
        ["itIT"] = "Livello di zoom globale per le icone del HUD",
    ...
    ["Changes the color of a HUD icon to red when you are near it."] = {
        ...
        ["itIT"] = "Cambia il colore di un'icona del HUD in rosso quando ti trovi vicino a essa.",
    ...
    ["Show slay icons"] = {
        ...
        ["itIT"] = "Mostrare le icone di uccisione",
        ["koKR"] = "처치 아이콘 표시",
    ...
    ["Toggles whether or not slay icons appear on the HUD."] = {
        ...
        ["itIT"] = "Attiva o disattiva la visualizzazione delle icone di uccisione sul HUD.",
    ...
    ["Global radius/size for HUD Icons"] = {
        ...
        ["itIT"] = "Raggio/dimensione globale per le icone del HUD",
    ...
    ["Adjusts the zoom level for HUD Icons which affects how close in or how far out you see them. (Default: %s)"] = {
        ...
        ["itIT"] = "Regola il livello di zoom delle icone del HUD, che influisce sulla vicinanza o sulla distanza con cui le vedi. (Predefinito: %s)",
    ...
    ["The DBM HUD integrates with the addon DeadlyBossMods to show a radar of objective icons on your entire screen. Enabling this feature usually requires a /reload to take effect."] = {
        ...
        ["itIT"] = "Il DBM HUD si integra con l'addon DeadlyBossMods per mostrare un radar delle icone degli obiettivi su tutto lo schermo. L'attivazione di questa funzione richiede solitamente un /reload per avere effetto.",
