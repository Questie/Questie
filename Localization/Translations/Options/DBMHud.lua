...
local dbmHudOptionsLocales = {
    ...
    ["Questie has activated DBM HUD overlay. For more options, visit DBM HUD tab in Questie options"] = {
        ...
        ["esMX"] = "Questie ha activado la superposición HUD de DBM. Para más opciones, visita la pestaña HUD de DBM en las opciones de Questie.",
        ["enUS"] = true,
        ["zhCN"] = false,
        ["zhTW"] = "Questie 已啟用 DBM 畫面中顯示 (HUD) 圖層，更多選項在 Questie 設定選項的 DBM HUD 標籤頁面中。",
        ["esES"] = "Questie ha activado la superposición HUD de DBM. Para más opciones, visita la pestaña HUD de DBM en las opciones de Questie.",
    ...
    ["Toggles whether or not available/complete quest icons appear on HUD. (Default: %s)"] = {
        ["ptBR"] = "Alterna se os ícones das missões disponíveis/concluídas aparecem ou não no HUD. (Padrão: %s)",
        ...
        ["esMX"] = "Alterna si los iconos de misiones disponibles/completas aparecen o no en el HUD. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "切换是否在HUD上显示可用/完成任务图标。（默认：%s）",
        ["zhTW"] = "切換 HUD 上是否要顯示可接/完成任務的圖示。(預設值: %s)",
        ["esES"] = "Alterna si los iconos de misiones disponibles/completas aparecen o no en el HUD. (Predeterminado: %s)",
    ...
    ["Toggles whether or not object (gear) icons appear on the DBM HUD. (Default: %s)"] = {
        ["ptBR"] = "Ativa ou desativa a aparição de ícones de objetos (equipamentos) no HUD do DBM. (Padrão: %s)",
        ...
        ["esMX"] = "Activa o desactiva si los iconos de objetos (equipo) aparecen o no en el HUD. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "切换是否需要在DBM HUD上显示物件图标 （默认: %s）",
        ["zhTW"] = "切換 HUD 上是否要顯示物件 (裝備) 圖示。(預設值: %s)",
        ["esES"] = "Activa o desactiva si los iconos de objetos (equipo) aparecen o no en el HUD. (Predeterminado: %s)",
    ...
    ["Toggles whether or not slay icons appear on the DBM HUD. (Default: %s)"] = {
        ...
        ["esMX"] = "Alterna si los iconos de matar aparecen en el HUD. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "切换是否在HUD上显示击杀目标的图标。 （默认：%s）",
        ["zhTW"] = "切換 HUD 上是否要顯示殺怪的圖示。(預設值: %s)",
        ["esES"] = "Alterna si los iconos de matar aparecen en el HUD. (Predeterminado: %s)",
