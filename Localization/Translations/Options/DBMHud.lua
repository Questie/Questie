...
local dbmHudOptionsLocales = {
    ...
    ["Enable or disable the DBM Heads Up Display (HUD) overlay for showing map objects."] = {
        ...
        ["deDE"] = "Aktivieren oder deaktivieren Sie das DBM-HUD zur Anzeige von Kartenobjekten.",
    ...
    ["Show quest giver icons"] = {
        ...
        ["ruRU"] = "Значки заданий",
        ["deDE"] = "Questgeber-Symbole anzeigen",
    ...
    ["Toggles whether or not available/complete quest icons appear on HUD. ( Default: %s )"] = {
        ...
        ["deDE"] = "Schaltet ein, ob Symbole für verfügbare/abgeschlossene Quests im HUD angezeigt werden oder nicht. ( Standard: %s )",
    ...
    ["Show quest objective icons"] = {
        ...
        ["ruRU"] = "Значки целей",
        ["deDE"] = "Questziel-Symbole anzeigen",
        ["koKR"] = "퀘스트 목표 아이콘 표시",
    ...
    ["Adjusts the fresh rate for HUD Icons which affects how often UI refreshes their position. ( Default: %s )"] = {
        ...
        ["deDE"] = "Passt die Aktualisierungsrate für HUD-Symbole an, die sich darauf auswirkt, wie oft die Benutzeroberfläche ihre Position aktualisiert. (Standard: %s)",
    ...
    ["Enable proximity visual for HUD icons"] = {
        ...
        ["deDE"] = "Näherungsvisualisierung für HUD-Symbole einschalten",
    ...
    ["Adjusts the size of the icons that appear on the HUD. ( Default: %s )"] = {
        ...
        ["deDE"] = "Passt die Größe der Symbole an, die auf dem HUD erscheinen. ( Standard: %s )",
    ...
    ["Toggles whether or not objective icons appear on HUD ( Default: %s )"] = {
        ...
        ["deDE"] = "Schaltet um, ob Objektivsymbole im HUD erscheinen oder nicht ( Standard: %s )",
    ...
    ["Show quest loot icons"] = {
        ...
        ["ruRU"] = "Значки добычи",
        ["deDE"] = "Beutesymbole für Quests anzeigen",
        ["koKR"] = "수집 아이콘 표시",
    ...
    ["Show quest slay icons"] = {
        ...
        ["ruRU"] = "Значки убийств",
        ["deDE"] = "Quest-Tötungssymbole anzeigen",
        ["koKR"] = "처치 아이콘 표시",
    ...
    ["Toggles whether or not slay icons appear on HUD. ( Default: %s )"] = {
        ...
        ["deDE"] = "Schaltet um, ob Tötungs-Symbole auf dem HUD erscheinen oder nicht. ( Standard: %s )",
    ...
    ["Global radius/size for HUD Icons"] = {
        ...
        ["ruRU"] = "Размер",
        ["deDE"] = "Globaler Radius/Größe für HUD-Symbole",
    ...
    ["Adjusts the zoom level for HUD Icons which affects how close in or how far out you see them. ( Default: %s )"] = {
        ...
        ["deDE"] = "Stellt die Zoomstufe für HUD-Symbole ein, die beeinflusst, wie nah oder wie weit entfernt Sie sie sehen. (Standard: %s)",
