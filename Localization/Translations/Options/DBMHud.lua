...
local dbmHudOptionsLocales = {
    ...
    ["Enable or disable the DBM Heads Up Display (HUD) overlay for showing map objects."] = {
        ...
        ["esMX"] = "Activa o desactiva la superposición del Heads Up Display (HUD) de DBM para objetos del mapa.",
        ["enUS"] = true,
        ["zhCN"] = "启用/禁用叠加在地图插件上的 DBM HUD。",
        ["zhTW"] = "啟用或停用 DBM 畫面中顯示 (HUD) 圖層來顯示地圖物件。",
        ["esES"] = "Activa o desactiva la superposición del Heads Up Display (HUD) de DBM para objetos del mapa.",
    ...
    ["Toggles whether or not available/complete quest icons appear on HUD. (Default: %s)"] = {
        ["ptBR"] = "Ativa ou desativa se os ícones de missões disponíveis/concluídas aparecem no DBM HUD. (Padrão: %s)",
        ...
        ["esMX"] = "Activa o desactiva si los iconos de misiones disponibles/completas aparecen en el DBM HUD. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "切换是否在HUD上显示可用/完成任务图标。（默认：%s）",
        ["zhTW"] = "切換 HUD 上是否要顯示可接/完成任務的圖示。(預設值: %s)",
        ["esES"] = "Activa o desactiva si los iconos de misiones disponibles/completas aparecen en el DBM HUD. (Predeterminado: %s)",
        ["frFR"] = "Indique si les icônes de quêtes disponibles / terminées apparaissent ou non sur le HUD. (Par défaut : %s)",
    },
    ...
    ["Refresh rate for HUD (Requires turning HUD off/on)"] = {
        ...
        ["esMX"] = "Frecuencia de actualización para HUD (requiere activar / desactivar el HUD)",
        ["enUS"] = true,
        ["zhCN"] = "HUD的刷新率（需要关闭再打开HUD）",
        ["zhTW"] = "HUD 重新整理頻率 (需要將 HUD 停用後再啟用)",
        ["esES"] = "Frecuencia de actualización para HUD (requiere activar / desactivar el HUD)",
    ...
    ["Toggles whether or not object (gear) icons appear on the DBM HUD. (Default: %s)"] = {
        ["ptBR"] = "Ativa ou desativa se os ícones de objetos (equipamentos) aparecem no DBM HUD. (Padrão: %s)",
        ...
        ["esMX"] = "Activa o desactiva si los iconos de objetos (equipo) aparecen en el DBM HUD. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "切换是否需要在DBM HUD上显示物件图标 （默认: %s）",
        ["zhTW"] = "切換 HUD 上是否要顯示物件 (裝備) 圖示。(預設值: %s)",
        ["esES"] = "Activa o desactiva si los iconos de objetos (equipo) aparecen en el DBM HUD. (Predeterminado: %s)",
        ["frFR"] = "Indique si les icônes d'objets (équipement) apparaissent sur le DBM HUD. (Par défaut : %s)",
    },
    ["Size & Scale Options"] = {
    ...
    ["Toggles whether or not loot icons appear on the DBM HUD. (Default: %s)"] = {
        ["ptBR"] = "Ativa ou desativa se os ícones de saque aparecem no DBM HUD. (Padrão: %s)",
        ...
        ["esMX"] = "Activa o desactiva si los iconos de botín aparecen en el DBM HUD. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "切换是否在HUD上显示物品图标。 （默认：%s）",
        ["zhTW"] = "切換 HUD 上是否要顯示撿東西的圖示。(預設值: %s)",
        ["esES"] = "Activa o desactiva si los iconos de botín aparecen en el DBM HUD. (Predeterminado: %s)",
        ["frFR"] = "Indique si les icônes de butin apparaissent sur le DBM HUD. (Par défaut : %s)",
    },
    ...
    ["Toggles whether or not slay icons appear on the DBM HUD. (Default: %s)"] = {
        ...
        ["esMX"] = "Activa o desactiva si los iconos de matanza aparecen en el DBM HUD. (Predeterminado: %s)",
        ["enUS"] = true,
