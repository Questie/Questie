...
local dbmHudOptionsLocales = {
    ...
    ["Enable proximity visual for HUD icons"] = {
        ...
        ["esMX"] = "Activa la proximidad visual para los iconos del HUD",
        ["enUS"] = true,
        ["zhCN"] = "启用近距离视野的 HUD 图标",
        ["zhTW"] = "啟用 HUD 圖示的接近提示",
        ["esES"] = "Activa la proximidad visual para los iconos del HUD",
    ...
    ["Toggles whether or not object (gear) icons appear on the DBM HUD. (Default: %s)"] = {
        ...
        ["esMX"] = "Alterna si los iconos de objetos (equipo) aparecen o no en el HUD. (Predeterminado: %s)",
        ["enUS"] = true,
        ["zhCN"] = "切换是否需要在DBM HUD上显示物件图标 （默认: %s）",
        ["zhTW"] = "切換 HUD 上是否要顯示物件 (裝備) 圖示。(預設值: %s)",
        ["esES"] = "Alterna si los iconos de objetos (equipo) aparecen o no en el HUD. (Predeterminado: %s)",
