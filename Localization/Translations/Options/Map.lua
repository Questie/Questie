...
local mapOptionsLocales = {
    ...
    ["Show Questie Map Button"] = {
        ...
        ["itIT"] = "Mostrare il pulsante di Questie sulla mappa",
    ...
    ["Enable or disable the Show/Hide Questie Button on Map (May fix some Map Addon interactions)."] = {
        ...
        ["itIT"] = "Abilita o disabilita il pulsante Mostra/Nascondi di Questie sulla mappa (può risolvere alcune interazioni con gli addon delle mappe).",
    ...
    ["Map Icons Glow"] = {
        ...
        ["itIT"] = "Icone della mappa luminose",
        ["koKR"] = "지도 아이콘 반짝임 사용",
    ...
    ["Draw a glow texture behind map icons, colored unique to each quest."] = {
        ...
        ["itIT"] = "Disegna una texture luminosa dietro le icone della mappa, con un colore unico per ogni missione.",
    ...
    ["Unique Map Icon Colors"] = {
        ...
        ["itIT"] = "Colori unici delle icone della mappa",
    ...
    ["Show map icons with colors that are randomly generated based on quest ID."] = {
        ...
        ["itIT"] = "Mostra le icone della mappa con colori generati casualmente in base all'ID della missione.",
    ...
    ["Map Note Options"] = {
        ...
        ["itIT"] = "Opzioni delle note della mappa",
        ["koKR"] = "지도 아이콘 설정",
    ...
    ["How large the map icons are.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanto sono grandi le icone della mappa.\n(Predefinito: %s)",
    ...
    ["Scale for Available/Complete Icons"] = {
        ...
        ["itIT"] = "Scala delle icone disponibili/completate",
    ...
    ["How large the available/complete icons are. Affects both map and minimap icons.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanto sono grandi le icone disponibili/completate. Influisce sia sulle icone della mappa che su quelle della minimappa.\n(Predefinito: %s)",
    ...
    ["How large the event icons are.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanto sono grandi le icone evento.\n(Predefinito: %s)",
    ...
    ["Scale for Loot Icons"] = {
        ...
        ["itIT"] = "Scala delle icone del bottino",
        ["koKR"] = "수집 아이콘 크기",
    ...
    ["How large the loot icons are.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanto sono grandi le icone del bottino.\n(Predefinito: %s)",
    ...
    ["Scale for Slay Icons"] = {
        ...
        ["itIT"] = "Scala delle icone di uccisione",
        ["koKR"] = "처치 아이콘 크기",
    ...
    ["How large the slay icons are.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanto sono grandi le icone di uccisione.\n(Predefinito: %s)",
    ...
    ["Scale for Object Icons"] = {
        ...
        ["itIT"] = "Scala delle icone degli oggetti",
        ["koKR"] = "오브젝트 아이콘 크기",
    ...
    ["How large the object icons are.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanto sono grandi le icone degli oggetti.\n(Predefinito: %s)",
    ...
    ["Townsfolk Icons"] = {
        ...
        ["esES"] = "Iconos de ciudadanos",
        ["esMX"] = "Iconos de ciudadanos",
        ["frFR"] = "Icônes des citadins",
        ["itIT"] = "Icone dei cittadini",
        ["koKR"] = "마을 주민 아이콘",
    ...
    ["How large the townsfolk map icons are.\n(Default: %s)"] = {
        ...
        ["esES"] = "Tamaño de los iconos de ciudadanos en el mapa.\n(Predeterminado: %s)",
        ["esMX"] = "Tamaño de los iconos de ciudadanos en el mapa.\n(Predeterminado: %s)",
        ["frFR"] = "Taille des icônes des citadins sur la carte.\n(Par défaut : %s)",
        ["itIT"] = "Quanto sono grandi le icone dei cittadini sulla mappa.\n(Predefinito: %s)",
    ...
    ["Minimap Townsfolk Icons"] = {
        ...
        ["esES"] = "Iconos de ciudadanos en el minimapa",
        ["esMX"] = "Iconos de ciudadanos en el minimapa",
        ["frFR"] = "Icônes des citadins sur la minicarte",
        ["itIT"] = "Icone dei cittadini nella minimappa",
        ["koKR"] = "미니맵 마을 주민 아이콘",
    ...
    ["How large the townsfolk minimap icons are.\n(Default: %s)"] = {
        ...
        ["esES"] = "Tamaño de los iconos de ciudadanos en el minimapa.\n(Predeterminado: %s)",
        ["esMX"] = "Tamaño de los iconos de ciudadanos en el minimapa.\n(Predeterminado: %s)",
        ["frFR"] = "Taille des icônes des citadins sur la minicarte.\n(Par défaut : %s)",
        ["itIT"] = "Quanto sono grandi le icone dei cittadini nella minimappa.\n(Predefinito: %s)",
    ...
    ["Show Map Coordinates"] = {
        ...
        ["frFR"] = "Coordonnées",
        ["itIT"] = "Coordinate della mappa e del cursore",
        ["koKR"] = "지도 및 커서 좌표",
    ...
    ["Place the Player's coordinates and Cursor's coordinates on the Map's title."] = {
        ...
        ["itIT"] = "Mostra le coordinate del giocatore e del cursore nel titolo della mappa.",
    ...
    ["Map Coordinates Decimal Precision"] = {
        ...
        ["itIT"] = "Precisione decimale delle coordinate della mappa",
    ...
    ["How many decimals to include in the precision on the Map for Player and Cursor coordinates.\n(Default: %s)"] = {
        ...
        ["itIT"] = "Quanti decimali includere nella precisione delle coordinate del giocatore e del cursore sulla mappa.\n(Predefinito: %s)",
