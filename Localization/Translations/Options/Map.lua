...
local mapOptionsLocales = {
    ...
    ["Enable or disable the Show/Hide Questie Button on Map (May fix some Map Addon interactions)."] = {
        ["ptBR"] = "Ativa ou desativa o botão mostrar/ocultar Questie no mapa (pode corrigir algumas interações com os addons de mapas).",
        ...
        ["esMX"] = "Activa o desactiva el botón de mostrar/ocultar Questie en el mapa (Puede solucionar algunas interacciones con los addons de mapas).",
        ["enUS"] = true,
        ["zhCN"] = "启用或停用大地图上的Questie切换按钮（可以解决某些地图插件的冲突）",
        ["zhTW"] = "啟用或停用大地圖上的顯示/隱藏任務圖示按鈕 (可以修正某些地圖插件的互動問題)。",
        ["esES"] = "Activa o desactiva el botón de mostrar/ocultar Questie en el mapa (Puede solucionar algunas interacciones con los addons de mapas).",
        ["frFR"] = "Active l'affichage du bouton afficher / cacher Questie sur la carte. (peut corriger certaines interactions avec des add-ons modifiant la carte).",
    },
    ["Map Icons Glow"] = {
    ...
    ["Show map icons with colors that are randomly generated based on quest ID."] = {
        ["ptBR"] = "Mostra ícones do mapa com cores geradas de maneira aleatoriamente com base no ID da missão",
