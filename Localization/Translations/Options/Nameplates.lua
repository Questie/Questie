...
local nameplateOptionsLocales = {
    ...
    ["Nameplate Icon Options"] = {
        ...
        ["itIT"] = "Opzioni delle icone delle barre dei nomi",
        ["koKR"] = "이름표 아이콘 설정",
    ...
    ["Enable Nameplate Quest Objectives"] = {
        ...
        ["itIT"] = "Attivare gli obiettivi di missione sulle barre dei nomi",
    ...
    ["Enable or disable the quest objective icons over creature nameplates."] = {
        ...
        ["itIT"] = "Abilita o disabilita le icone degli obiettivi di missione sulle barre dei nomi delle creature.",
    ...
    ["Where on the X axis the nameplate icon should be. (Default: %s)"] = {
        ...
        ["esES"] = "La posición en el eje X del icono de la placa de nombre. (Predeterminado: %s)",
        ["esMX"] = "La posición en el eje X del icono de la placa de nombre. (Predeterminado: %s)",
        ["frFR"] = "La position sur l’axe X de l’icône de la plaque de nom. (Par défaut : %s)",
        ["itIT"] = "Dove dovrebbe trovarsi l'icona della barra dei nomi sull'asse X. (Predefinito: %s)",
        ["koKR"] = "대상 프레임에 표시할 아이콘의 X좌표를 설정합니다. (기본값: %s)",
        ["ptBR"] = "A posição no eixo X do ícone da placa de nome. (Padrão: %s)",
    ...
    ["Where on the Y axis the nameplate icon should be. (Default: %s)"] = {
        ...
        ["esES"] = "La posición en el eje Y del icono de la placa de nombre. (Predeterminado: %s)",
        ["esMX"] = "La posición en el eje Y del icono de la placa de nombre. (Predeterminado: %s)",
        ["frFR"] = "La position sur l’axe Y de l’icône de la plaque de nom. (Par défaut : %s)",
        ["itIT"] = "Dove dovrebbe trovarsi l'icona della barra dei nomi sull'asse Y. (Predefinito: %s)",
        ["koKR"] = "대상 프레임에 표시할 아이콘의 Y좌표를 설정합니다. (기본값: %s)",
        ["ptBR"] = "A posição no eixo Y do ícone da placa de nome. (Padrão: %s)",
    ...
    ["Nameplate Icon Scale"] = {
        ...
        ["itIT"] = "Scala delle icone delle barre dei nomi",
        ["koKR"] = "이름표 아이콘 크기",
    ...
    ["Scale the size of the quest icons on creature nameplates. (Default: %s)"] = {
        ...
        ["itIT"] = "Imposta la dimensione delle icone delle missioni sulle barre dei nomi delle creature. (Predefinito: %s)",
    ...
    ["Reset Nameplates"] = {
        ...
        ["itIT"] = "Ripristinare le barre dei nomi",
        ["koKR"] = "이름표 초기화",
    ...
    ["Reset to default nameplate position and scale."] = {
        ...
        ["itIT"] = "Ripristina posizione e scala predefinite delle barre dei nomi.",
    ...
    ["Target Frame Icon Options"] = {
        ...
        ["itIT"] = "Opzioni delle icone della finestra del bersaglio",
        ["koKR"] = "대상 프레임 아이콘 설정",
    ...
    ["Enable Target Frame Quest Objectives"] = {
        ...
        ["itIT"] = "Attivare gli obiettivi di missione sulla finestra del bersaglio",
    ...
    ["Enable or disable the quest objective icons over creature target frame."] = {
        ...
        ["itIT"] = "Abilita o disabilita le icone degli obiettivi di missione sulla finestra del bersaglio della creatura.",
    ...
    ["Reset Target Frame"] = {
        ...
        ["itIT"] = "Ripristinare la finestra del bersaglio",
        ["koKR"] = "대상 프레임 초기화",
    ...
    ["Reset to default target frame position and scale."] = {
        ...
        ["itIT"] = "Ripristina posizione e scala predefinite della finestra del bersaglio.",
