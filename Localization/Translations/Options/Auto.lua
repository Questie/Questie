...
local autoOptionsLocales = {
    ...
    ["Automatically abandoned quest %s because breadcrumb quest %s is not complete."] = {
        ...
        ["koKR"] = "퀘스트 %s을(를) 자동으로 포기했습니다. 길잡이 퀘스트 %s가 완료되지 않았기 때문입니다.",
        ["ptBR"] = "Missão %s abandonada automaticamente porque a missão de encaminhamento %s não foi concluída.",
        ["ruRU"] = "Задание %s автоматически отклонено, так как предзадание %s не выполнено",
