...
local autoOptionsLocales = {
    ...
    ["Automatically abandoned %s because breadcrumb quest %s is not complete."] = {
        ["enUS"] = true,
        ["deDE"] = "%s wurde automatisch abgebrochen, weil die Brotkrumen-Quest %s nicht abgeschlossen ist.",
        ["esES"] = "%s abandonada automáticamente porque la misión de rastro %s no está completada.",
        ["esMX"] = "%s abandonada automáticamente porque la misión de migajas %s no está completada.",
