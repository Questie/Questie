...
local autoOptionsLocales = {
    ...
    ["If checked, Questie will automatically hand in finished quests when talking to NPCs."] = {
        ...
        ["itIT"] = "Se selezionato, Questie consegnerà automaticamente le missioni completate quando parli con gli NPC.",
    ...
    ["If checked, Questie will automatically accept quest dialogs when they appear, depending on the rules below."] = {
        ...
        ["itIT"] = "Se selezionato, Questie accetterà automaticamente le missioni quando appaiono, in base alle regole qui sotto.",
    ...
    ["Automatically accept normal quests from NPCs."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni normali dagli NPC.",
    ...
    ["Automatically accept repeatable quests (including dailies) from NPCs."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni ripetibili (incluse le giornaliere) dagli NPC.",
    ...
    ["Automatically accept dungeon and raid quests from NPCs."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni di spedizione e incursione dagli NPC.",
    ...
    ["Automatically accept PvP quests from NPCs."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni PvP dagli NPC.",
    ...
    ["Automatically accept event quests (including event dailies) from NPCs."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni evento (incluse le giornaliere evento) dagli NPC.",
    ...
    ["Automatically accept trivial (low-level) quests from NPCs."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni banali (di basso livello) dagli NPC.",
    ...
    ["Automatically accept normal quests from players."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni normali dai giocatori.",
    ...
    ["Automatically accept repeatable quests (including dailies) from players."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni ripetibili (incluse le giornaliere) dai giocatori.",
    ...
    ["Automatically accept dungeon and raid quests from players."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni di spedizione e incursione dai giocatori.",
    ...
    ["Automatically accept PvP quests from players."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni PvP dai giocatori.",
    ...
    ["Automatically accept event quests (including event dailies) from players."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni evento (incluse le giornaliere evento) dai giocatori.",
    ...
    ["Automatically accept trivial (low-level) quests from players."] = {
        ...
        ["itIT"] = "Accetta automaticamente le missioni banali (di basso livello) dai giocatori.",
    ...
    ["Dungeon/Raid Quests"] = {
        ...
        ["itIT"] = "Missioni di spedizione/incursione",
        ["koKR"] = "던전/레이드 퀘스트",
    ...
    ["Reject quests shared in battlegrounds"] = {
        ...
        ["itIT"] = "Rifiuta le missioni condivise nei campi di battaglia",
    ...
    ["Automatically reject quests shared by players while in a battleground instance. This feature overrides autoaccept behavior."] = {
        ...
        ["itIT"] = "Rifiuta automaticamente le missioni condivise dai giocatori mentre sei in un'istanza di campo di battaglia. Questa funzione prevale sul comportamento di accettazione automatica.",
    ...
    ["Reject quests shared by non-friends"] = {
        ...
        ["itIT"] = "Rifiuta le missioni condivise da non amici",
    ...
    ["Automatically reject quests shared by players that aren't on your friends list. This feature overrides autoaccept behavior."] = {
        ...
        ["itIT"] = "Rifiuta automaticamente le missioni condivise da giocatori che non sono nella tua lista amici. Questa funzione prevale sul comportamento di accettazione automatica.",
    ...
    ["Abandon quest if breadcrumb is not completed"] = {
        ...
        ["itIT"] = "Abbandona la missione se la missione guida non è completata",
        ["koKR"] = "길잡이를 완료하지 않은 경우 퀘스트 포기",
        ["ptBR"] = "Abandonar se a missão de encaminhamento não foi concluído",
        ["ruRU"] = "Отказаться от задания, если предзадание не выполнено",
        ["zhCN"] = "如果线索未完成则放弃任务",
        ["zhTW"] = "如果線索未完成則放棄任務",
    },
    ["Automatically abandon a quest if you accept it before completing its breadcrumb quest."] = {
        ...
        ["itIT"] = "Abbandona automaticamente una missione se la accetti prima di completare la sua missione guida.",
        ["koKR"] = "길잡이 퀘스트를 완료하기 전에 퀘스트를 수락하면 자동으로 포기합니다.",
        ["ptBR"] = "Abandona automaticamente uma missão se você a aceitar antes de concluir sua missão de encaminhamento.",
        ["ruRU"] = "Автоматически отказываться от задания, если вы приняли его до завершения предзадания",
        ["zhCN"] = "如果你在完成线索任务之前接受了任务，则自动放弃该任务",
        ["zhTW"] = "如果你在完成線索任務之前接受了任務，則自動放棄該任務",
    },
    ["Automatically abandoned quest %s because breadcrumb quest %s is not completed."] = {
        ["enUS"] = true,
        ["deDE"] = "Quest %s wurde automatisch abgebrochen, weil die Brotkrumen-Quest %s nicht abgeschlossen ist.",
        ["esES"] = "La misión %s fue abandonada automáticamente porque la misión de rastro %s no está completada.",
        ["esMX"] = "La misión %s fue abandonada automáticamente porque la misión de migajas %s no está completada.",
        ["frFR"] = "La quête %s est abandonnée automatiquement car la quête d'orientation %s n'est pas terminée.",
        ["itIT"] = "Missione %s abbandonata automaticamente perché la missione guida %s non è completata.",
        ["koKR"] = "%s 퀘스트를 자동으로 포기했습니다. 길잡이 퀘스트 %s가 완료되지 않았기 때문입니다.",
        ["ptBR"] = "A missão %s foi abandonada automaticamente porque a missão de encaminhamento %s não foi concluída.",
        ["ruRU"] = "Задание %s автоматически отменено, так как задание-наводка %s не завершено",
        ["zhCN"] = "已自动放弃任务 %s，因为线索任务 %s 未完成",
        ["zhTW"] = "已自動放棄任務 %s，因為線索任務 %s 未完成",
    },
    ["Further Auto customization is coming in a future Questie update."] = {
        ...
        ["itIT"] = "Ulteriori personalizzazioni automatiche arriveranno in un futuro aggiornamento di Questie.",
