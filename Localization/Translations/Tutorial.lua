...
local tutorialLocals = {
    ...
    ["Questie can show you the locations of Phase 1 & 2 runes for your class.\n\n"] = {
        ...
        ["zhCN"] = false,
        ["zhTW"] = false,
        ["esES"] = "Questie puede mostrarte las ubicaciones de las runas de la fase 1 & 2 para tu clase.\n\n",
        ["frFR"] = "Questie peut vous indiquer la position des runes de la Phase 1 & 2 pour votre classe.\n\n",
    },
