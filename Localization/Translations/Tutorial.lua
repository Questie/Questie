...
local tutorialLocals = {
    ...
    ["Questie can show you the locations of Phase 1 runes for your class.\n\n"] = {
        ["ptBR"] = "O Questie pode mostrar as localizações das runas da fase 1 para a sua classe.\n\n",
        ...
        ["koKR"] = false,
        ["esMX"] = "Questie puede mostrarte las ubicaciones de las runas de la fase 1 para tu clase.\n\n",
        ["enUS"] = true,
        ["zhCN"] = false,
        ["zhTW"] = "Questie 可以顯示你的職業在第一階段的符文位置。\n\n",
        ["esES"] = "Questie puede mostrarte las ubicaciones de las runas de la fase 1 para tu clase.\n\n",
    ...
    ["Yes, show runes"] = {
        ["ptBR"] = "Sim, mostrar runas",
        ["ruRU"] = "Показывать руны",
        ["deDE"] = "Ja, zeige Runen",
        ["koKR"] = false,
        ["esMX"] = "Sí, mostrar runas",
        ["enUS"] = true,
        ["zhCN"] = false,
        ["zhTW"] = "是的，要顯示符文",
        ["esES"] = "Sí, mostrar runas",
        ["frFR"] = "Oui, montrez les runes",
    },
    ["No, hide runes"] = {
        ["ptBR"] = "Não, ocultar runas",
        ["ruRU"] = "Скрыть руны",
        ["deDE"] = "Nein, nicht zeigen",
        ["koKR"] = false,
        ["esMX"] = "No, ocultar runas",
        ["enUS"] = true,
        ["zhCN"] = false,
        ["zhTW"] = "不要，請隱藏符文",
        ["esES"] = "No, ocultar runas",
