...
local tutorialLocals = {
    ...
    ["With WotLK Phase 4 Blizzard introduced their own quest objective system.\n\nPlease choose the objective style you want to use:"] = {
        ...
        ["itIT"] = "Con la Fase 4 di WotLK, Blizzard ha introdotto il proprio sistema di obiettivi di missione.\n\nScegli lo stile di obiettivo che desideri utilizzare:",
    ...
    ["Questie can show you the locations of runes for your class from previous SoD Phases.\n\n"] = {
        ...
        ["itIT"] = "Questie può mostrarti le posizioni delle rune per la tua classe delle fasi precedenti di SoD.\n\n",
    ...
    ["Rune locations are marked with the following symbol:"] = {
        ...
        ["itIT"] = "Le posizioni delle rune sono contrassegnate dal seguente simbolo:",
    ...
    ["Please choose if you want to see them or not\n"] = {
        ...
        ["itIT"] = "Scegli se vuoi vederle o no\n",
    ...
    ["(This can always be changed in the Icons tab of the settings)"] = {
        ...
        ["itIT"] = "(Puoi sempre modificarlo nella scheda Icone delle impostazioni)",
    ...
    ["Questie can automatically reject quests shared to you\nwhile you are in a battleground.\n\n\nDo you want to activate this?"] = {
        ...
        ["itIT"] = "Questie può rifiutare automaticamente le missioni condivise con te\nmentre ti trovi in un campo di battaglia.\n\n\nVuoi attivare questa funzione?",
        ["koKR"] = "전장에 있을 경우, Qestie 가\n당신에게 공유된 퀘스트를 자동으로 거절할 수 있습니다.\n\n\n정말로 이 기능을 활성화 할까요?",
