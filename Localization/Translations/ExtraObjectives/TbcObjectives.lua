...
local tbcObjectiveLocales = {
    ...
    ["Use the Felhound Whistle and kill some Deranged Helboars"] = { -- 10629
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Benutzt die Teufelshundepfeife und tötet einige verstörter Hölleneber.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
    ...
    ["Collect Cursed Eggs to spawn Malevolent Hatchling"] = { -- 10861
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Sammelt verfluchte Eier um bösartige Jungtiere zu spawnen.", -- Hat jemand was besseres als spawnen? "Anzulocken" passt hier nicht so wirklich.
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
