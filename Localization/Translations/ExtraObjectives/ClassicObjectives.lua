...
local classicObjectiveLocales = {
    ...
    ["Step 1: obtain the Yellow Punch Card. You need the White Punch Card."] = { -- 2930
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Schritt 1: Sie erhalten die Gelbe Lochkarte. Sie benötigen die Weiße Lochkarte.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["Step 2: obtain the Blue Punch Card. You need the Yellow Punch Card."] = { -- 2930
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Schritt 2: Sie erhalten die blaue Lochkarte. Sie benötigen die Gelbe Lochkarte.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["Step 3: obtain the Red Punch Card. You need the Blue Punch Card."] = { -- 2930
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Schritt 3: Sie erhalten die rote Stempelkarte. Sie benötigen die blaue Punch Card.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["Step 4: obtain the Prismatic Punch Card. You need the Red Punch Card."] = { -- 2930
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Schritt 4: Sie erhalten die prismatische Lochkarte. Sie benötigen die rote Lochkarte.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["Use the Gorishi Queen Lure."] = { -- 4507
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Benutzen den Köder für die Gorishischwarmkönigin",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["Summon a Lord using a full Twilight set, neck and ring."] = { -- 8352 9248
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Beschwöre einen Lord mit einem kompletten Twilight-Set, Halskette und Ring.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["Ask to see the Captain."] = { -- 8507
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Fragen Sie nach dem Kapitän.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["Place the Relic Bundle in the Town Square."] = { -- 5721
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Legen Sie das Reliquienbündel auf den Stadtplatz.",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
    ...
    ["Place a tribute at Grom's Monument"] = { -- 8150
        ["ptBR"] = false,
        ["ruRU"] = false,
        ["deDE"] = "Setzen Sie einen Tribut am Grom-Denkmal",
        ["koKR"] = false,
        ["esMX"] = false,
        ["enUS"] = true,
