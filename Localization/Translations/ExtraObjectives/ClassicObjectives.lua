...
local classicObjectiveLocales = {
    ...
    ["Hold off Kolkar invaders until Warlord Krom'zar spawns and then loot the banner spawned on his corpse."] = { -- 4021
        ["ptBR"] = "Impeça os invasores Kolkar até que o Senhor da Guerra Krom'zar apareça e, em seguida, saqueie o estandarte que surge em seu cadáver.",
        ["ruRU"] = false,
        ["deDE"] = false,
        ["koKR"] = false,
        ["esMX"] = "Detén a los invasores Kolkar hasta que aparezca el Señor de la Guerra Krom'zar, y luego recoge el estandarte que aparece en su cadáver.",
        ["enUS"] = true,
        ["frFR"] = "Repoussez les envahisseurs Kolkar jusqu'à ce que le Chef de guerre Krom'zar apparaisse, puis récupérez la bannière qui apparaît sur son cadavre.",
        ["esES"] = "Detén a los invasores Kolkar hasta que aparezca el Señor de la Guerra Krom'zar, y luego recoge el estandarte que aparece en su cadáver.",
        ["zhTW"] = false,
        ["zhCN"] = false,
    },
