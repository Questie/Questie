...
local classicObjectiveLocales = {
    ...
    ["Hold off Kolkar invaders until Warlord Krom'zar spawns and then loot the banner spawned on his corpse."] = { -- 4021
        ["ptBR"] = "Impeça os invasores Kolkar até que o Senhor da Guerra Krom'zar apareça e, em seguida, saqueie a bandeira que surge em seu cadáver.",
        ["ruRU"] = false,
        ["deDE"] = false,
        ["koKR"] = false,
        ["esMX"] = "Detén a los invasores Kolkar hasta que aparezca el Señor de la Guerra Krom'zar, y luego saquea el estandarte que aparece en su cadáver.",
        ["enUS"] = true,
        ...
        ["esES"] = "Detén a los invasores Kolkar hasta que aparezca el Señor de la Guerra Krom'zar, y luego saquea el estandarte que aparece en su cadáver.",
        ["zhTW"] = false,
        ["zhCN"] = false,
    },
