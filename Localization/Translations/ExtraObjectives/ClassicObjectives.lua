...
local classicObjectiveLocales = {
    ...
    ["Use Cantation of Manifestation to reveal Rift Spawn. Use Chest of Containment Coffers on stunned Rift Spawn"] = { -- 1920 & 1960
        ...
        ["zhCN"] = "使用显形卷轴显露裂隙怒灵，并对被击昏的裂隙怒灵使用封灵箱",
    ...
    ["Hold off Kolkar invaders until Warlord Krom'zar spawns and then loot the banner spawned on his corpse."] = { -- 4021
        ...
        ["zhCN"] = "阻挡科卡尔入侵者，直到督军克罗姆扎出现，然后拾取其尸体上出现的旗帜",
    ...
    ["Beat Emberstrife till his will is broken, then place the Unforged Seal of Ascension before him and use the Orb of Draconic Energy."] = { -- 4743
        ...
        ["zhCN"] = "击败埃博斯塔夫直到其意志崩溃，然后将未铸造的晋升印章放在他面前，并使用龙力宝珠",
    ...
    ["Use the Lovers' Hearts to summon an Incubus and slay it."] = { -- 65597 -- NLU
        ...
        ["esMX"] = "Usa el Corazón de los amantes a invocar un íncubo y mátalo",
        ...
        ["zhCN"] = "使用情人的徽记召唤梦魔并杀死它",
        ["zhTW"] = "使用戀人的心臟召喚夢魔並殺死它",
    },
    ["Light the Unlit Torch near a fire and use the Burning Torch to set the Archaeologist's Cart on fire."] = { -- 65602
        ["enUS"] = true,
        ["deDE"] = "Entzünde die Nicht angezündete Fackel und benutze die Brennende Fackel, um den Wagen des Archäologen in Brand zu stecken",
        ["esES"] = "Enciende la Antorcha apagada cerca del fuego y usa la Antorcha encendida para prender fuego al Carro de arqueólogo",
        ["esMX"] = "Enciende la Antorcha apagada cerca del fuego y usa la Antorcha ardiente para prender fuego al Carro de arqueólogo",
        ["frFR"] = "Allumez la Torche éteinte près d’un feu et utilisez la Torche ardente pour mettre le feu au Chariot d’archéologue",
        ["koKR"] = "불 근처에서 불을 붙이지 않은 횃불에 불을 붙인 후 고고학자의 수레에 불타는 횃불을 사용해 불을 지르세요",
    ...
    ["Use the Wooden Figurine to summon an Incubus and slay it."] = { -- 65603 -- NLU
        ...
        ["esMX"] = "Usa la Figurilla de madera para invocar a un íncubo y mátalo",
        ["frFR"] = "Utilisez la Figurine en bois pour invoquer un Incubus et tuez-le",
        ["koKR"] = "목재 조각상을 사용하여 인큐버스를 소환 후 죽이세요",
        ["ptBR"] = "Use a Estatueta de Madeira para evocar um Íncubo e abatê-lo",
        ["ruRU"] = "Используйте Деревянную статуэтку, чтобы призвать Суккуба и убить его",
        ["zhCN"] = "使用木雕召唤梦魔并杀死它",
        ["zhTW"] = "使用木雕刻像召喚夢魔並殺死它",
    },
   ["Use the Withered Scarf to summon an Incubus and slay it."] = { -- 65604
        ["enUS"] = true,
        ["deDE"] = "Benutzt den abgetragener Schal um den Inkubus zu beschwören und erschlagt ihn",
        ["esES"] = "Usa el Pañuelo deshilachado para invocar a un íncubo y mátalo",
        ["esMX"] = "Usa la Bufanda desgastada para invocar a un íncubo y mátalo",
    ...
    ["Use the Cenarion Moondust"] = {
        ...
        ["esES"] = "Usa el Polvo lunar Cenarion",
        ["esMX"] = "Usa el Polvo de luna Cenarion",
        ["frFR"] = "Utilisez la Poussière de lune cénarienne",
    ...
    ["Use the Cenarion Lunardust"] = {
        ...
        ["esES"] = "Usa el Polvo lunar Cenarion",
        ["esMX"] = "Usa el Polvo de luna Cenarion",
        ["frFR"] = "Utilisez la Poussière lunaire cénarienne",
        ["koKR"] = "세나리온 달가루를 사용하세요",
    ...
    ["Defeat Lunaclaw"] = {
        ...
        ["esES"] = "Derrota a Garraluna",
        ["esMX"] = "Derrota a Garraluna",
        ["frFR"] = "Vainquez Lunegriffe",
        ["koKR"] = "초승달발톱을 처치하세요",
    ...
    ["Slay slimes until they leave behind a Rusty Chest"] = {
        ...
        ["esES"] = "Mata babosas hasta que dejen un Cofre oxidado",
        ["esMX"] = "Mata babosas hasta que dejen un Cofre oxidado",
        ["frFR"] = "Tuez des Gelées jusqu’à ce qu’elles laissent un Coffre rouillé",
    ...
    ["Talk to Estelle Gendry"] = {
        ["enUS"] = true,
        ["deDE"] = "Spricht mit Estelle Gendry",
        ["esES"] = "Habla con Estelle Gendry",
        ["esMX"] = "Habla con Estelle Gendry",
        ["frFR"] = "Parlez à Estelle Gendry",
        ["koKR"] = "에스텔 젠드리와 대화",
    ...
    ["Open the chest"] = {
        ["enUS"] = true,
        ["deDE"] = "Öffne die Truhe",
        ["esES"] = "Abre el cofre",
        ["esMX"] = "Abre el cofre",
        ["frFR"] = "Ouvrez le coffre",
        ["koKR"] = "상자 열기",
        ["ptBR"] = "Abra o baú",
    ...
    ["Use the E.C.A.C. to weaken it"] = {
        ["enUS"] = true,
        ["deDE"] = "Benutze das R.C.V.K. um es zu schwächen",
        ["esES"] = "Usa el G.E.A.Q. para debilitarlo",
        ["esMX"] = "Usa el G.E.A.Q. para debilitarlo",
        ["frFR"] = "Utilisez le B.G.A.C. pour l’affaiblir",
        ["koKR"] = "E.C.A.C를 사용하여 약화시키기",
    ...
    ["Imprison the Doomguard Commander"] = {
        ["enUS"] = true,
        ["deDE"] = "Sperrt den Kommandanten der Verdammniswache ein",
        ["esES"] = "Aprisiona al Comandante guardia apocalíptico",
        ["esMX"] = "Aprisiona al Comandante guardia apocalíptico",
        ["frFR"] = "Emprisonne le Commandant de la Garde funeste",
        ["koKR"] = "파멸의수호대 사령관을 가두세요",
        ["ptBR"] = "Aprisione o Comandante Demonarca",
        ["ruRU"] = "Заключите Стражник ужаса: Командир",
        ["zhCN"] = "囚禁末日守卫指挥官",
        ["zhTW"] = "囚禁末日守衛指揮官",
    },
    ["Open the box"] = {
        ["enUS"] = true,
        ["deDE"] = "Öffne die Kiste",
        ["esES"] = "Abre la caja",
        ["esMX"] = "Abre la caja",
        ["frFR"] = "Ouvre la boîte",
        ["koKR"] = "상자를 여세요",
        ["ptBR"] = "Abra a caixa",
        ["ruRU"] = "Откройте коробку",
        ["zhCN"] = "打开箱子",
        ["zhTW"] = "打開箱子",
    },
}
