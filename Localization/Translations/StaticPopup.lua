...
local staticPopup = {
    ...
    ["Quest Item %%s might be needed for the quest %%s. \n\nAre you sure you want to delete this?"] = {
        ...
        ["itIT"] = "L'oggetto di missione %%s potrebbe essere necessario per la missione %%s. \n\nSei sicuro di volerlo eliminare?",
    ...
    ["You're trying to use Questie addon"] = {
        ...
        ["itIT"] = "Stai cercando di usare l'addon Questie",
    ...
    ["on an unsupported WoW game client!"] = {
        ...
        ["itIT"] = "su un client di gioco WoW non supportato!",
    ...
    ["WoW \"retail\" and private servers"] = {
        ...
        ["itIT"] = "WoW \"retail\" e server privati",
    ...
    ["WoW Classic (Era/Cataclysm)!"] = {
        ...
        ["frFR"] = true,
        ["itIT"] = "WoW Classic (Era/Cataclisma)!",
        ["koKR"] = "와우 클래식 (시대/리치왕)",
        ["ptBR"] = true,
