...
local eventsLocales = {
    ["The '%s' world event is active!"] = {
        ...
        ["itIT"] = "L'evento mondiale '%s' è attivo!",
        ["koKR"] = "월드 이벤트 '%s' 활성화",
    ...
    ["The Darkmoon Faire is up in %s!"] = {
        ...
        ["itIT"] = "La Fiera di Lunacupa è a %s!",
        ["koKR"] = "다크문 축제가 %s에서 열리고 있습니다!",
