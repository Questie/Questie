describe("TBC localization lookup loadstrings", function()
    local l10n
    ...
    describe("deDE", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/TBC/lookupItems/deDE.lua"
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/TBC/lookupNpcs/deDE.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/TBC/lookupObjects/deDE.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/TBC/lookupQuests/deDE.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("esES", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/TBC/lookupItems/esES.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/TBC/lookupNpcs/esES.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/TBC/lookupObjects/esES.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/TBC/lookupQuests/esES.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("esMX", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/TBC/lookupItems/esMX.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/TBC/lookupNpcs/esMX.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/TBC/lookupObjects/esMX.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/TBC/lookupQuests/esMX.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("frFR", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/TBC/lookupItems/frFR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/TBC/lookupNpcs/frFR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/TBC/lookupObjects/frFR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/TBC/lookupQuests/frFR.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("koKR", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/TBC/lookupItems/koKR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/TBC/lookupNpcs/koKR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/TBC/lookupObjects/koKR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/TBC/lookupQuests/koKR.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("ptBR", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/TBC/lookupItems/ptBR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/TBC/lookupNpcs/ptBR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/TBC/lookupObjects/ptBR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/TBC/lookupQuests/ptBR.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("ruRU", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/TBC/lookupItems/ruRU.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/TBC/lookupNpcs/ruRU.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/TBC/lookupObjects/ruRU.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/TBC/lookupQuests/ruRU.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("zhCN", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/TBC/lookupItems/zhCN.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/TBC/lookupNpcs/zhCN.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/TBC/lookupObjects/zhCN.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/TBC/lookupQuests/zhCN.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("zhTW", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/TBC/lookupItems/zhTW.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/TBC/lookupNpcs/zhTW.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/TBC/lookupObjects/zhTW.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/TBC/lookupQuests/zhTW.lua"
            assert(loadfile(currentLookupFile))()
