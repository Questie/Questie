describe("MoP localization lookup loadstrings", function()
    local l10n
    ...
    describe("deDE", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/MoP/lookupItems/deDE.lua"
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/MoP/lookupNpcs/deDE.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/MoP/lookupObjects/deDE.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/MoP/lookupQuests/deDE.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("esES", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/MoP/lookupItems/esES.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/MoP/lookupNpcs/esES.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/MoP/lookupObjects/esES.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/MoP/lookupQuests/esES.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("esMX", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/MoP/lookupItems/esMX.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/MoP/lookupNpcs/esMX.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/MoP/lookupObjects/esMX.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/MoP/lookupQuests/esMX.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("frFR", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/MoP/lookupItems/frFR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/MoP/lookupNpcs/frFR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/MoP/lookupObjects/frFR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/MoP/lookupQuests/frFR.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("koKR", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/MoP/lookupItems/koKR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/MoP/lookupNpcs/koKR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/MoP/lookupObjects/koKR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/MoP/lookupQuests/koKR.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("ptBR", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/MoP/lookupItems/ptBR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/MoP/lookupNpcs/ptBR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/MoP/lookupObjects/ptBR.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/MoP/lookupQuests/ptBR.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("ruRU", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/MoP/lookupItems/ruRU.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/MoP/lookupNpcs/ruRU.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/MoP/lookupObjects/ruRU.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/MoP/lookupQuests/ruRU.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("zhCN", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/MoP/lookupItems/zhCN.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/MoP/lookupNpcs/zhCN.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/MoP/lookupObjects/zhCN.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/MoP/lookupQuests/zhCN.lua"
            assert(loadfile(currentLookupFile))()
    ...
    describe("zhTW", function()
        ...
        it("validates lookupItems", function()
            currentLookupFile = "Localization/lookups/MoP/lookupItems/zhTW.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupNpcs", function()
            currentLookupFile = "Localization/lookups/MoP/lookupNpcs/zhTW.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupObjects", function()
            currentLookupFile = "Localization/lookups/MoP/lookupObjects/zhTW.lua"
            assert(loadfile(currentLookupFile))()
        ...
        it("validates lookupQuests", function()
            currentLookupFile = "Localization/lookups/MoP/lookupQuests/zhTW.lua"
            assert(loadfile(currentLookupFile))()
