...
elseif GetLocale() == "zhCN" then
    l10n.questLookupOverrides = loadstring([[return {
        ...
        [83713] = {"死亡证明：泰坦符文协议阿尔法",{"达拉然的大法师兰达洛克要你从任意地下城的最终首领处取回污染者的勋章。\n\n该任务必须在泰坦符文协议阿尔法难度的地下城中完成。"}},
        [83714] = {"死亡证明：艾泽拉斯的威胁",{"达拉然的大法师兰达洛克要你从任意地下城的最终首领处取回神秘的古器。\n\n该任务必须在英雄难度的地下城中完成。"}},
        [83717] = {"死亡证明：泰坦符文协议贝塔",{"达拉然的大法师兰达洛克要你从任意地下城的最终首领处取回污染者的勋章。\n\n该任务必须在泰坦符文协议贝塔难度的地下城中完成。"}},
        [87379] = {"死亡证明：艾泽拉斯的威胁",{"达拉然的大法师兰达洛克要你从任意地下城的最终首领处取回神秘的古器。\n\n该任务必须在英雄难度的地下城中完成。"}},
