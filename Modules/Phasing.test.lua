...
describe("Phasing", function()
    ...
    describe("Aysa Cloudsinger", function()
        it("should return true for pool phase when 29419 is not complete and not in the quest log", function()
            Questie.db.char.complete[29419] = false
            QuestLogCache.questLog_DO_NOT_MODIFY = {}

            assert.is_true(Phasing.IsSpawnVisible(phases.DRIVER_NOT_RESCUED))
        end)

        it("should return true for pool phase when 29419 is in quest log but not complete", function()
            Questie.db.char.complete[29419] = false
        ...
        it("should return false for pool phase when 29419 is complete", function()
            ...
            assert.is_false(Phasing.IsSpawnVisible(phases.DRIVER_NOT_RESCUED))
        end)

        it("should return false for pool phase when 29419 is in the quest log and complete", function()
            Questie.db.char.complete[29419] = true
            QuestLogCache.questLog_DO_NOT_MODIFY = {[29419]={isComplete=1}}
        ...
        it("should return true for land phase when 29419 is in the quest log and complete", function()
            Questie.db.char.complete[29419] = true
            QuestLogCache.questLog_DO_NOT_MODIFY = {[29419]={isComplete=1}}
        ...
        it("should return false for land phase when 29414 is accepted", function()
            Questie.db.char.complete[29419] = true
            Questie.db.char.complete[29414] = false
            QuestLogCache.questLog_DO_NOT_MODIFY = {[29414]={}}

            assert.is_false(Phasing.IsSpawnVisible(phases.AYSA_CLOUDSINGER_ON_LAND))
        end)

        it("should return false for land phase when 29414 complete", function()
            Questie.db.char.complete[29419] = true
            Questie.db.char.complete[29414] = true

            assert.is_false(Phasing.IsSpawnVisible(phases.AYSA_CLOUDSINGER_ON_LAND))
        end)

        it("should return true for cave phase when 29414 is accepted", function()
            Questie.db.char.complete[29414] = false
            QuestLogCache.questLog_DO_NOT_MODIFY = {[29414]={}}

            assert.is_true(Phasing.IsSpawnVisible(phases.AYSA_CLOUDSINGER_IN_CAVE))
        end)

        it("should return true for cave phase when 29414 is in the quest log and complete", function()
            Questie.db.char.complete[29414] = false
            QuestLogCache.questLog_DO_NOT_MODIFY = {[29414]={isComplete=1}}

            assert.is_true(Phasing.IsSpawnVisible(phases.AYSA_CLOUDSINGER_IN_CAVE))
        end)

        it("should return true for cave phase when 29414 is complete", function()
            Questie.db.char.complete[29414] = true
            QuestLogCache.questLog_DO_NOT_MODIFY = {}
