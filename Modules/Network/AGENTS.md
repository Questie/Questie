...
- `CommsEncoding` permits at most 762 final encoded bytes, equal to three AceComm multipart payloads. Keep feature-specific output guardrails stricter; raising the shared ceiling requires an explicit transport decision.
