    ...
    Tooltip._Rebuild = function(self)
            ...
            for _, questData in pairs(quests) do
                ...
                if questData.title ~= nil then
                    ...
                    if (quest and shift) then
                        local xpReward = GetQuestLogRewardXP(questData.questId, Questie.db.char.showQuestXpAtMaxLevel)
                        if xpReward > 0 then
        ...
        for questId, textList in pairs(self.questOrder) do -- this logic really needs to be improved
            ...
            if haveGiver then
                ...
                local xpReward = GetQuestLogRewardXP(questId, Questie.db.char.showQuestXpAtMaxLevel)
