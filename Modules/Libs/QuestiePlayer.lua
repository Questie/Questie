...
local currentQuestlog = {} --Gets populated by QuestieQuest:GetAllQuestIds(), this is either an object to the quest in question, or the ID if the object doesn't exist.
...
function QuestiePlayer:EnumerateQuestlog()
    return pairs(currentQuestlog or {})
end
----- END
