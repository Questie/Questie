...
describe("AvailableQuests", function()
    ...
    before_each(function()
        ...
        MapIconDrawer.UnloadStarterOrFinisher = spy.new(function() end)
    ...
    describe("ValidateAvailableQuestsFromGossipShow", function()
        it("should hide daily quests that are not available", function()
            ...
            assert.spy(MapIconDrawer.UnloadStarterOrFinisher).was.called_with(MapIconDrawer, QUEST_ID, nil)
            ...
            assert.spy(Comms.BroadcastUnavailableDailyQuests).was.called_with(NPC_ID, {QUEST_ID})
        end)
        ...
        it("should not hide available quests", function()
            ...
            assert.spy(_G.QuestieCompat.GetAvailableQuests).was.called()
            assert.spy(_G.QuestieCompat.GetActiveQuests).was.called()
            assert.spy(MapIconDrawer.UnloadStarterOrFinisher).was.not_called_with(MapIconDrawer, QUEST_ID)
        ...
        it("should handle talking to an NPC without available quests", function()
            ...
            assert.spy(MapIconDrawer.UnloadStarterOrFinisher).was.not_called()
    ...
    describe("ValidateAvailableQuestsFromQuestDetail", function()
        it("should hide daily quests that are not available", function()
            ...
            assert.spy(MapIconDrawer.UnloadStarterOrFinisher).was.called_with(MapIconDrawer, unavailableQuest, nil)
            ...
            assert.spy(MapIconDrawer.UnloadStarterOrFinisher).was.not_called_with(MapIconDrawer, availableQuest)
            ...
            assert.spy(Comms.BroadcastUnavailableDailyQuests).was.called_with(NPC_ID, {unavailableQuest})
        end)
    ...
    describe("ValidateAvailableQuestsFromQuestGreeting", function()
        it("should hide daily quests that are not available", function()
            ...
            assert.spy(MapIconDrawer.UnloadStarterOrFinisher).was.not_called_with(MapIconDrawer, availableQuestId)
            ...
            assert.spy(MapIconDrawer.UnloadStarterOrFinisher).was.called_with(MapIconDrawer, unavailableQuestId, nil)
            ...
            assert.spy(Comms.BroadcastUnavailableDailyQuests).was.called_with(NPC_ID, {unavailableQuestId})
        end)
    ...
    describe("RemoveQuestsForToday", function()
        it("should remove quests", function()
            ...
            assert.spy(MapIconDrawer.UnloadStarterOrFinisher).was.called_with(MapIconDrawer, firstQuest, nil)
            assert.spy(QuestieTooltips.RemoveQuest).was.called_with(QuestieTooltips, firstQuest)
            assert.spy(MapIconDrawer.UnloadStarterOrFinisher).was.called_with(MapIconDrawer, secondQuest, nil)
