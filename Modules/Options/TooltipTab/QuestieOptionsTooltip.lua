...
function QuestieOptions.tabs.tooltip:Initialize()
    return {
        name = function() return i10n('Tooltips'); end,
        type = "group",
        order = 16,
        args = {
            tooltip_options = {
                type = "header",
                order = 1,
                name = function() return i10n('Tooltip options'); end,
            },
            enableTooltipsToggle = {
                type = "toggle",
                order = 1.1,
                name = function() return i10n('Enable Tooltips'); end,
                desc = function() return i10n('When this is enabled, quest info will be added to relevant mob/item tooltips.'); end,
                width = 1.5,
            ...
            showQuestLevels = {
                type = "toggle",
                order = 1.2,
                name = function() return i10n('Show Quest Level in Tooltips'); end,
                desc = function() return i10n('When this is checked, the level of quests will show in the tooltips.'); end,
                width = 1.5,
            ...
            partyOnlyToggle = {
                type = "toggle",
                order = 1.3,
                name = function() return i10n('Only show party members'); end,
                desc = function() return i10n('When this is enabled, shared quest info will only show players in your party.'); end,
                width = 1.5,
            ...
            questsInNpcTooltip = {
                type = "toggle",
                order = 1.4,
                name = function() return i10n('Show quests in NPC tooltips'); end,
                desc = function() return i10n('Show quests (available/complete) in the NPC tooltips.'); end,
                width = 1.5,
