            ...
            icon_toggles_group = {
                ...
                args = {
                    ...
                    showItemQuests = {
                        type = "toggle",
                        order = 2.011,
                        name = function() return l10n("Available Item Quests"); end,
                        desc = function() return l10n("When this is enabled, the locations of available quests started by items will be shown on the map/minimap."); end,
                        width = 1.595,
                        disabled = function() return (not Questie.db.profile.enabled); end,
