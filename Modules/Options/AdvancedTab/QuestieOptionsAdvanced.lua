...
StaticPopupDialogs["QUESTIE_LANG_CHANGED_RELOAD"] = {
    button1 = i10n('Reload UI'),
    button2 = i10n('Cancel'),
    OnAccept = function()
        ReloadUI()
    end,
    text = i10n('The database needs to be updated to change language. Press reload to apply the new language'),
...
function QuestieOptions.tabs.advanced:Initialize()
    return {
        name = function() return i10n('Advanced'); end,
        type = "group",
        order = 17,
        args = {
            map_options = {
                type = "header",
                order = 1,
                name = function() return i10n('Advanced Settings'); end,
            },
            enableIconLimit = {
                type = "toggle",
                order = 1.1,
                name = function() return i10n('Enable Icon Limit'); end,
                desc = function() return i10n('Enable the limit of icons drawn per type.'); end,
                width = "full",
                get = function (info) return QuestieOptions:GetGlobalOptionValue(info); end,
                set = function (info, value)
                    QuestieOptions:SetGlobalOptionValue(info, value)
                    QuestieOptionsUtils:Delay(0.5, QuestieQuest.SmoothReset, i10n('Setting icon limit value to %s : Redrawing!', value))
                end,
            },
            iconLimit = {
                type = "range",
                order = 1.2,
                name = function() return i10n('Icon Limit'); end,
                desc = function() return i10n('Limits the amount of icons drawn per type. ( Default: %s )', optionsDefaults.global.iconLimit); end,
                width = "double",
                min = 10,
                max = 500,
                step = 10,
            ...
            seperatingHeader2 = {
                type = "header",
                order = 2,
                name = i10n('Developer Options'),
            },
            showQuestIDs = {
                type = "toggle",
                order = 2.1,
                name = function() return i10n('Show Quest IDs'); end,
                desc = function() return i10n('When this is checked, the ID of quests will show in the tooltips and the tracker.'); end,
                width = "full",
            ...
            debugEnabled = {
                type = "toggle",
                order = 2.2,
                name = function() return i10n('Enable Debug'); end,
                desc = function() return i10n('Enable or disable debug functionality.'); end,
                width = "full",
            ...
            debugEnabledPrint = {
                ...
                name = function() return i10n('Enable Debug').."-PRINT" end,
                desc = function() return i10n('Enable or disable debug functionality.').."-PRINT" end,
                width = "full",
            ...
            debugLevel = {
                ...
                order = 2.4,
                name = function() return i10n('Debug level to print'); end,
                width = "normal",
                disabled = function() return not Questie.db.global.debugEnabled; end,
            ...
            locale_header = {
                type = "header",
                order = 3,
                name = function() return i10n('Localization Settings'); end,
            },
            locale_dropdown = {
                type = "select",
                order = 3.1,
                ...
                style = 'dropdown',
                name = function() return i10n('Select UI Locale'); end,
                get = function()
                    if not Questie.db.global.questieLocaleDiff then
                        return 'auto'
                    else
                        return i10n:GetUILocale();
                    end
                end,
                set = function(input, lang)
                    if lang == 'auto' then
                        local clientLocale = GetLocale()
                        i10n:SetUILocale(clientLocale)
            ...
            reset_header = {
                type = "header",
                order = 4,
                name = function() return i10n('Reset Questie'); end,
            },
            Spacer_D = QuestieOptionsUtils:Spacer(22),
            reset_text = {
                type = "description",
                order = 4.1,
                name = function() return i10n('Hitting this button will reset all of the Questie configuration settings back to their default values. (Excluding Localization)'); end,
                fontSize = "medium",
            },
            questieReset = {
                type = "execute",
                order = 4.2,
                name = function() return i10n('Reset Questie'); end,
                desc = function() return i10n('Reset Questie to the default values for all settings.'); end,
            ...
            recompileDatabase = {
                type = "execute",
                order = 4.4,
                name = function() return i10n('Recompile Database'); end,
                desc = function() return i10n('Forces a recompile of the Questie database. This will also reload the UI.'); end,
                func = function (info, value)
                    QuestieConfig.dbIsCompiled = false
                    ReloadUI()
                end,
            ...
            openProfiler = {
                type = "execute",
                order = 4.6,
                name = function() return i10n('Open Profiler'); end,
                desc = function() return i10n('Open the Questie profiler, this is useful for tracking down the source of lag / frame spikes.'); end,
                func = function (info, value)
            ...
            github_text = {
                type = "description",
                order = 4.8,
                name = function() return Questie:Colorize(i10n('Questie is under active development for World of Warcraft: Classic. Please check GitHub for the latest alpha builds or to report issues. Or join us on our discord! (( https://github.com/AeroScripts/QuestieDev/ ))'), 'purple'); end,
                fontSize = "medium",
            },
        },
    }
