            ...
            group_tracker = {
                ...
                args = {
                    ...
                    minimizeInInstances = {
                        ...
                        desc = function() return l10n("If checked, the Questie Tracker will automatically be minimized when entering an dungeon/raid/battleground.") end,
                        disabled = function() return not Questie.db.profile.trackerEnabled end,
                    ...
                    hideInInstances = {
                        ...
                        desc = function() return l10n("If checked, the Questie Tracker will automatically be hidden when entering a dungeon/raid/battleground.") end,
                        disabled = function() return not Questie.db.profile.trackerEnabled end,
