...
local _playerRaceFlag = 255 -- dummy default value to give always not maching race, corrected in init
local _playerRaceFlagMask = 1 -- dummy default value to give always not maching race, corrected in init
local _playerClassName = ""
local _playerClassFlag = 255 -- dummy default value to give always not maching class, corrected in init
