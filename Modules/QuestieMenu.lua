...
function QuestieMenu:PopulateTownsfolk()
    ...
    local classTrainers = Questie.IsTBC and {
        ["MAGE"] = {198, 313, 328, 331, 944, 1228, 2124, 2128, 3047, 3048, 3049, 4566, 4567, 4568, 4987, 5144, 5145, 5146, 5497, 5498, 5880, 5882, 5883, 5884, 5885, 7311, 7312, 15279, 16269, 16500, 16651, 16652, 16653, 16749, 17481, 17513, 17514, 19340, 20791, 26326, 27703, 27704, 27705},
    ...
    elseif playerClass == "MAGE" then
        Questie.db.global.classSpecificTownsfolk["MAGE"]["Portal Trainer"] = {4165,2485,2489,5958,5957,2492,16654,16755}
    end
