		...
		dbm_hud_tab = {
            ...
            args = {
                ...
                dbmHUDShowQuest = {
                    ...
                    desc = function() return QuestieLocale:GetUIString('DBM_HUD_FILTER_QUEST_DESC') end,
                    width = "full",
                    get = GetGlobalOptionLocal,
                    set = function (info, value)
                        SetGlobalOptionLocal(info, value)
                ...
                dbmHUDShowSlay = {
                    ...
                    desc = function() return QuestieLocale:GetUIString('DBM_HUD_FILTER_KILL_DESC') end,
                    width = "full",
                    get = GetGlobalOptionLocal,
                    set = function (info, value)
                        SetGlobalOptionLocal(info, value)
                ...
                dbmHUDShowLoot = {
                    ...
                    desc = function() return QuestieLocale:GetUIString('DBM_HUD_FILTER_LOOT_DESC') end,
                    width = "full",
                    get = GetGlobalOptionLocal,
                    set = function (info, value)
                        SetGlobalOptionLocal(info, value)
                ...
                dbmHUDShowInteract = {
                    ...
                    desc = function() return QuestieLocale:GetUIString('DBM_HUD_FILTER_INTERACT_DESC') end,
                    width = "full",
                    get = GetGlobalOptionLocal,
                    set = function (info, value)
                        SetGlobalOptionLocal(info, value)
