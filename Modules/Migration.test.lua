...
describe("Migration", function()
    ...
    it("clears compiler payloads from ordinary, SoD, and Titan scopes", function()
        ...
        assert.are_same(41, Questie.db.profile.migrationVersion)
    end)
    ...
    it("enables the compartment button when upgrading from version 40", function()
        Questie.db.profile.migrationVersion = 40
    ...
    it("creates the minimap table when it is missing", function()
        Questie.db.profile.migrationVersion = 40
        Questie.db.profile.minimap = nil
