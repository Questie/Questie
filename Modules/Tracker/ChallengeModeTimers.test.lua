...
describe("ChallengeModeTimer", function()
    ...
    describe("GetTimerString", function()
        ...
        it("should return correct timer when within platinum range", function()
            ...
            assert.is_equal("00:50 / 01:40 |TInterface\\Challenges\\challenges-plat:0|t", timer)
            assert.spy(_G.C_ChallengeMode.GetChallengeModeMapTimes).was.called_with(123)
            assert.spy(Questie.Colorize).was.called_with(Questie, "00:50 / ", "white")
            assert.spy(Questie.Colorize).was.called_with(Questie, "01:40", "D9D9D9")
        end)
        ...
        it("should return correct timer when within gold range", function()
            ...
            assert.is_equal("02:30 / 03:20 |TInterface\\Challenges\\challenges-gold:0|t", timer)
            assert.spy(_G.C_ChallengeMode.GetChallengeModeMapTimes).was.called_with(123)
            assert.spy(Questie.Colorize).was.called_with(Questie, "02:30 / ", "white")
            assert.spy(Questie.Colorize).was.called_with(Questie, "03:20", "F1E156")
        end)
        ...
        it("should return correct timer when within silver range", function()
            ...
            assert.is_equal("03:21 / 05:00 |TInterface\\Challenges\\challenges-silver:0|t", timer)
            assert.spy(_G.C_ChallengeMode.GetChallengeModeMapTimes).was.called_with(123)
            assert.spy(Questie.Colorize).was.called_with(Questie, "03:21 / ", "white")
            assert.spy(Questie.Colorize).was.called_with(Questie, "05:00", "C4C4C4")
        end)
        ...
        it("should return correct timer when within bronze range", function()
            ...
            assert.is_equal("05:01 / 06:40 |TInterface\\Challenges\\challenges-bronze:0|t", timer)
            assert.spy(_G.C_ChallengeMode.GetChallengeModeMapTimes).was.called_with(123)
            assert.spy(Questie.Colorize).was.called_with(Questie, "05:01 / ", "white")
            assert.spy(Questie.Colorize).was.called_with(Questie, "06:40", "CE8946")
        end)
        ...
        it("should return correct timer without medal icon when below bronze range", function()
            ...
            assert.spy(_G.C_ChallengeMode.GetChallengeModeMapTimes).was.called_with(123)
            assert.spy(Questie.Colorize).was.called_with(Questie, "06:41 / ", "white")
            assert.spy(Questie.Colorize).was.called_with(Questie, "00:00", "845321")
        end)
    end)
end)
