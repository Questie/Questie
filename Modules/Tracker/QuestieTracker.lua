...
function QuestieTracker:UpdateHeight()
    ...
    -- trackerHeightByManual > 0 and trackerHeightByManual = [Sizer Manual Mode] | trackerHeightByRatio = [Sizer Auto Mode]
