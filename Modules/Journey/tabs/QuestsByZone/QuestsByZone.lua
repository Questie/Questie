...
function _QuestieJourney.questsByZone:CollectZoneQuests(zoneId)
    ...
    for _, levelAndQuest in pairs(sortedQuestByLevel) do
        ...
        if QuestieCorrections.hiddenQuests and ((not QuestieCorrections.hiddenQuests[questId]) or QuestieEvent:IsEventQuest(questId)) and QuestieDB.questIDList[questId] then
            temp.value = questId
